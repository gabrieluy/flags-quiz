export const countries_json = [
  {
    ...
    translations: {
      ...
      jp: { official: 'グレナダ', common: 'グレナダ' },
      kr: { official: '그레나다', common: '그레나다' },
      nld: { official: 'Grenada', common: 'Grenada' },
      ir: { official: 'گرنادا', common: 'گرنادا' },
      pol: { official: 'Grenada', common: 'Grenada' },
      pt: { official: 'Grenada', common: 'Granada' },
      ru: { official: 'Гренада', common: 'Гренада' },
      slk: { official: 'Grenada', common: 'Grenada' },
      es: { official: 'Granada', common: 'Grenada' },
      swe: { official: 'Grenada', common: 'Grenada' },
      tr: { official: 'Grenada', common: 'Grenada' },
      urd: { official: 'گریناڈا', common: 'گریناڈا' },
      cn: { official: '格林纳达', common: '格林纳达' },
    },
    latlng: [12.11666666, -61.66666666],
    landlocked: false,
    area: 344.0,
    demonyms: { eng: { f: 'Grenadian', m: 'Grenadian' }, fr: { f: 'Grenadienne', m: 'Grenadien' } },
    flag: '\uD83C\uDDEC\uD83C\uDDE9',
    maps: {
  ...
  },
  {
    name: {
      common: 'Malaysia',
      official: 'Malaysia',
      nativeName: { eng: { official: 'Malaysia', common: 'Malaysia' }, msa: { official: 'مليسيا', common: 'مليسيا' } },
    },
    tld: ['.my'],
    code: 'MY',
    ccn3: '458',
    ...
    translations: {
      ...
      jp: { official: 'マレーシア', common: 'マレーシア' },
      kr: { official: '말레이시아', common: '말레이시아' },
      nld: { official: 'Maleisië', common: 'Maleisië' },
      ir: { official: 'فدراسیون مالزی', common: 'مالزی' },
      pol: { official: 'Malezja', common: 'Malezja' },
      pt: { official: 'Malásia', common: 'Malásia' },
      ru: { official: 'Малайзия', common: 'Малайзия' },
      slk: { official: 'Malajzia', common: 'Malajzia' },
      es: { official: 'Malasia', common: 'Malasia' },
      swe: { official: 'Malaysia', common: 'Malaysia' },
      tr: { official: 'Malezya', common: 'Malezya' },
      urd: { official: 'ملائیشیا', common: 'ملائیشیا' },
      cn: { official: '马来西亚', common: '马来西亚' },
    },
    latlng: [2.5, 112.5],
    landlocked: false,
    borders: ['BRN', 'IDN', 'THA'],
    area: 330803.0,
    demonyms: { eng: { f: 'Malaysian', m: 'Malaysian' }, fr: { f: 'Malaisienne', m: 'Malaisien' } },
    flag: '\uD83C\uDDF2\uD83C\uDDFE',
    maps: {
  ...
  },
  {
    name: {
      ...
      official: 'Guiana',
      nativeName: { fr: { official: 'Guyane', common: 'Guyane française' } },
    },
    tld: ['.gf'],
    code: 'GF',
    ccn3: '254',
    ...
    translations: {
      ...
      de: { official: 'Französisch-Guayana', common: 'Französisch-Guayana' },
      ...
      jp: { official: 'ギアナ', common: 'フランス領ギアナ' },
      kr: { official: '프랑스령 기아나', common: '프랑스령 기아나' },
      nld: { official: 'Guyana', common: 'Frans-Guyana' },
      ir: { official: 'گویان فرانسه', common: 'گویان فرانسه' },
      pol: { official: 'Gujana Francuska', common: 'Gujana Francuska' },
      pt: { official: 'Guiana', common: 'Guiana Francesa' },
      ru: { official: 'Гвиана', common: 'Французская Гвиана' },
      ...
      tr: { official: 'Fransız Guyanası', common: 'Fransız Guyanası' },
      urd: { official: 'گیانا', common: 'فرانسیسی گیانا' },
      cn: { official: '法属圭亚那', common: '法属圭亚那' },
    },
    latlng: [4.0, -53.0],
    landlocked: false,
    borders: ['BRA', 'SUR'],
    area: 83534.0,
    demonyms: { eng: { f: 'Guianan', m: 'Guianan' }, fr: { f: 'Guyanaise', m: 'Guyanais' } },
    flag: '\uD83C\uDDEC\uD83C\uDDEB',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'Reino de España', common: 'España' } },
    },
    tld: ['.es'],
    code: 'ES',
    ccn3: '724',
    ...
    translations: {
      ...
      jp: { official: 'スペイン王国', common: 'スペイン' },
      kr: { official: '에스파냐 왕국', common: '스페인' },
      nld: { official: 'Koninkrijk Spanje', common: 'Spanje' },
      ir: { official: 'پادشاهی اسپانیا', common: 'اسپانیا' },
      pol: { official: 'Królestwo Hiszpanii ', common: 'Hiszpania' },
      pt: { official: 'Reino de Espanha', common: 'Espanha' },
      ru: { official: 'Королевство Испания', common: 'Испания' },
      ...
      tr: { official: 'İspanya Krallığı', common: 'İspanya' },
      urd: { official: 'مملکتِ ہسپانیہ', common: 'ہسپانیہ' },
      cn: { official: '西班牙王国', common: '西班牙' },
    },
    latlng: [40.0, -4.0],
    landlocked: false,
    borders: ['AND', 'FRA', 'GIB', 'PRT', 'MAR'],
    area: 505992.0,
    demonyms: { eng: { f: 'Spanish', m: 'Spanish' }, fr: { f: 'Espagnole', m: 'Espagnol' } },
    flag: '\uD83C\uDDEA\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Cookinseln', common: 'Cookinseln' },
      ...
      jp: { official: 'クック諸島', common: 'クック諸島' },
      kr: { official: '쿡 제도', common: '쿡 제도' },
      nld: { official: 'Cook eilanden', common: 'Cookeilanden' },
      ir: { official: 'جزایر کوک', common: 'جزایر کوک' },
      pol: { official: 'Wyspy Cooka', common: 'Wyspy Cooka' },
      pt: { official: 'Ilhas Cook', common: 'Ilhas Cook' },
      ru: { official: 'острова Кука', common: 'Острова Кука' },
      ...
      tr: { official: 'Cook Adaları', common: 'Cook Adaları' },
      urd: { official: 'جزائر کک', common: 'جزائر کک' },
      cn: { official: '库克群岛', common: '库克群岛' },
    },
    latlng: [-21.23333333, -159.76666666],
    landlocked: false,
    area: 236.0,
    demonyms: { eng: { f: 'Cook Islander', m: 'Cook Islander' }, fr: { f: 'Cookienne', m: 'Cookien' } },
    flag: '\uD83C\uDDE8\uD83C\uDDF0',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'République du Mali', common: 'Mali' } },
    },
    tld: ['.ml'],
    code: 'ML',
    ccn3: '466',
    ...
    translations: {
      ...
      jp: { official: 'マリ共和国', common: 'マリ' },
      kr: { official: '말리 공화국', common: '말리' },
      nld: { official: 'Republiek Mali', common: 'Mali' },
      ir: { official: 'جمهوری مالی', common: 'مالی' },
      pol: { official: 'Republika Mali', common: 'Mali' },
      pt: { official: 'República do Mali', common: 'Mali' },
      ru: { official: 'Республика Мали', common: 'Мали' },
      ...
      tr: { official: 'Mali Cumhuriyeti', common: 'Mali' },
      urd: { official: 'جمہوریہ مالی', common: 'مالی' },
      cn: { official: '马里共和国', common: '马里' },
    },
    latlng: [17.0, -4.0],
    landlocked: true,
    borders: ['DZA', 'BFA', 'GIN', 'CIV', 'MRT', 'NER', 'SEN'],
    area: 1240192.0,
    demonyms: { eng: { f: 'Malian', m: 'Malian' }, fr: { f: 'Malienne', m: 'Malien' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF1',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'Grande République arabe libyenne populaire et socialiste', common: 'Libye' },
      hrv: { official: 'Država Libiji', common: 'Libija' },
      hun: { official: 'Líbia Állam', common: 'Líbia' },
      it: { official: 'Stato della Libia', common: 'Libia' },
      jp: { official: 'リビアの国家', common: 'リビア' },
      kr: { official: '리비아', common: '리비아' },
      nld: { official: 'Staat van Libië', common: 'Libië' },
      ir: { official: 'دولت لیبی', common: 'لیبی' },
      pol: { official: 'Państwo Libia', common: 'Libia' },
      pt: { official: 'Estado da Líbia', common: 'Líbia' },
      ru: { official: 'Государство Ливии', common: 'Ливия' },
      slk: { official: 'Líbya', common: 'Líbya' },
      es: { official: 'Estado de Libia', common: 'Libia' },
      swe: { official: 'Staten Libyen', common: 'Libyen' },
      tr: { official: 'Libya Devleti', common: 'Libya' },
      urd: { official: 'ریاستِ لیبیا', common: 'لیبیا' },
      cn: { official: '利比亚国', common: '利比亚' },
    },
    latlng: [25.0, 17.0],
    landlocked: false,
    borders: ['DZA', 'TCD', 'EGY', 'NER', 'SDN', 'TUN'],
    area: 1759540.0,
    demonyms: { eng: { f: 'Libyan', m: 'Libyan' }, fr: { f: 'Libyenne', m: 'Libyen' } },
    flag: '\uD83C\uDDF1\uD83C\uDDFE',
    maps: { googleMaps: 'https://goo.gl/maps/eLgGnaQWcJEdYRMy5', openStreetMaps: 'openstreetmap.org/relation/192758' },
    population: 6871287,
    fifa: 'LBY',
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        es: { official: 'República Árabe Saharaui Democrática', common: 'Sahara Occidental' },
      },
    },
    tld: ['.eh'],
    code: 'EH',
    ...
    translations: {
      ...
      de: { official: 'Demokratische Arabische Republik Sahara', common: 'Westsahara' },
      est: { official: 'Lääne-Sahara', common: 'Lääne-Sahara' },
      fin: { official: 'Länsi-Sahara', common: 'Länsi-Sahara' },
      fr: { official: 'République arabe sahraouie démocratique', common: 'Sahara Occidental' },
      hrv: { official: 'Sahrawi Arab Demokratska Republika', common: 'Zapadna Sahara' },
      hun: { official: 'Nyugat-Szahara', common: 'Nyugat-Szahara' },
      it: { official: 'Repubblica Araba Saharawi Democratica', common: 'Sahara Occidentale' },
      jp: { official: 'サハラアラブ民主共和国', common: '西サハラ' },
      kr: { official: '사하라 아랍 민주 공화국', common: '서사하라' },
      nld: { official: 'Sahrawi Arabische Democratische Republiek', common: 'Westelijke Sahara' },
      ir: { official: 'صحرای غربی', common: 'صحرای غربی' },
      pol: { official: 'Saharyjska Arabska Republika Demokratyczna', common: 'Sahara Zachodnia' },
      pt: { official: 'República Árabe Saharaui Democrática', common: 'Saara Ocidental' },
      ru: { official: 'Sahrawi Арабская Демократическая Республика', common: 'Западная Сахара' },
      slk: { official: 'Západná Sahara', common: 'Západná Sahara' },
      es: { official: 'República Árabe Saharaui Democrática', common: 'Sahara Occidental' },
      swe: { official: 'Västsahara', common: 'Västsahara' },
      tr: { official: 'Sahra Demokratik Arap Cumhuriyeti', common: 'Sahra Demokratik Arap Cumhuriyeti' },
      urd: { official: 'صحراوی عرب عوامی جمہوریہ', common: 'مغربی صحارا' },
      cn: { official: '阿拉伯撒哈拉民主共和国', common: '西撒哈拉' },
    },
    latlng: [24.5, -13.0],
    landlocked: false,
    borders: ['DZA', 'MRT', 'MAR'],
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Salomonen', common: 'Salomonen' },
      ...
      jp: { official: 'ソロモン諸島', common: 'ソロモン諸島' },
      kr: { official: '솔로몬 제도', common: '솔로몬 제도' },
      nld: { official: 'Solomon eilanden', common: 'Salomonseilanden' },
      ir: { official: 'جزایر سلیمان', common: 'جزایر سلیمان' },
      pol: { official: 'Wyspy Salomona', common: 'Wyspy Salomona' },
      pt: { official: 'Ilhas Salomão', common: 'Ilhas Salomão' },
      ru: { official: 'Соломоновы острова', common: 'Соломоновы Острова' },
      ...
      tr: { official: 'Solomon Adaları', common: 'Solomon Adaları' },
      urd: { official: 'جزائر سلیمان', common: 'جزائر سلیمان' },
      cn: { official: '所罗门群岛', common: '所罗门群岛' },
    },
    latlng: [-8.0, 159.0],
    landlocked: false,
    area: 28896.0,
    demonyms: { eng: { f: 'Solomon Islander', m: 'Solomon Islander' }, fr: { f: 'Salomonienne', m: 'Salomonien' } },
    flag: '\uD83C\uDDF8\uD83C\uDDE7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'チュニジア共和国', common: 'チュニジア' },
      kr: { official: '튀니지 공화국', common: '튀니지' },
      nld: { official: 'Republiek Tunesië', common: 'Tunesië' },
      ir: { official: 'جمهوری تونس', common: 'تونس' },
      pol: { official: 'Republika Tunezyjska', common: 'Tunezja' },
      pt: { official: 'República da Tunísia', common: 'Tunísia' },
      ru: { official: 'Тунисской Республики', common: 'Тунис' },
      ...
      tr: { official: 'Tunus Cumhuriyeti', common: 'Tunus' },
      urd: { official: 'جمہوریہ تونس', common: 'تونس' },
      cn: { official: '突尼斯共和国', common: '突尼斯' },
    },
    latlng: [34.0, 9.0],
    landlocked: false,
    borders: ['DZA', 'LBY'],
    area: 163610.0,
    demonyms: { eng: { f: 'Tunisian', m: 'Tunisian' }, fr: { f: 'Tunisienne', m: 'Tunisien' } },
    flag: '\uD83C\uDDF9\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    ...
    languages: { eng: 'English', fr: 'French', nfr: 'Guernésiais' },
    translations: {
      ...
      de: { official: 'Vogtei Guernsey', common: 'Guernsey' },
      ...
      jp: { official: 'ガーンジーの得意分野', common: 'ガーンジー' },
      kr: { official: '건지 섬', common: '건지 섬' },
      nld: { official: 'Baljuwschap Guernsey', common: 'Guernsey' },
      ir: { official: 'گرنزی', common: 'گرنزی' },
      pol: { official: 'Baliwat Guernsey', common: 'Guernsey' },
      pt: { official: 'Bailiado de Guernsey', common: 'Guernsey' },
      ru: { official: 'Коронное владение Гернси', common: 'Гернси' },
      slk: { official: 'Guernsey', common: 'Guernsey' },
      es: { official: 'Bailía de Guernsey', common: 'Guernsey' },
      swe: { official: 'Guernsey', common: 'Guernsey' },
      tr: { official: 'Guernsey Muhafızlığı', common: 'Guernsey' },
      urd: { official: 'گرنزی رودبار', common: 'گرنزی' },
      cn: { official: '根西岛', common: '根西岛' },
    },
    latlng: [49.46666666, -2.58333333],
    landlocked: false,
    area: 78.0,
    demonyms: { eng: { f: 'Channel Islander', m: 'Channel Islander' }, fr: { f: 'Guernesiaise', m: 'Guernesiais' } },
    flag: '\uD83C\uDDEC\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    ...
    languages: { crs: 'Seychellois Creole', eng: 'English', fr: 'French' },
    translations: {
      ...
      jp: { official: 'セイシェル共和国', common: 'セーシェル' },
      kr: { official: '세이셸 공화국', common: '세이셸' },
      nld: { official: 'Republiek der Seychellen', common: 'Seychellen' },
      ir: { official: 'جمهوری سیشل', common: 'سیشل' },
      pol: { official: 'Republika Seszeli', common: 'Seszele' },
      pt: { official: 'República das Seychelles', common: 'Seicheles' },
      ru: { official: 'Республика Сейшельские Острова', common: 'Сейшельские Острова' },
      ...
      tr: { official: 'Seyşeller Cumhuriyeti', common: 'Seyşeller' },
      urd: { official: 'جمہوریہ سیچیلیس', common: 'سیچیلیس' },
      cn: { official: '塞舌尔共和国', common: '塞舌尔' },
    },
    latlng: [-4.58333333, 55.66666666],
    landlocked: false,
    area: 452.0,
    demonyms: { eng: { f: 'Seychellois', m: 'Seychellois' }, fr: { f: 'Seychelloise', m: 'Seychellois' } },
    flag: '\uD83C\uDDF8\uD83C\uDDE8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'îles Vierges', common: 'Îles Vierges britanniques' },
      ...
      jp: { official: 'バージン諸島', common: 'イギリス領ヴァージン諸島' },
      kr: { official: '영국령 버진아일랜드', common: '영국령 버진아일랜드' },
      nld: { official: 'Maagdeneilanden', common: 'Britse Maagdeneilanden' },
      ir: { official: 'جزایر ویرجین بریتانیا', common: 'جزایر ویرجین بریتانیا' },
      pol: { official: 'Brytyjskie Wyspy Dziewicze', common: 'Brytyjskie Wyspy Dziewicze' },
      pt: { official: 'Ilhas Virgens', common: 'Ilhas Virgens' },
      ru: { official: 'Виргинские острова', common: 'Британские Виргинские острова' },
      slk: { official: 'Panenské ostrovy', common: 'Panenské ostrovy' },
      es: { official: 'Islas Vírgenes', common: 'Islas Vírgenes del Reino Unido' },
      swe: { official: 'Brittiska Jungfruöarna', common: 'Brittiska Jungfruöarna' },
      tr: { official: 'Virjin Adaları', common: 'Virjin Adaları' },
      urd: { official: 'برطانوی جزائر ورجن', common: 'برطانوی جزائر ورجن' },
      cn: { official: '英属维尔京群岛', common: '英属维尔京群岛' },
    },
  ...
  },
  {
    name: {
      common: 'Guadeloupe',
      official: 'Guadeloupe',
      nativeName: { fr: { official: 'Guadeloupe', common: 'Guadeloupe' } },
    },
    tld: ['.gp'],
    code: 'GP',
    ccn3: '312',
    ...
    translations: {
      ...
      jp: { official: 'グアドループ島', common: 'グアドループ' },
      kr: { official: '과들루프', common: '과들루프' },
      nld: { official: 'Guadeloupe', common: 'Guadeloupe' },
      ir: { official: 'گوادلوپ', common: 'گوادلوپ' },
      pol: { official: 'Gwadelupa', common: 'Gwadelupa' },
      pt: { official: 'Guadalupe', common: 'Guadalupe' },
      ru: { official: 'Гваделупа', common: 'Гваделупа' },
      slk: { official: 'Guadeloupe', common: 'Guadeloupe' },
      es: { official: 'Guadalupe', common: 'Guadalupe' },
      swe: { official: 'Guadeloupe', common: 'Guadeloupe' },
      tr: { official: 'Guadeloupe', common: 'Guadeloupe' },
      urd: { official: 'گواڈیلوپ', common: 'گواڈیلوپ' },
      cn: { official: '瓜德罗普岛', common: '瓜德罗普岛' },
    },
    latlng: [16.25, -61.583333],
    landlocked: false,
    area: 1628.0,
    demonyms: { eng: { f: 'Guadeloupian', m: 'Guadeloupian' }, fr: { f: 'Guadeloupéenne', m: 'Guadeloupéen' } },
    flag: '\uD83C\uDDEC\uD83C\uDDF5',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'シリアアラブ共和国', common: 'シリア・アラブ共和国' },
      kr: { official: '시리아 아랍 공화국', common: '시리아' },
      nld: { official: 'Syrische Arabische Republiek', common: 'Syrië' },
      ir: { official: 'جمهوری عربی سوریه', common: 'سوریه' },
      pol: { official: 'Syryjska Republika Arabska', common: 'Syria' },
      pt: { official: 'República Árabe Síria', common: 'Síria' },
      ru: { official: 'Сирийская Арабская Республика', common: 'Сирия' },
      ...
      tr: { official: 'Suriye Arap Cumhuriyeti', common: 'Suriye' },
      urd: { official: 'عرب جمہوریہ سوریہ', common: 'سوریہ' },
      cn: { official: '叙利亚阿拉伯共和国', common: '叙利亚' },
    },
    latlng: [35.0, 38.0],
    landlocked: false,
    borders: ['IRQ', 'ISR', 'JOR', 'LBN', 'TUR'],
    area: 185180.0,
    demonyms: { eng: { f: 'Syrian', m: 'Syrian' }, fr: { f: 'Syrienne', m: 'Syrien' } },
    flag: '\uD83C\uDDF8\uD83C\uDDFE',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ノルウェー王国', common: 'ノルウェー' },
      kr: { official: '노르웨이 왕국', common: '노르웨이' },
      nld: { official: 'Koninkrijk Noorwegen', common: 'Noorwegen' },
      ir: { official: 'پادشاهی نروژ', common: 'نروژ' },
      pol: { official: 'Królestwo Norwegii', common: 'Norwegia' },
      pt: { official: 'Reino da Noruega', common: 'Noruega' },
      ru: { official: 'Королевство Норвегия', common: 'Норвегия' },
      ...
      tr: { official: 'Norveç Krallığı', common: 'Norveç' },
      urd: { official: 'مملکتِ ناروے', common: 'ناروے' },
      cn: { official: '挪威王国', common: '挪威' },
    },
    latlng: [62.0, 10.0],
    landlocked: false,
    borders: ['FIN', 'SWE', 'RUS'],
    area: 323802.0,
    demonyms: { eng: { f: 'Norwegian', m: 'Norwegian' }, fr: { f: 'Norvégienne', m: 'Norvégien' } },
    flag: '\uD83C\uDDF3\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'République des Philippines', common: 'Philippines' },
      ...
      jp: { official: 'フィリピン共和国', common: 'フィリピン' },
      kr: { official: '필리핀 공화국', common: '필리핀' },
      nld: { official: 'Republiek der Filipijnen', common: 'Filipijnen' },
      ir: { official: 'جمهوری فیلیپین', common: 'فیلیپین' },
      pol: { official: 'Republika Filipin', common: 'Filipiny' },
      pt: { official: 'República das Filipinas', common: 'Filipinas' },
      ru: { official: 'Республика Филиппины', common: 'Филиппины' },
      ...
      tr: { official: 'Filipinler Cumhuriyeti', common: 'Filipinler' },
      urd: { official: 'جمہوریہ فلپائن', common: 'فلپائن' },
      cn: { official: '菲律宾共和国', common: '菲律宾' },
    },
    latlng: [13.0, 122.0],
    landlocked: false,
    area: 342353.0,
    demonyms: { eng: { f: 'Filipino', m: 'Filipino' }, fr: { f: 'Philippine', m: 'Philippin' } },
    flag: '\uD83C\uDDF5\uD83C\uDDED',
    maps: {
  ...
  {
    name: { common: 'Iceland', official: 'Iceland', nativeName: { isl: { official: 'Ísland', common: 'Ísland' } } },
    tld: ['.is'],
    code: 'IS',
    ccn3: '352',
    cca3: 'ISL',
    ...
    translations: {
      ...
      jp: { official: 'アイスランド', common: 'アイスランド' },
      kr: { official: '아이슬란드 공화국', common: '아이슬란드' },
      nld: { official: 'IJsland', common: 'IJsland' },
      ir: { official: 'جمهوری ایسلند', common: 'ایسلند' },
      pol: { official: 'Republika Islandii', common: 'Islandia' },
      pt: { official: 'Islândia', common: 'Islândia' },
      ru: { official: 'Исландия', common: 'Исландия' },
      slk: { official: 'Islandská republika', common: 'Island' },
      es: { official: 'Islandia', common: 'Islandia' },
      swe: { official: 'Island', common: 'Island' },
      tr: { official: 'İzlanda', common: 'İzlanda' },
      urd: { official: 'آئس لینڈ', common: 'آئس لینڈ' },
      cn: { official: '冰岛', common: '冰岛' },
    },
    latlng: [65.0, -18.0],
    landlocked: false,
    area: 103000.0,
    demonyms: { eng: { f: 'Icelander', m: 'Icelander' }, fr: { f: 'Islandaise', m: 'Islandais' } },
    flag: '\uD83C\uDDEE\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { pt: { official: 'República de Moçambique', common: 'Moçambique' } },
    },
    tld: ['.mz'],
    code: 'MZ',
    ccn3: '508',
    ...
    translations: {
      ...
      jp: { official: 'モザンビーク共和国', common: 'モザンビーク' },
      kr: { official: '모잠비크 공화국', common: '모잠비크' },
      nld: { official: 'Republiek Mozambique', common: 'Mozambique' },
      ir: { official: 'جمهوری موزامبیک', common: 'موزامبیک' },
      pol: { official: 'Republika Mozambiku', common: 'Mozambik' },
      pt: { official: 'República de Moçambique', common: 'Moçambique' },
      ru: { official: 'Республика Мозамбик', common: 'Мозамбик' },
      ...
      tr: { official: 'Mozambik Cumhuriyeti', common: 'Mozambik' },
      urd: { official: 'جمہوریہ موزمبیق', common: 'موزمبیق' },
      cn: { official: '莫桑比克共和国', common: '莫桑比克' },
    },
    latlng: [-18.25, 35.0],
    landlocked: false,
    borders: ['MWI', 'ZAF', 'SWZ', 'TZA', 'ZMB', 'ZWE'],
    area: 801590.0,
    demonyms: { eng: { f: 'Mozambican', m: 'Mozambican' }, fr: { f: 'Mozambicaine', m: 'Mozambicain' } },
    flag: '\uD83C\uDDF2\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Republik Palau', common: 'Palau' },
      est: { official: 'Belau Vabariik', common: 'Belau' },
      fin: { official: 'Palaun tasavalta', common: 'Palau' },
      fr: { official: 'République des Palaos (Palau)', common: 'Palaos (Palau)' },
      ...
      jp: { official: 'パラオ共和国', common: 'パラオ' },
      kr: { official: '팔라우 공화국', common: '팔라우' },
      nld: { official: 'Republiek van Palau', common: 'Palau' },
      ir: { official: 'جمهوری پالائو', common: 'پالائو' },
      pol: { official: 'Republika Palau', common: 'Palau' },
      pt: { official: 'República de Palau', common: 'Palau' },
      ru: { official: 'Республика Палау', common: 'Палау' },
      ...
      tr: { official: 'Palau Cumhuriyeti', common: 'Palau' },
      urd: { official: 'جمہوریہ پلاؤ', common: 'پلاؤ' },
      cn: { official: '帕劳共和国', common: '帕劳' },
    },
    latlng: [7.5, 134.5],
    landlocked: false,
    area: 459.0,
    demonyms: { eng: { f: 'Palauan', m: 'Palauan' }, fr: { f: 'Paluane', m: 'Paluan' } },
    flag: '\uD83C\uDDF5\uD83C\uDDFC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Islamische Republik Afghanistan', common: 'Afghanistan' },
      ...
      fr: { official: "République islamique d'Afghanistan", common: 'Afghanistan' },
      ...
      it: { official: "Repubblica islamica dell'Afghanistan", common: 'Afghanistan' },
      jp: { official: 'アフガニスタン·イスラム共和国', common: 'アフガニスタン' },
      kr: { official: '아프가니스탄 이슬람 공화국', common: '아프가니스탄' },
      nld: { official: 'Islamitische Republiek Afghanistan', common: 'Afghanistan' },
      ir: { official: 'جمهوری اسلامی افغانستان', common: 'افغانستان' },
      pol: { official: 'Islamska Republika Afganistanu', common: 'Afganistan' },
      pt: { official: 'República Islâmica do Afeganistão', common: 'Afeganistão' },
      ru: { official: 'Исламская Республика Афганистан', common: 'Афганистан' },
      slk: { official: 'Afgánsky islamský štát', common: 'Afganistan' },
      es: { official: 'República Islámica de Afganistán', common: 'Afganistán' },
      swe: { official: 'Islamiska republiken Afghanistan', common: 'Afghanistan' },
      tr: { official: 'Afganistan İslam Cumhuriyeti', common: 'Afganistan' },
      urd: { official: 'اسلامی جمہوریہ افغانستان', common: 'افغانستان' },
      cn: { official: '阿富汗伊斯兰共和国', common: '阿富汗' },
    },
    latlng: [33.0, 65.0],
    landlocked: true,
    borders: ['IRN', 'PAK', 'TKM', 'UZB', 'TJK', 'CHN'],
    area: 652230.0,
    demonyms: { eng: { f: 'Afghan', m: 'Afghan' }, fr: { f: 'Afghane', m: 'Afghan' } },
    flag: '\uD83C\uDDE6\uD83C\uDDEB',
    maps: {
  ...
  },
  {
    ...
    region: 'Africa',
    subregion: 'Eastern Africa',
    languages: { ara: 'Arabic', fr: 'French' },
    translations: {
      ara: { official: 'جمهورية جيبوتي', common: 'جيبوتي' },
      ...
      jp: { official: 'ジブチ共和国', common: 'ジブチ' },
      kr: { official: '지부티 공화국', common: '지부티' },
      nld: { official: 'Republiek Djibouti', common: 'Djibouti' },
      ir: { official: 'جمهوری جیبوتی', common: 'جیبوتی' },
      pol: { official: 'Republika Dżibuti', common: 'Dżibuti' },
      pt: { official: 'República do Djibouti', common: 'Djibouti' },
      ru: { official: 'Республика Джибути', common: 'Джибути' },
      ...
      tr: { official: 'Cibuti Cumhuriyeti', common: 'Cibuti' },
      urd: { official: 'جمہوریہ جبوتی', common: 'جبوتی' },
      cn: { official: '吉布提共和国', common: '吉布提' },
    },
    latlng: [11.5, 43.0],
    landlocked: false,
    borders: ['ERI', 'ETH', 'SOM'],
    area: 23200.0,
    demonyms: { eng: { f: 'Djibouti', m: 'Djibouti' }, fr: { f: 'Djiboutienne', m: 'Djiboutien' } },
    flag: '\uD83C\uDDE9\uD83C\uDDEF',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        es: { official: 'República del Perú', common: 'Perú' },
      },
    },
    tld: ['.pe'],
    code: 'PE',
    ...
    status: 'officially-assigned',
    unMember: true,
    currencies: { Pcym: { name: 'Peruvian sol', symbol: 'S/ ' } },
    idd: { root: '+5', suffixes: ['1'] },
    capital: ['Lima'],
    altSpellings: ['PE', 'Republic of Peru', 'República del Perú'],
    region: 'Americas',
    subregion: 'South America',
    languages: { aym: 'Aymara', que: 'Quechua', es: 'Spanish' },
    translations: {
      ...
      jp: { official: 'ペルー共和国', common: 'ペルー' },
      kr: { official: '페루 공화국', common: '페루' },
      nld: { official: 'Republiek Peru', common: 'Peru' },
      ir: { official: 'جمهوری پرو', common: 'پرو' },
      pol: { official: 'Republika Peru', common: 'Peru' },
      pt: { official: 'República do Peru', common: 'Perú' },
      ru: { official: 'Республика Перу', common: 'Перу' },
      ...
      tr: { official: 'Peru Cumhuriyeti', common: 'Peru' },
      urd: { official: 'جمہوریہ پیرو', common: 'پیرو' },
      cn: { official: '秘鲁共和国', common: '秘鲁' },
    },
    latlng: [-10.0, -76.0],
    landlocked: false,
    borders: ['BOL', 'BRA', 'CHL', 'COL', 'ECU'],
    area: 1285216.0,
    demonyms: { eng: { f: 'Peruvian', m: 'Peruvian' }, fr: { f: 'Péruvienne', m: 'Péruvien' } },
    flag: '\uD83C\uDDF5\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    languages: { de: 'German', fr: 'French', ltz: 'Luxembourgish' },
    translations: {
      ...
      jp: { official: 'ルクセンブルク大公国', common: 'ルクセンブルク' },
      kr: { official: '룩셈부르크 대공국', common: '룩셈부르크' },
      nld: { official: 'Groothertogdom Luxemburg', common: 'Luxemburg' },
      ir: { official: 'دوک‌نشین لوکزامبورگ', common: 'لوکزامبورگ' },
      pol: { official: 'Wielkie Księstwo Luksemburga', common: 'Luksemburg' },
      pt: { official: 'Grão-Ducado do Luxemburgo', common: 'Luxemburgo' },
      ru: { official: 'Великое Герцогство Люксембург', common: 'Люксембург' },
      ...
      tr: { official: 'Lüksemburg Büyük Dükalığı', common: 'Lüksemburg' },
      urd: { official: 'دوقیہ کبیرلکسمبرگ', common: 'لکسمبرگ' },
      cn: { official: '卢森堡大公国', common: '卢森堡' },
    },
    latlng: [49.75, 6.16666666],
    landlocked: true,
    borders: ['BEL', 'FRA', 'DEU'],
    area: 2586.0,
    demonyms: { eng: { f: 'Luxembourger', m: 'Luxembourger' }, fr: { f: 'Luxembourgeoise', m: 'Luxembourgeois' } },
    flag: '\uD83C\uDDF1\uD83C\uDDFA',
    maps: {
  ...
  },
  {
    ...
    region: 'Africa',
    subregion: 'Eastern Africa',
    languages: { fr: 'French', run: 'Kirundi' },
    translations: {
      ...
      jp: { official: 'ブルンジ共和国', common: 'ブルンジ' },
      kr: { official: '부룬디', common: '부룬디' },
      nld: { official: 'Republiek Burundi', common: 'Burundi' },
      ir: { official: 'جمهوری بوروندی', common: 'بوروندی' },
      pol: { official: 'Republika Burundi', common: 'Burundi' },
      pt: { official: 'República do Burundi', common: 'Burundi' },
      ru: { official: 'Республика Бурунди', common: 'Бурунди' },
      ...
      tr: { official: 'Burundi Cumhuriyeti', common: 'Burundi' },
      urd: { official: 'جمہوریہ برونڈی', common: 'برونڈی' },
      cn: { official: '布隆迪共和国', common: '布隆迪' },
    },
    latlng: [-3.5, 30.0],
    landlocked: true,
    borders: ['COD', 'RWA', 'TZA'],
    area: 27834.0,
    demonyms: { eng: { f: 'Burundian', m: 'Burundian' }, fr: { f: 'Burundaise', m: 'Burundais' } },
    flag: '\uD83C\uDDE7\uD83C\uDDEE',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'République coopérative de Guyana', common: 'Guyana' },
      ...
      jp: { official: 'ガイアナの協同共和国', common: 'ガイアナ' },
      kr: { official: '가이아나 협동 공화국', common: '가이아나' },
      nld: { official: 'Coöperatieve Republiek Guyana', common: 'Guyana' },
      ir: { official: 'جمهوری تعاونی گویان', common: 'گویان' },
      pol: { official: 'Kooperacyjna Republika Gujany', common: 'Gujana' },
      pt: { official: 'Co -operative República da Guiana', common: 'Guiana' },
      ru: { official: 'Кооперативная Республика Гайана', common: 'Гайана' },
      ...
      tr: { official: 'Guyana Kooperatif Cumhuriyeti', common: 'Guyana' },
      urd: { official: 'تعاونی جمہوریہ گیانا', common: 'گیانا' },
      cn: { official: '圭亚那共和国', common: '圭亚那' },
    },
    latlng: [5.0, -59.0],
    landlocked: false,
    borders: ['BRA', 'SUR', 'VEN'],
    area: 214969.0,
    demonyms: { eng: { f: 'Guyanese', m: 'Guyanese' }, fr: { f: 'Guyanienne', m: 'Guyanien' } },
    flag: '\uD83C\uDDEC\uD83C\uDDFE',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      bre: { official: 'Rouantelezh-Unanet Breizh-Veur ha Norzhiwercnn', common: 'Rouantelezh-Unanet' },
      ...
      de: { official: 'Vereinigtes Königreich Großbritannien und Nordirland', common: 'Vereinigtes Königreich' },
      ...
      fr: { official: "Royaume-Uni de Grande-Bretagne et d'Irlande du Nord", common: 'Royaume-Uni' },
      ...
      it: { official: 'Regno Unito di Gran Bretagna e Irlanda del Nord', common: 'Regno Unito' },
      jp: { official: 'グレート·ブリテンおよび北アイルランド連合王国', common: 'イギリス' },
      kr: { official: '그레이트브리튼 북아일랜드 연합 왕국', common: '영국' },
      nld: { official: 'Verenigd Koninkrijk van Groot-Brittannië en Noord-Ierland', common: 'Verenigd Koninkrijk' },
      ir: { official: 'پادشاهی متحد بریتانیای کبیر و ایرلند شمالی', common: 'انگلیس' },
      pol: {
        official: 'Zjednoczone Królestwo Wielkiej Brytanii i Irlandii Północnej',
        common: 'Zjednoczone Królestwo',
      },
      pt: { official: 'Reino Unido da Grã-Bretanha e Irlanda do Norte', common: 'Reino Unido' },
      ru: { official: 'Соединенное Королевство Великобритании и Северной Ирландии', common: 'Великобритания' },
      slk: {
        official: 'Spojené kráľovstvo Veľkej Británie a SevernéhoÌrska',
        common: 'Veľká Británia (Spojené kráľovstvo)',
      },
      es: { official: 'Reino Unido de Gran Bretaña e Irlanda del Norte', common: 'Reino Unido' },
      swe: { official: 'Förenade konungariket Storbritannien och Nordirland', common: 'Storbritannien' },
      tr: { official: 'Büyük Britanya ve Kuzey İrlanda Birleşik Krallığı', common: 'Birleşik Krallık' },
      urd: { official: 'مملکتِ متحدہ برطانیہ عظمی و شمالی آئرلینڈ', common: 'مملکتِ متحدہ' },
      cn: { official: '大不列颠及北爱尔兰联合王国', common: '英国' },
    },
    latlng: [54.0, -2.0],
    landlocked: false,
    borders: ['IRL'],
    area: 242900.0,
    demonyms: { eng: { f: 'British', m: 'British' }, fr: { f: 'Britannique', m: 'Britannique' } },
    flag: '\uD83C\uDDEC\uD83C\uDDE7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Gebiet der Kokos- (Keeling-) Inseln', common: 'Kokosinseln' },
      est: { official: 'Kookossaarte ala', common: 'Kookossaared' },
      fin: { official: 'Kookossaaret', common: 'Kookossaaret' },
      fr: { official: 'Territoire des îles Cocos (Keeling)', common: 'Îles Cocos' },
      ...
      it: { official: 'Territorio della (Keeling) Isole Cocos', common: 'Isole Cocos e Keeling' },
      jp: { official: 'ココス諸島の領土', common: 'ココス（キーリング）諸島' },
      kr: { official: '코코스 제도', common: '코코스 제도' },
      nld: { official: 'Grondgebied van de Eilanden Cocos (Keeling )', common: 'Cocoseilanden' },
      ir: { official: 'جزایر کوکوس', common: 'جزایر کوکوس' },
      pol: { official: 'Wyspy Kokosowe', common: 'Wyspy Kokosowe' },
      pt: { official: 'Território dos Cocos (Keeling)', common: 'Ilhas Cocos (Keeling)' },
      ru: { official: 'Территория Кокосовые (Килинг) острова', common: 'Кокосовые острова' },
      slk: { official: 'Kokosové ostrovy', common: 'Kokosové ostrovy' },
      es: { official: 'Territorio de los (Keeling) Islas Cocos', common: 'Islas Cocos o Islas Keeling' },
      swe: { official: 'Kokosöarna', common: 'Kokosöarna' },
      tr: { official: 'Cocos (Keeling) Adaları', common: 'Cocos (Keeling) Adaları' },
      urd: { official: 'جزائر (کیلنگ) کوکوس', common: 'جزائر کوکوس' },
      cn: { official: '科科斯', common: '科科斯' },
    },
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'パレスチナ自治政府', common: 'パレスチナ' },
      kr: { official: '팔레스타인국', common: '팔레스타인' },
      nld: { official: 'Staat Palestina', common: 'Palestijnse gebieden' },
      ir: { official: 'دولت فلسطین', common: 'فلسطین' },
      pol: { official: 'Państwo Palestyna', common: 'Palestyna' },
      pt: { official: 'Estado da Palestina', common: 'Palestina' },
      ru: { official: 'Государство Палестина', common: 'Палестина' },
      ...
      tr: { official: 'Filistin Devleti', common: 'Filistin' },
      urd: { official: 'ریاستِ فلسطین', common: 'فلسطین' },
      cn: { official: '巴勒斯坦国', common: '巴勒斯坦' },
    },
    latlng: [31.9, 35.2],
    landlocked: false,
    borders: ['ISR', 'EGY', 'JOR'],
    area: 6220.0,
    demonyms: { eng: { f: 'Palestinian', m: 'Palestinian' }, fr: { f: 'Palestinienne', m: 'Palestinien' } },
    flag: '\uD83C\uDDF5\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: '島のピトケアングループ', common: 'ピトケアン' },
      kr: { official: '핏케언 제도', common: '핏케언 제도' },
      nld: { official: 'Pitcairn groep eilanden', common: 'Pitcairneilanden' },
      ir: { official: 'جزایر پیت‌کرن', common: 'جزایر پیت‌کرن' },
      pol: { official: 'Wyspy Pitcairn, Henderson, Ducie i Oeno', common: 'Pitcairn' },
      pt: { official: 'Pitcairn grupo de ilhas', common: 'Ilhas Pitcairn' },
      ru: { official: 'Питкэрн группа островов', common: 'Острова Питкэрн' },
      ...
      tr: { official: 'Pitcairn, Henderson, Ducie ve Oeno Adaları', common: 'Pitcairn Adaları' },
      urd: { official: 'پٹکیرن جزائر', common: 'جزائر پٹکیرن' },
      cn: { official: '皮特凯恩群岛', common: '皮特凯恩群岛' },
    },
    latlng: [-25.06666666, -130.1],
    landlocked: false,
    area: 47.0,
    demonyms: { eng: { f: 'Pitcairn Islander', m: 'Pitcairn Islander' }, fr: { f: 'Pitcairnaise', m: 'Pitcairnais' } },
    flag: '\uD83C\uDDF5\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'バルバドス', common: 'バルバドス' },
      kr: { official: '바베이도스', common: '바베이도스' },
      nld: { official: 'Barbados', common: 'Barbados' },
      ir: { official: 'باربادوس', common: 'باربادوس' },
      pol: { official: 'Barbados', common: 'Barbados' },
      pt: { official: 'Barbados', common: 'Barbados' },
      ru: { official: 'Барбадос', common: 'Барбадос' },
      slk: { official: 'Barbados', common: 'Barbados' },
      es: { official: 'Barbados', common: 'Barbados' },
      swe: { official: 'Barbados', common: 'Barbados' },
      tr: { official: 'Barbados', common: 'Barbados' },
      urd: { official: 'بارباڈوس', common: 'بارباڈوس' },
      cn: { official: '巴巴多斯', common: '巴巴多斯' },
    },
    latlng: [13.16666666, -59.53333333],
    landlocked: false,
    area: 430.0,
    demonyms: { eng: { f: 'Barbadian', m: 'Barbadian' }, fr: { f: 'Barbadienne', m: 'Barbadien' } },
    flag: '\uD83C\uDDE7\uD83C\uDDE7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Republik Kiribati', common: 'Kiribati' },
      ...
      it: { official: 'Repubblica indipendente e sovrano di Kiribati', common: 'Kiribati' },
      jp: { official: 'キリバスの独立と主権共和国', common: 'キリバス' },
      kr: { official: '키리바시 공화국', common: '키리바시' },
      nld: { official: 'Onafhankelijke en soevereine republiek Kiribati', common: 'Kiribati' },
      ir: { official: 'جمهوری کیریباتی', common: 'کیریباتی' },
      pol: { official: 'Republika Kiribati', common: 'Kiribati' },
      pt: { official: 'Independente e soberano República de Kiribati', common: 'Kiribati' },
      ru: { official: 'Независимой и суверенной Республики Кирибати', common: 'Кирибати' },
      slk: { official: 'Kiribatská republika', common: 'Kiribati' },
      es: { official: 'República Independiente y Soberano de Kiribati', common: 'Kiribati' },
      swe: { official: 'Republiken Kiribati', common: 'Kiribati' },
      tr: { official: 'Kiribati Cumhuriyeti', common: 'Kiribati' },
      urd: { official: 'سلطنت آزاد جمہوریہ کیریباتی', common: 'کیریباتی' },
      cn: { official: '基里巴斯共和国', common: '基里巴斯' },
    },
    latlng: [1.41666666, 173.0],
    landlocked: false,
    area: 811.0,
    demonyms: { eng: { f: 'I-Kiribati', m: 'I-Kiribati' }, fr: { f: 'Kiribatienne', m: 'Kiribatien' } },
    flag: '\uD83C\uDDF0\uD83C\uDDEE',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        vcym: { official: 'Riphabuḽiki ya Afurika Tshipembe', common: 'Afurika Tshipembe' },
    ...
    translations: {
      ...
      de: { official: 'Republik Südafrika', common: 'Südafrika' },
      ...
      fr: { official: "République d'Afrique du Sud", common: 'Afrique du Sud' },
      ...
      jp: { official: '南アフリカ共和国', common: '南アフリカ' },
      kr: { official: '남아프리카 공화국', common: '남아프리카' },
      nld: { official: 'Republiek Zuid-Afrika', common: 'Zuid-Afrika' },
      ir: { official: 'جمهوری آفریقای جنوبی', common: 'آفریقای جنوبی' },
      pol: { official: 'Republika Południowej Afryki', common: 'Południowa Afryka' },
      pt: { official: 'República da África do Sul', common: 'África do Sul' },
      ru: { official: 'Южно-Африканская Республика', common: 'Южная Африка' },
      slk: { official: 'Juhoafrická republika', common: 'Južná Afrika' },
      es: { official: 'República de Sudáfrica', common: 'Sudáfrica' },
      swe: { official: 'Republiken Sydafrika', common: 'Sydafrika' },
      tr: { official: 'Güney Afrika Cumhuriyeti', common: 'Güney Afrika' },
      urd: { official: 'جمہوریہ جنوبی افریقا', common: 'جنوبی افریقا' },
      cn: { official: '南非共和国', common: '南非' },
    },
    latlng: [-29.0, 24.0],
    landlocked: false,
    borders: ['BWA', 'LSO', 'MOZ', 'NAM', 'SWZ', 'ZWE'],
    area: 1221037.0,
    demonyms: { eng: { f: 'South African', m: 'South African' }, fr: { f: 'Sud-africaine', m: 'Sud-africain' } },
    flag: '\uD83C\uDDFF\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'モンゴル', common: 'モンゴル' },
      kr: { official: '몽골', common: '몽골국' },
      nld: { official: 'Mongolië', common: 'Mongolië' },
      ir: { official: 'مغولستان', common: 'مغولستان' },
      pol: { official: 'Mongolia', common: 'Mongolia' },
      pt: { official: 'Mongólia', common: 'Mongólia' },
      ru: { official: 'Монголия', common: 'Монголия' },
      slk: { official: 'Mongolsko', common: 'Mongolsko' },
      es: { official: 'Mongolia', common: 'Mongolia' },
      swe: { official: 'Mongoliet', common: 'Mongoliet' },
      tr: { official: 'Moğolistan', common: 'Moğolistan' },
      urd: { official: 'منگولیا', common: 'منگولیا' },
      cn: { official: '蒙古', common: '蒙古' },
    },
    latlng: [46.0, 105.0],
    landlocked: true,
    borders: ['CHN', 'RUS'],
    area: 1564110.0,
    demonyms: { eng: { f: 'Mongolian', m: 'Mongolian' }, fr: { f: 'Mongole', m: 'Mongol' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        tr: { official: 'Kıbrıs Cumhuriyeti', common: 'Kıbrıs' },
      },
    },
    tld: ['.cy'],
    code: 'CY',
    ...
    region: 'Europe',
    subregion: 'Southern Europe',
    languages: { ell: 'Greek', tr: 'Turkish' },
    translations: {
      ...
      jp: { official: 'キプロス共和国', common: 'キプロス' },
      kr: { official: '키프로스 공화국', common: '키프로스' },
      nld: { official: 'Republiek Cyprus', common: 'Cyprus' },
      ir: { official: 'جمهوری قبرس', common: 'قِبرِس' },
      pol: { official: 'Republika Cypryjska', common: 'Cypr' },
      pt: { official: 'República de Chipre', common: 'Chipre' },
      ru: { official: 'Республика Кипр', common: 'Кипр' },
      ...
      cn: { official: '塞浦路斯共和国', common: '塞浦路斯' },
    },
    latlng: [35.0, 33.0],
    landlocked: false,
    area: 9251.0,
    demonyms: { eng: { f: 'Cypriot', m: 'Cypriot' }, fr: { f: 'Chypriote', m: 'Chypriote' } },
    flag: '\uD83C\uDDE8\uD83C\uDDFE',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        fr: { official: 'République de Maurice', common: 'Maurice' },
    ...
    region: 'Africa',
    subregion: 'Eastern Africa',
    languages: { eng: 'English', fr: 'French', mfe: 'Mauritian Creole' },
    translations: {
      ...
      fr: { official: 'République de Maurice', common: 'Île Maurice' },
      ...
      jp: { official: 'モーリシャス共和国', common: 'モーリシャス' },
      kr: { official: '모리셔스 공화국', common: '모리셔스' },
      nld: { official: 'Republiek Mauritius', common: 'Mauritius' },
      ir: { official: 'جمهوری موریس', common: 'موریس' },
      pol: { official: 'Republika Mauritiusu', common: 'Mauritius' },
      pt: { official: 'República das Maurícias', common: 'Maurício' },
      ru: { official: 'Республика Маврикий', common: 'Маврикий' },
      ...
      tr: { official: 'Mauritius Cumhuriyeti', common: 'Mauritius' },
      urd: { official: 'جمہوریہ موریشس', common: 'موریشس' },
      cn: { official: '毛里求斯共和国', common: '毛里求斯' },
    },
    latlng: [-20.28333333, 57.55],
    landlocked: false,
    area: 2040.0,
    demonyms: { eng: { f: 'Mauritian', m: 'Mauritian' }, fr: { f: 'Mauricienne', m: 'Mauricien' } },
    flag: '\uD83C\uDDF2\uD83C\uDDFA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'アンチグアバーブーダ', common: 'アンティグア・バーブーダ' },
      kr: { official: '앤티가 바부다', common: '앤티가 바부다' },
      nld: { official: 'Antigua en Barbuda', common: 'Antigua en Barbuda' },
      ir: { official: 'آنتیگوا و باربودا', common: 'آنتیگوا و باربودا' },
      pol: { official: 'Antigua i Barbuda', common: 'Antigua i Barbuda' },
      pt: { official: 'Antigua e Barbuda', common: 'Antígua e Barbuda' },
      ru: { official: 'Антигуа и Барбуда', common: 'Антигуа и Барбуда' },
      ...
      tr: { official: 'Antigua ve Barbuda', common: 'Antigua ve Barbuda' },
      urd: { official: 'اینٹیگوا و باربوڈا', common: 'اینٹیگوا و باربوڈا' },
      cn: { official: '安提瓜和巴布达', common: '安提瓜和巴布达' },
    },
    latlng: [17.05, -61.8],
    landlocked: false,
    area: 442.0,
    demonyms: {
      ...
      fr: { f: 'Antiguaise et barbudienne', m: 'Antiguaise et barbudien' },
    },
    flag: '\uD83C\uDDE6\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'Saint-Martin', common: 'Saint-Martin' } },
    },
    tld: ['.fr', '.gp'],
    code: 'MF',
    ccn3: '663',
    ...
    translations: {
      ...
      de: { official: 'Saint-Martin', common: 'Saint-Martin' },
      ...
      jp: { official: 'サンマルタン島', common: 'サン・マルタン（フランス領）' },
      kr: { official: '생마르탱', common: '생마르탱' },
      nld: { official: 'Saint Martin', common: 'Saint-Martin' },
      ir: { official: 'سن مارتن', common: 'سن مارتن' },
      pol: { official: 'Wspólnota Saint-Martin', common: 'Saint-Martin' },
      pt: { official: 'saint Martin', common: 'São Martinho' },
      ru: { official: 'Сен-Мартен', common: 'Сен-Мартен' },
      ...
      tr: { official: 'Saint Martin', common: 'Saint Martin' },
      urd: { official: 'سینٹ مارٹن', common: 'سینٹ مارٹن' },
      cn: { official: '圣马丁', common: '圣马丁' },
    },
    ...
    demonyms: {
      ...
      fr: { f: 'Saint-Martinoise', m: 'Saint-Martinois' },
    },
    flag: '\uD83C\uDDF2\uD83C\uDDEB',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'Ile de la Réunion', common: 'La Réunion' } },
    },
    tld: ['.re'],
    code: 'RE',
    ccn3: '638',
    ...
    translations: {
      ...
      jp: { official: 'レユニオン島', common: 'レユニオン' },
      kr: { official: '레위니옹', common: '레위니옹' },
      nld: { official: 'Réunion', common: 'Réunion' },
      ir: { official: 'رئونیون', common: 'رئونیون' },
      pol: { official: 'Reunion', common: 'Reunion' },
      pt: { official: 'Ilha da Reunião', common: 'Reunião' },
      ru: { official: 'Реюньон', common: 'Реюньон' },
      ...
      tr: { official: 'Réunion', common: 'Réunion' },
      urd: { official: 'رے یونیوں جزیرہ', common: 'رے یونیوں' },
      cn: { official: '留尼旺岛', common: '留尼旺岛' },
    },
    latlng: [-21.15, 55.5],
    landlocked: false,
    area: 2511.0,
    demonyms: { eng: { f: 'Réunionese', m: 'Réunionese' }, fr: { f: 'Réunionnaise', m: 'Réunionnais' } },
    flag: '\uD83C\uDDF7\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'バミューダ', common: 'バミューダ' },
      kr: { official: '버뮤다', common: '버뮤다' },
      nld: { official: 'Bermuda', common: 'Bermuda' },
      ir: { official: 'جزایر برمودا', common: 'برمودا' },
      pol: { official: 'Bermudy', common: 'Bermudy' },
      pt: { official: 'Bermudas', common: 'Bermudas' },
      ru: { official: 'Бермудские острова', common: 'Бермудские Острова' },
      slk: { official: 'Bermudy', common: 'Bermudy' },
      es: { official: 'Bermuda', common: 'Bermudas' },
      swe: { official: 'Bermuda', common: 'Bermuda' },
      tr: { official: 'Bermuda', common: 'Bermuda' },
      urd: { official: 'برمودا', common: 'برمودا' },
      cn: { official: '百慕大', common: '百慕大' },
    },
    latlng: [32.33333333, -64.75],
    landlocked: false,
    area: 54.0,
    demonyms: { eng: { f: 'Bermudian', m: 'Bermudian' }, fr: { f: 'Bermudienne', m: 'Bermudien' } },
    flag: '\uD83C\uDDE7\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'Principauté de Monaco', common: 'Monaco' } },
    },
    tld: ['.mc'],
    code: 'MC',
    ccn3: '492',
    ...
    translations: {
      ...
      jp: { official: 'モナコ公国', common: 'モナコ' },
      kr: { official: '모나코 공국', common: '모나코' },
      nld: { official: 'Vorstendom Monaco', common: 'Monaco' },
      ir: { official: 'شاهزاده‌نشین موناکو', common: 'موناکو' },
      pol: { official: 'Księstwo Monako', common: 'Monako' },
      pt: { official: 'Principado do Mónaco', common: 'Mónaco' },
      ru: { official: 'Княжество Монако', common: 'Монако' },
      ...
      tr: { official: 'Monako Prensliği', common: 'Monako' },
      urd: { official: 'جمہوریہ مناکو', common: 'موناکو' },
      cn: { official: '摩纳哥公国', common: '摩纳哥' },
    },
    latlng: [43.73333333, 7.4],
    landlocked: false,
    borders: ['FRA'],
    area: 2.02,
    demonyms: { eng: { f: 'Monegasque', m: 'Monegasque' }, fr: { f: 'Monégasque', m: 'Monégasque' } },
    flag: '\uD83C\uDDF2\uD83C\uDDE8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Land Curaçao', common: 'Curaçao' },
      est: { official: 'Curaçao', common: 'Curaçao' },
      fin: { official: 'Curaçao', common: 'Curaçao' },
      fr: { official: 'Pays de Curaçao', common: 'Curaçao' },
      hun: { official: 'Curaçao', common: 'Curaçao' },
      it: { official: 'Paese di Curaçao', common: 'Curaçao' },
      kr: { official: '퀴라소', common: '퀴라소' },
      nld: { official: 'Land Curaçao', common: 'Curaçao' },
      ir: { official: 'کوراسائو', common: 'کوراسائو' },
      pol: { official: 'Curaçao', common: 'Curaçao' },
      pt: { official: 'País de Curaçao', common: 'ilha da Curação' },
      ru: { official: 'Страна Кюрасао', common: 'Кюрасао' },
      slk: { official: 'Curacao', common: 'Curacao' },
      es: { official: 'País de Curazao', common: 'Curazao' },
      swe: { official: 'Curaçao', common: 'Curaçao' },
      tr: { official: 'Curaçao', common: 'Curaçao' },
      urd: { official: 'مملکتِ کیوراساؤ', common: 'کیوراساؤ' },
      cn: { official: '库拉索', common: '库拉索' },
    },
    latlng: [12.116667, -68.933333],
    landlocked: false,
    area: 444.0,
    demonyms: { eng: { f: 'Curaçaoan', m: 'Curaçaoan' }, fr: { f: 'Curacienne', m: 'Curacien' } },
    flag: '\uD83C\uDDE8\uD83C\uDDFC',
    maps: {
  ...
  },
  {
    ...
    region: 'Europe',
    subregion: 'Northern Europe',
    languages: { eng: 'English', fr: 'French', nrf: 'Jèrriais' },
    translations: {
      ...
      jp: { official: 'ジャージの得意分野', common: 'ジャージー' },
      kr: { official: '저지 섬', common: '저지 섬' },
      nld: { official: 'Baljuwschap Jersey', common: 'Jersey' },
      ir: { official: 'جرزی', common: 'جرزی' },
      pol: { official: 'Jersey', common: 'Jersey' },
      pt: { official: 'Bailiado de Jersey', common: 'Jersey' },
      ru: { official: 'Коронное владение Джерси', common: 'Джерси' },
      slk: { official: 'Bailiwick Jersey', common: 'Jersey' },
      es: { official: 'Bailía de Jersey', common: 'Jersey' },
      swe: { official: 'Jersey', common: 'Jersey' },
      tr: { official: 'Jersey', common: 'Jersey' },
      urd: { official: 'جرزی', common: 'جرزی' },
      cn: { official: '泽西岛', common: '泽西岛' },
    },
    latlng: [49.25, -2.16666666],
    landlocked: false,
    area: 116.0,
    demonyms: { eng: { f: 'Channel Islander', m: 'Channel Islander' }, fr: { f: 'Jersiaise', m: 'Jersiais' } },
    flag: '\uD83C\uDDEF\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'カンボジア王国', common: 'カンボジア' },
      kr: { official: '캄보디아 왕국', common: '캄보디아' },
      nld: { official: 'Koninkrijk Cambodja', common: 'Cambodja' },
      ir: { official: 'پادشاهی کامبوج', common: 'کامبوج' },
      pol: { official: 'Królestwo Kambodży', common: 'Kambodża' },
      pt: { official: 'Reino do Camboja', common: 'Camboja' },
      ru: { official: 'Королевство Камбоджа', common: 'Камбоджа' },
      ...
      tr: { official: 'Kamboçya Krallığı', common: 'Kamboçya' },
      urd: { official: 'مملکتِ کمبوڈیا', common: 'کمبوڈیا' },
      cn: { official: '柬埔寨王国', common: '柬埔寨' },
    },
    latlng: [13.0, 105.0],
    landlocked: false,
    borders: ['LAO', 'THA', 'VNM'],
    area: 181035.0,
    demonyms: { eng: { f: 'Cambodian', m: 'Cambodian' }, fr: { f: 'Cambodgienne', m: 'Cambodgien' } },
    flag: '\uD83C\uDDF0\uD83C\uDDED',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'スーダン共和国', common: 'スーダン' },
      kr: { official: '수단 공화국', common: '수단' },
      nld: { official: 'Republiek Soedan', common: 'Soedan' },
      ir: { official: 'جمهوری سودان', common: 'سودان' },
      pol: { official: 'Republika Sudanu', common: 'Sudan' },
      pt: { official: 'República do Sudão', common: 'Sudão' },
      ru: { official: 'Республика Судан', common: 'Судан' },
      ...
      tr: { official: 'Sudan Cumhuriyeti', common: 'Sudan' },
      urd: { official: 'جمہوریہ سودان', common: 'سودان' },
      cn: { official: '苏丹共和国', common: '苏丹' },
    },
    latlng: [15.0, 30.0],
    landlocked: false,
    borders: ['CAF', 'TCD', 'EGY', 'ERI', 'ETH', 'LBY', 'SSD'],
    area: 1886068.0,
    demonyms: { eng: { f: 'Sudanese', m: 'Sudanese' }, fr: { f: 'Soudanaise', m: 'Soudanais' } },
    flag: '\uD83C\uDDF8\uD83C\uDDE9',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'République de Guinée', common: 'Guinée' } },
    },
    tld: ['.gn'],
    code: 'GN',
    ccn3: '324',
    ...
    translations: {
      ...
      jp: { official: 'ギニア共和国', common: 'ギニア' },
      kr: { official: '기니 공화국', common: '기니' },
      nld: { official: 'Republiek Guinee', common: 'Guinee' },
      ir: { official: 'مملکت مستقل پاپوآ گینه نو', common: 'پاپوآ گینه نو' },
      pol: { official: 'Republika Gwinei', common: 'Gwinea' },
      pt: { official: 'República da Guiné', common: 'Guiné' },
      ru: { official: 'Республика Гвинея', common: 'Гвинея' },
      ...
      tr: { official: 'Gine Cumhuriyeti', common: 'Gine' },
      urd: { official: 'جمہوریہ گنی', common: 'گنی' },
      cn: { official: '几内亚共和国', common: '几内亚' },
    },
    latlng: [11.0, -10.0],
    landlocked: false,
    borders: ['CIV', 'GNB', 'LBR', 'MLI', 'SEN', 'SLE'],
    area: 245857.0,
    demonyms: { eng: { f: 'Guinean', m: 'Guinean' }, fr: { f: 'Guinéenne', m: 'Guinéen' } },
    flag: '\uD83C\uDDEC\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Turks und Caicos Inseln', common: 'Turks-und Caicosinseln' },
      ...
      fr: { official: 'Îles Turques et Caïques', common: 'Îles Turques-et-Caïques' },
      ...
      jp: { official: 'タークス·カイコス諸島', common: 'タークス・カイコス諸島' },
      kr: { official: '터크스 케이커스 제도', common: '터크스 케이커스 제도' },
      nld: { official: 'Turks-en Caicoseilanden', common: 'Turks-en Caicoseilanden' },
      ir: { official: 'جزایر تورکس و کایکوس', common: 'جزایر تورکس و کایکوس' },
      pol: { official: 'Turks i Caicos', common: 'Turks i Caicos' },
      pt: { official: 'Ilhas Turks e Caicos', common: 'Ilhas Turks e Caicos' },
      ru: { official: 'Теркс и Кайкос острова', common: 'Теркс и Кайкос' },
      ...
      tr: { official: 'Turks ve Caicos Adaları', common: 'Turks ve Caicos Adaları' },
      urd: { official: 'جزائر کیکس و ترکیہ', common: 'جزائر کیکس و ترکیہ' },
      cn: { official: '特克斯和凯科斯群岛', common: '特克斯和凯科斯群岛' },
    },
  ...
  },
  {
    name: {
      common: 'Martinique',
      official: 'Martinique',
      nativeName: { fr: { official: 'Martinique', common: 'Martinique' } },
    },
    tld: ['.mq'],
    code: 'MQ',
    ccn3: '474',
    ...
    translations: {
      ...
      jp: { official: 'マルティニーク島', common: 'マルティニーク' },
      kr: { official: '마르티니크', common: '마르티니크' },
      nld: { official: 'Martinique', common: 'Martinique' },
      ir: { official: 'مارتینیک', common: 'مارتینیک' },
      pol: { official: 'Martynika', common: 'Martynika' },
      pt: { official: 'Martinique', common: 'Martinica' },
      ru: { official: 'Мартиника', common: 'Мартиника' },
      slk: { official: 'Martinique', common: 'Martinique' },
      es: { official: 'Martinica', common: 'Martinica' },
      swe: { official: 'Martinique', common: 'Martinique' },
      tr: { official: 'Martinik', common: 'Martinik' },
      urd: { official: 'مارٹینیک', common: 'مارٹینیک' },
      cn: { official: '马提尼克', common: '马提尼克' },
    },
    latlng: [14.666667, -61.0],
    landlocked: false,
    area: 1128.0,
    demonyms: { eng: { f: 'Martinican', m: 'Martinican' }, fr: { f: 'Martiniquaise', m: 'Martiniquais' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'République de Slovénie', common: 'Slovénie' },
      ...
      jp: { official: 'スロベニア共和国', common: 'スロベニア' },
      kr: { official: '슬로베니아 공화국', common: '슬로베니아' },
      nld: { official: 'Republiek Slovenië', common: 'Slovenië' },
      ir: { official: 'جمهوری اسلوونی', common: 'اسلوونی' },
      pol: { official: 'Republika Słowenii', common: 'Słowenia' },
      pt: { official: 'República da Eslovénia', common: 'Eslovénia' },
      ru: { official: 'Республика Словения', common: 'Словения' },
      ...
      tr: { official: 'Slovenya Cumhuriyeti', common: 'Slovenya' },
      urd: { official: 'جمہوریہ سلووینیا', common: 'سلووینیا' },
      cn: { official: '斯洛文尼亚共和国', common: '斯洛文尼亚' },
    },
    latlng: [46.11666666, 14.81666666],
    landlocked: false,
    borders: ['AUT', 'HRV', 'ITA', 'HUN'],
    area: 20273.0,
    demonyms: { eng: { f: 'Slovene', m: 'Slovene' }, fr: { f: 'Slovène', m: 'Slovène' } },
    flag: '\uD83C\uDDF8\uD83C\uDDEE',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      it: { official: "Repubblica islamica dell'Iran", common: 'Iran' },
      jp: { official: 'イラン·イスラム共和国', common: 'イラン・イスラム共和国' },
      kr: { official: '이란 이슬람 공화국', common: '이란' },
      nld: { official: 'Islamitische Republiek Iran', common: 'Iran' },
      pol: { official: 'Islamska Republika Iranu', common: 'Iran' },
      pt: { official: 'República Islâmica do Irã', common: 'Irão' },
      ru: { official: 'Исламская Республика Иран', common: 'Иран' },
      slk: { official: 'Iránska islamská republika', common: 'Irán' },
      es: { official: 'República Islámica de Irán', common: 'Iran' },
      swe: { official: 'Islamiska republiken Iran', common: 'Iran' },
      tr: { official: 'İran İslam Cumhuriyeti', common: 'İran' },
      urd: { official: 'جمہوریہ ایران', common: 'ایران' },
      cn: { official: '伊朗伊斯兰共和国', common: '伊朗' },
    },
    latlng: [32.0, 53.0],
    landlocked: false,
    borders: ['AFG', 'ARM', 'AZE', 'IRQ', 'PAK', 'TUR', 'TKM'],
    area: 1648195.0,
    demonyms: { eng: { f: 'Iranian', m: 'Iranian' }, fr: { f: 'Iranienne', m: 'Iranien' } },
    flag: '\uD83C\uDDEE\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'スウェーデン王国', common: 'スウェーデン' },
      kr: { official: '스웨덴 왕국', common: '스웨덴' },
      nld: { official: 'Koninkrijk Zweden', common: 'Zweden' },
      ir: { official: 'پادشاهی سوئد', common: 'سوئد' },
      pol: { official: 'Królestwo Szwecji', common: 'Szwecja' },
      pt: { official: 'Reino da Suécia', common: 'Suécia' },
      ru: { official: 'Королевство Швеция', common: 'Швеция' },
      ...
      tr: { official: 'İsveç Krallığı', common: 'İsveç' },
      urd: { official: 'مملکتِ سویڈن', common: 'سویڈن' },
      cn: { official: '瑞典王国', common: '瑞典' },
    },
    latlng: [62.0, 15.0],
    landlocked: false,
    borders: ['FIN', 'NOR'],
    area: 450295.0,
    demonyms: { eng: { f: 'Swedish', m: 'Swedish' }, fr: { f: 'Suédoise', m: 'Suédois' } },
    flag: '\uD83C\uDDF8\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { bcym: { official: 'বাংলাদেশ গণপ্রজাতন্ত্রী', common: 'বাংলাদেশ' } },
    },
    tld: ['.bd'],
    code: 'BD',
    ccn3: '050',
    ...
    translations: {
      ...
      fr: { official: 'La République populaire du Bangladesh', common: 'Bangladesh' },
      hrv: { official: 'Narodna Republika Bangladeš', common: 'Bangladeš' },
      hun: { official: 'Banglades', common: 'Banglades' },
      it: { official: 'Repubblica popolare del Bangladesh', common: 'Bangladesh' },
      jp: { official: 'バングラデシュ人民共和国', common: 'バングラデシュ' },
      kr: { official: '방글라데시 인민 공화국', common: '방글라데시' },
      nld: { official: 'Volksrepubliek Bangladesh', common: 'Bangladesh' },
      ir: { official: 'جمهوری خلق بنگلادش', common: 'بنگلادش' },
      pol: { official: 'Ludowa Republika Bangladeszu', common: 'Bangladesz' },
      pt: { official: 'República Popular do Bangladesh', common: 'Bangladesh' },
      ru: { official: 'Народная Республика Бангладеш', common: 'Бангладеш' },
      slk: { official: 'Bangladéšska ľudová republika', common: 'Bangladéš' },
      es: { official: 'República Popular de Bangladesh', common: 'Bangladesh' },
      swe: { official: 'Folkrepubliken Bangladesh', common: 'Bangladesh' },
      tr: { official: 'Bangladeş Halk Cumhuriyeti', common: 'Bangladeş' },
      urd: { official: 'عوامی جمہوریہ بنگلہ دیش', common: 'بنگلہ دیش' },
      cn: { official: '孟加拉人民共和国', common: '孟加拉国' },
    },
    latlng: [24.0, 90.0],
    landlocked: false,
    borders: ['MMR', 'IND'],
    area: 147570.0,
    demonyms: { eng: { f: 'Bangladeshi', m: 'Bangladeshi' }, fr: { f: 'Bangladaise', m: 'Bangladais' } },
    flag: '\uD83C\uDDE7\uD83C\uDDE9',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      bre: { official: 'Georgia ar Su hag Inizi Sandwich ar Su', common: 'Georgia ar Su hag Inizi Sandwich ar Su' },
      ces: {
      ...
      ir: { official: 'جزایر جورجیای جنوبی و ساندویچ جنوبی', common: 'جزایر جورجیای جنوبی و ساندویچ جنوبی' },
      pol: { official: 'Georgia Południowa i Sandwich Południowy', common: 'Georgia Południowa i Sandwich Południowy' },
      pt: { official: 'Geórgia do Sul e Sandwich do Sul', common: 'Ilhas Geórgia do Sul e Sandwich do Sul' },
      ru: { official: 'Южная Георгия и Южные Сандвичевы острова', common: 'Южная Георгия и Южные Сандвичевы острова' },
      slk: {
      ...
      tr: { official: 'Güney Georgia ve Güney Sandwich Adaları', common: 'Güney Georgia ve Güney Sandwich Adaları' },
      urd: { official: 'جنوبی جارجیا و جزائر جنوبی سینڈوچ', common: 'جنوبی جارجیا' },
      cn: { official: '南乔治亚岛和南桑威奇群岛', common: '南乔治亚' },
    },
    latlng: [-54.5, -37.0],
    landlocked: false,
    area: 3903.0,
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Amerikanische Jungferninseln', common: 'Amerikanische Jungferninseln' },
      ...
      fr: { official: 'Îles Vierges des États-Unis', common: 'Îles Vierges des États-Unis' },
      ...
      it: { official: 'Isole Vergini degli Stati Uniti', common: 'Isole Vergini americane' },
      jp: { official: '米国のバージン諸島', common: 'アメリカ領ヴァージン諸島' },
      kr: { official: '미국령 버진아일랜드', common: '미국령 버진아일랜드' },
      nld: { official: 'Maagdeneilanden van de Verenigde Staten', common: 'Amerikaanse Maagdeneilanden' },
      ir: { official: 'جزایر ویرجین ایالات متحده آمریکا', common: 'جزایر ویرجین ایالات متحده آمریکا' },
      pol: { official: 'Wyspy Dziewicze Stanów Zjednoczonych', common: 'Wyspy Dziewicze Stanów Zjednoczonych' },
      pt: { official: 'Ilhas Virgens dos Estados Unidos', common: 'Ilhas Virgens dos Estados Unidos' },
      ru: { official: 'Виргинские острова Соединенных Штатов', common: 'Виргинские Острова' },
      slk: { official: 'Americké Panenské ostrovy', common: 'Americké Panenské ostrovy' },
      es: { official: 'Islas Vírgenes de los Estados Unidos', common: 'Islas Vírgenes de los Estados Unidos' },
      swe: { official: 'Amerikanska Jungfruöarna', common: 'Amerikanska Jungfruöarna' },
      tr: { official: 'Amerika Birleşik Devletleri Virjin Adaları', common: 'ABD Virjin Adaları' },
      urd: { official: 'امریکی جزائر ورجن', common: 'امریکی جزائر ورجن' },
      cn: { official: '美属维尔京群岛', common: '美属维尔京群岛' },
    },
    ...
    demonyms: { eng: { f: 'Virgin Islander', m: 'Virgin Islander' } },
    flag: '\uD83C\uDDFB\uD83C\uDDEE',
    maps: { googleMaps: 'https://goo.gl/maps/mBfreywj8dor6q4m9', openStreetMaps: 'openstreetmap.org/relation/286898' },
    population: 106290,
    fifa: 'VIR',
  ...
  },
  {
    ...
    translations: {
      ...
      it: { official: 'Territorio della australi e antartiche francesi Terre', common: 'Territori Francesi del Sud' },
      jp: { official: 'フランス領南方·南極地域の領土', common: 'フランス領南方・南極地域' },
      kr: { official: '프랑스령 남부와 남극 지역', common: '프랑스령 남부와 남극 지역' },
      nld: {
      ...
      ir: { official: 'سرزمین‌های جنوبی و جنوبگانی فرانسه', common: 'سرزمین‌های جنوبی و جنوبگانی فرانسه' },
      pol: {
        official: 'Francuskie Terytoria Południowe i Antarktyczne',
        common: 'Francuskie Terytoria Południowe i Antarktyczne',
      },
      pt: { official: 'Território do Sul e Antártica Francesa', common: 'Terras Austrais e Antárticas Francesas' },
      ru: {
      ...
      tr: { official: 'Fransız Güney ve Antarktika Toprakları', common: 'Fransız Güney ve Antarktika Toprakları' },
      urd: { official: 'سرزمینِ جنوبی فرانسیسیہ و انٹارکٹیکہ', common: 'سرزمین جنوبی فرانسیسیہ و انٹارکٹیکا' },
      cn: { official: '法国南部和南极土地', common: '法国南部和南极土地' },
    },
    latlng: [-49.25, 69.167],
    landlocked: false,
    area: 7747.0,
    demonyms: { eng: { f: 'French', m: 'French' }, fr: { f: 'Française', m: 'Français' } },
    flag: '\uD83C\uDDF9\uD83C\uDDEB',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'モルディブ共和国', common: 'モルディブ' },
      kr: { official: '몰디브 공화국', common: '몰디브' },
      nld: { official: 'Republiek van de Malediven', common: 'Maldiven' },
      ir: { official: 'جمهوری مالدیو', common: 'مالدیو' },
      pol: { official: 'Republika Malediwów', common: 'Malediwy' },
      pt: { official: 'República das Maldivas', common: 'Maldivas' },
      ru: { official: 'Республика Мальдивы', common: 'Мальдивы' },
      ...
      tr: { official: 'Maldivler Cumhuriyeti', common: 'Maldivler' },
      urd: { official: 'جمہوریہ مالدیپ', common: 'مالدیپ' },
      cn: { official: '马尔代夫共和国', common: '马尔代夫' },
    },
    latlng: [3.25, 73.0],
    landlocked: false,
    area: 300.0,
    demonyms: { eng: { f: 'Maldivan', m: 'Maldivan' }, fr: { f: 'Maldivienne', m: 'Maldivien' } },
    flag: '\uD83C\uDDF2\uD83C\uDDFB',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ギリシャ共和国', common: 'ギリシャ' },
      kr: { official: '그리스 공화국', common: '그리스' },
      nld: { official: 'Helleense Republiek', common: 'Griekenland' },
      ir: { official: 'جمهوری یونان', common: 'یونان' },
      pol: { official: 'Republika Grecka', common: 'Grecja' },
      pt: { official: 'República Helénica', common: 'Grécia' },
      ru: { official: 'Греческая Республика', common: 'Греция' },
      ...
      tr: { official: 'Helen Cumhuriyeti', common: 'Yunanistan' },
      urd: { official: 'جمہوریہ ہیلینیہ', common: 'یونان' },
      cn: { official: '希腊共和国', common: '希腊' },
    },
    latlng: [39.0, 22.0],
    landlocked: false,
    borders: ['ALB', 'BGR', 'TUR', 'MKD'],
    area: 131990.0,
    demonyms: { eng: { f: 'Greek', m: 'Greek' }, fr: { f: 'Grecque', m: 'Grec' } },
    flag: '\uD83C\uDDEC\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'エストニア共和国', common: 'エストニア' },
      kr: { official: '에스토니아 공화국', common: '에스토니아' },
      nld: { official: 'Republiek Estland', common: 'Estland' },
      ir: { official: 'جمهوری استونی', common: 'اِستونی' },
      pol: { official: 'Republika Estońska', common: 'Estonia' },
      pt: { official: 'República da Estónia', common: 'Estónia' },
      ru: { official: 'Эстонская Республика', common: 'Эстония' },
      ...
      tr: { official: 'Estonya Cumhuriyeti', common: 'Estonya' },
      urd: { official: 'جمہوریہ اسٹونیا', common: 'اسٹونیا' },
      cn: { official: '爱沙尼亚共和国', common: '爱沙尼亚' },
    },
    latlng: [59.0, 26.0],
    landlocked: false,
    borders: ['LVA', 'RUS'],
    area: 45227.0,
    demonyms: { eng: { f: 'Estonian', m: 'Estonian' }, fr: { f: 'Estonienne', m: 'Estonien' } },
    flag: '\uD83C\uDDEA\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'マルタ共和国', common: 'マルタ' },
      kr: { official: '몰타 공화국', common: '몰타' },
      nld: { official: 'Republiek Malta', common: 'Malta' },
      ir: { official: 'جمهوری مالت', common: 'مالت' },
      pol: { official: 'Republika Malty', common: 'Malta' },
      pt: { official: 'República de Malta', common: 'Malta' },
      ru: { official: 'Республика Мальта', common: 'Мальта' },
      ...
      tr: { official: 'Malta Cumhuriyeti', common: 'Malta' },
      urd: { official: 'جمہوریہ مالٹا', common: 'مالٹا' },
      cn: { official: '马耳他共和国', common: '马耳他' },
    },
    latlng: [35.9375, 14.3754],
    landlocked: false,
    area: 316.0,
    demonyms: { eng: { f: 'Maltese', m: 'Maltese' }, fr: { f: 'Maltaise', m: 'Maltais' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'Polynésie française', common: 'Polynésie française' } },
    },
    tld: ['.pf'],
    code: 'PF',
    ccn3: '258',
    ...
    translations: {
      ...
      de: { official: 'Französisch-Polynesien', common: 'Französisch-Polynesien' },
      est: { official: 'Prantsuse Polüneesia', common: 'Prantsuse Polüneesia' },
      fin: { official: 'Ranskan Polynesia', common: 'Ranskan Polynesia' },
      fr: { official: 'Polynésie française', common: 'Polynésie française' },
      ...
      jp: { official: 'フランス領ポリネシア', common: 'フランス領ポリネシア' },
      kr: { official: '프랑스령 폴리네시아', common: '프랑스령 폴리네시아' },
      nld: { official: 'Frans-Polynesië', common: 'Frans-Polynesië' },
      ir: { official: 'پُلی‌نِزی فرانسه', common: 'پُلی‌نِزی فرانسه' },
      pol: { official: 'Polinezja Francuska', common: 'Polinezja Francuska' },
      pt: { official: 'Polinésia Francesa', common: 'Polinésia Francesa' },
      ru: { official: 'Французская Полинезия', common: 'Французская Полинезия' },
      ...
      tr: { official: 'Fransız Polinezyası', common: 'Fransız Polinezyası' },
      urd: { official: 'فرانسیسی پولینیشیا', common: 'فرانسیسی پولینیشیا' },
      cn: { official: '法属波利尼西亚', common: '法属波利尼西亚' },
    },
    latlng: [17.6797, 149.4068],
    landlocked: false,
    area: 4167.0,
    demonyms: { eng: { f: 'French Polynesian', m: 'French Polynesian' }, fr: { f: 'Polynésienne', m: 'Polynésien' } },
    flag: '\uD83C\uDDF5\uD83C\uDDEB',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'St. Lucia', common: 'St. Lucia' },
      ...
      jp: { official: 'セントルシア', common: 'セントルシア' },
      kr: { official: '세인트루시아', common: '세인트루시아' },
      nld: { official: 'Saint Lucia', common: 'Saint Lucia' },
      ir: { official: 'سنت لوسیا', common: 'سنت لوسیا' },
      pol: { official: 'Saint Lucia', common: 'Saint Lucia' },
      pt: { official: 'Santa Lúcia', common: 'Santa Lúcia' },
      ru: { official: 'Сент-Люсия', common: 'Сент-Люсия' },
      ...
      tr: { official: 'Saint Lucia', common: 'Saint Lucia' },
      urd: { official: 'سینٹ لوسیا', common: 'سینٹ لوسیا' },
      cn: { official: '圣卢西亚', common: '圣卢西亚' },
    },
    latlng: [13.88333333, -60.96666666],
    landlocked: false,
    area: 616.0,
    demonyms: { eng: { f: 'Saint Lucian', m: 'Saint Lucian' }, fr: { f: 'Saint-Lucienne', m: 'Saint-Lucien' } },
    flag: '\uD83C\uDDF1\uD83C\uDDE8',
    maps: {
  ...
  },
  {
    ...
    region: 'Africa',
    subregion: 'Eastern Africa',
    languages: { eng: 'English', fr: 'French', kin: 'Kinyarwanda' },
    translations: {
      ...
      jp: { official: 'ルワンダ共和国', common: 'ルワンダ' },
      kr: { official: '르완다 공화국', common: '르완다' },
      nld: { official: 'Republiek Rwanda', common: 'Rwanda' },
      ir: { official: 'جمهوری رواندا', common: 'رواندا' },
      pol: { official: 'Republika Rwandy', common: 'Rwanda' },
      pt: { official: 'República do Ruanda', common: 'Ruanda' },
      ru: { official: 'Республика Руанда', common: 'Руанда' },
      ...
      tr: { official: 'Ruanda Cumhuriyeti', common: 'Ruanda' },
      urd: { official: 'جمہوریہ روانڈا', common: 'روانڈا' },
      cn: { official: '卢旺达共和国', common: '卢旺达' },
    },
    latlng: [-2.0, 30.0],
    landlocked: true,
    borders: ['BDI', 'COD', 'TZA', 'UGA'],
    area: 26338.0,
    demonyms: { eng: { f: 'Rwandan', m: 'Rwandan' }, fr: { f: 'Rwandaise', m: 'Rwandais' } },
    flag: '\uD83C\uDDF7\uD83C\uDDFC',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { ru: { official: 'Российская Федерация', common: 'Россия' } },
    },
    tld: ['.ru', '.su', '.рф'],
    code: 'RU',
    ccn3: '643',
    ...
    translations: {
      ...
      jp: { official: 'ロシア連邦', common: 'ロシア連邦' },
      kr: { official: '러시아 연방', common: '러시아' },
      nld: { official: 'Russische Federatie', common: 'Rusland' },
      ir: { official: 'فدراسیون روسیه', common: 'روسیه' },
      pol: { official: 'Federacja Rosyjska', common: 'Rosja' },
      pt: { official: 'Federação Russa', common: 'Rússia' },
      ru: { official: 'Российская Федерация', common: 'Россия' },
      ...
      tr: { official: 'Rusya Federasyonu', common: 'Rusya' },
      urd: { official: 'روسی وفاق', common: 'روس' },
      cn: { official: '俄罗斯联邦', common: '俄罗斯' },
    },
    latlng: [60.0, 100.0],
    landlocked: false,
    borders: ['AZE', 'BLR', 'CHN', 'EST', 'FIN', 'GEO', 'KAZ', 'PRK', 'LVA', 'LTU', 'MNG', 'NOR', 'POL', 'UKR'],
    area: 1.7098242e7,
    demonyms: { eng: { f: 'Russian', m: 'Russian' }, fr: { f: 'Russe', m: 'Russe' } },
    flag: '\uD83C\uDDF7\uD83C\uDDFA',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        ru: { official: 'Республика Беларусь', common: 'Беларусь' },
      },
    },
    tld: ['.by'],
    code: 'BY',
    ...
    region: 'Europe',
    subregion: 'Eastern Europe',
    languages: { bel: 'Belarusian', ru: 'Russian' },
    translations: {
      ...
      fr: { official: 'République de Biélorussie', common: 'Biélorussie' },
      ...
      jp: { official: 'ベラルーシ共和国', common: 'ベラルーシ' },
      kr: { official: '벨라루스 공화국', common: '벨라루스' },
      nld: { official: 'Republiek Belarus', common: 'Wit-Rusland' },
      ir: { official: 'جمهوری بلاروس', common: 'بلاروس' },
      pol: { official: 'Republika Białorusi', common: 'Białoruś' },
      pt: { official: 'República da Bielorrússia', common: 'Bielorússia' },
      ru: { official: 'Республика Беларусь', common: 'Беларусь' },
      ...
      tr: { official: 'Belarus Cumhuriyeti', common: 'Belarus' },
      urd: { official: 'جمہوریہ بیلاروس', common: 'بیلاروس' },
      cn: { official: '白俄罗斯共和国', common: '白俄罗斯' },
    },
    latlng: [53.0, 28.0],
    landlocked: true,
    borders: ['LVA', 'LTU', 'POL', 'RUS', 'UKR'],
    area: 207600.0,
    demonyms: { eng: { f: 'Belarusian', m: 'Belarusian' }, fr: { f: 'Biélorusse', m: 'Biélorusse' } },
    flag: '\uD83C\uDDE7\uD83C\uDDFE',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'クロアチア共和国', common: 'クロアチア' },
      kr: { official: '크로아티아 공화국', common: '크로아티아' },
      nld: { official: 'Republiek Kroatië', common: 'Kroatië' },
      ir: { official: 'جمهوری کرواسی', common: 'کرُواسی' },
      pol: { official: 'Republika Chorwacji', common: 'Chorwacja' },
      pt: { official: 'República da Croácia', common: 'Croácia' },
      ru: { official: 'Республика Хорватия', common: 'Хорватия' },
      ...
      tr: { official: 'Hırvatistan Cumhuriyeti', common: 'Hırvatistan' },
      urd: { official: 'جمہوریہ کرویئشا', common: 'کرویئشا' },
      cn: { official: '克罗地亚共和国', common: '克罗地亚' },
    },
    latlng: [45.16666666, 15.5],
    landlocked: false,
    borders: ['BIH', 'HUN', 'MNE', 'SRB', 'SVN'],
    area: 56594.0,
    demonyms: { eng: { f: 'Croatian', m: 'Croatian' }, fr: { f: 'Croate', m: 'Croate' } },
    flag: '\uD83C\uDDED\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'Collectivité de Saint-Barthélemy', common: 'Saint-Barthélemy' } },
    },
    tld: ['.bl'],
    code: 'BL',
    ccn3: '652',
    ...
    translations: {
      ...
      de: { official: 'Gebietskörperschaft Saint-Barthélemy', common: 'Saint-Barthélemy' },
      ...
      fr: { official: 'Collectivité de Saint-Barthélemy', common: 'Saint-Barthélemy' },
      hrv: { official: 'Kolektivnost sv Barthélemy', common: 'Saint Barthélemy' },
      hun: { official: 'Saint-Barthélemy', common: 'Saint-Barthélemy' },
      it: { official: 'Collettività di Saint Barthélemy', common: 'Antille Francesi' },
      jp: { official: 'サン·バルテルミー島の集合体', common: 'サン・バルテルミー' },
      kr: { official: '생바르텔레미', common: '생바르텔레미' },
      nld: { official: 'Gemeenschap Saint Barthélemy', common: 'Saint Barthélemy' },
      ir: { official: 'سن بارتلمی', common: 'سن بارتلمی' },
      pol: { official: 'Saint-Barthélemy', common: 'Saint-Barthélemy' },
      pt: { official: 'Coletividade de Saint Barthélemy', common: 'São Bartolomeu' },
      ru: { official: 'Коллективность Санкт -Бартельми', common: 'Сен-Бартелеми' },
      slk: { official: 'Svätý Bartolomej', common: 'Svätý Bartolomej' },
      es: { official: 'Colectividad de San Barthélemy', common: 'San Bartolomé' },
      swe: { official: 'Saint-Barthélemy', common: 'Saint-Barthélemy' },
      tr: { official: 'Saint Barthélemy', common: 'Saint Barthélemy' },
      urd: { official: 'سینٹ بارتھیملے', common: 'سینٹ بارتھیملے' },
      cn: { official: '圣巴泰勒米集体', common: '圣巴泰勒米' },
    },
    ...
    demonyms: {
      ...
      fr: { f: 'Barthéloméenne', m: 'Barthéloméen' },
    },
    flag: '\uD83C\uDDE7\uD83C\uDDF1',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ジブラルタル', common: 'ジブラルタル' },
      kr: { official: '지브롤터', common: '지브롤터' },
      nld: { official: 'Gibraltar', common: 'Gibraltar' },
      ir: { official: 'جبل طارق', common: 'جبل طارق' },
      pol: { official: 'Gibraltar', common: 'Gibraltar' },
      pt: { official: 'Gibraltar', common: 'Gibraltar' },
      ru: { official: 'Гибралтар', common: 'Гибралтар' },
      slk: { official: 'Gibraltár', common: 'Gibraltár' },
      es: { official: 'Gibraltar', common: 'Gibraltar' },
      swe: { official: 'Gibraltar', common: 'Gibraltar' },
      tr: { official: 'Cebelitarık', common: 'Cebelitarık' },
      urd: { official: 'جبل الطارق', common: 'جبل الطارق' },
      cn: { official: '直布罗陀', common: '直布罗陀' },
    },
    latlng: [36.13333333, -5.35],
    landlocked: false,
    borders: ['ESP'],
    area: 6.0,
    demonyms: { eng: { f: 'Gibraltar', m: 'Gibraltar' }, fr: { f: 'Gibraltarienne', m: 'Gibraltarien' } },
    flag: '\uD83C\uDDEC\uD83C\uDDEE',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        eng: { official: 'Heard Island and McDonald Islands', common: 'Heard Island and McDonald Islands' },
      },
    },
    tld: ['.hm', '.aq'],
    code: 'HM',
    ...
    translations: {
      ...
      de: { official: 'Heard und McDonaldinseln', common: 'Heard und die McDonaldinseln' },
      ...
      fr: { official: 'Des îles Heard et McDonald', common: 'Îles Heard-et-MacDonald' },
      ...
      it: { official: 'Isole Heard e McDonald', common: 'Isole Heard e McDonald' },
      jp: { official: 'ハード島とマクドナルド諸島', common: 'ハード島とマクドナルド諸島' },
      kr: { official: '허드 맥도널드 제도', common: '허드 맥도널드 제도' },
      nld: { official: 'Heard en McDonaldeilanden', common: 'Heard-en McDonaldeilanden' },
      ir: { official: 'جزیره هرد و جزایر مک‌دونالد', common: 'جزیره هرد و جزایر مک‌دونالد' },
      pol: { official: 'Terytorium Wysp Heard i McDonalda', common: 'Wyspy Heard i McDonalda' },
      pt: { official: 'Ilha Heard e Ilhas McDonald', common: 'Ilha Heard e Ilhas McDonald' },
      ru: { official: 'Остров Херд и острова Макдональд', common: 'Остров Херд и острова Макдональд' },
      slk: { official: 'Teritórium Heardovho ostrova a Macdonaldových ostrovov', common: 'Heardov ostrov' },
      es: { official: 'Islas Heard y McDonald', common: 'Islas Heard y McDonald' },
      swe: { official: 'Heard- och McDonaldöarna', common: 'Heard- och McDonaldöarna' },
      tr: { official: 'Heard Adası ve McDonald Adaları', common: 'Heard Adası ve McDonald Adaları' },
      urd: { official: 'جزیرہ ہرڈ و جزائر مکڈونلڈ', common: 'جزیرہ ہرڈ و جزائر مکڈونلڈ' },
      cn: { official: '赫德岛和麦当劳群岛', common: '赫德岛和麦当劳群岛' },
    },
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República de Chile', common: 'Chile' } },
    },
    tld: ['.cl'],
    code: 'CL',
    ccn3: '152',
    ...
    translations: {
      ...
      jp: { official: 'チリ共和国', common: 'チリ' },
      kr: { official: '칠레 공화국', common: '칠레' },
      nld: { official: 'Republiek Chili', common: 'Chili' },
      ir: { official: 'جمهوری شیلی', common: 'شیلی' },
      pol: { official: 'Republika Chile', common: 'Chile' },
      pt: { official: 'República do Chile', common: 'Chile' },
      ru: { official: 'Республика Чили', common: 'Чили' },
      ...
      tr: { official: 'Şili Cumhuriyeti', common: 'Şili' },
      urd: { official: 'جمہوریہ چلی', common: 'چلی' },
      cn: { official: '智利共和国', common: '智利' },
    },
    latlng: [-30.0, -71.0],
    landlocked: false,
    borders: ['ARG', 'BOL', 'PER'],
    area: 756102.0,
    demonyms: { eng: { f: 'Chilean', m: 'Chilean' }, fr: { f: 'Chilienne', m: 'Chilien' } },
    flag: '\uD83C\uDDE8\uD83C\uDDF1',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: "République d'Arménie", common: 'Arménie' },
      ...
      jp: { official: 'アルメニア共和国', common: 'アルメニア' },
      kr: { official: '아르메니아 공화국', common: '아르메니아' },
      nld: { official: 'Republiek Armenië', common: 'Armenië' },
      ir: { official: 'جمهوری ارمنستان', common: 'ارمنستان' },
      pol: { official: 'Republika Armenii', common: 'Armenia' },
      pt: { official: 'República da Arménia', common: 'Arménia' },
      ru: { official: 'Республика Армения', common: 'Армения' },
      ...
      tr: { official: 'Ermenistan Cumhuriyeti', common: 'Ermenistan' },
      urd: { official: 'جمہوریہ آرمینیا', common: 'آرمینیا' },
      cn: { official: '亚美尼亚共和国', common: '亚美尼亚' },
    },
    latlng: [40.0, 45.0],
    landlocked: true,
    borders: ['AZE', 'GEO', 'IRN', 'TUR'],
    area: 29743.0,
    demonyms: { eng: { f: 'Armenian', m: 'Armenian' }, fr: { f: 'Arménienne', m: 'Arménien' } },
    flag: '\uD83C\uDDE6\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    ...
    region: 'Americas',
    subregion: 'Caribbean',
    languages: { fr: 'French', hat: 'Haitian Creole' },
    translations: {
      ...
      jp: { official: 'ハイチ共和国', common: 'ハイチ' },
      kr: { official: '아이티 공화국', common: '아이티' },
      nld: { official: 'Republiek Haïti', common: 'Haïti' },
      ir: { official: 'جمهوری هائیتی', common: 'هائیتی' },
      pol: { official: 'Republika Haiti', common: 'Haiti' },
      pt: { official: 'República do Haiti', common: 'Haiti' },
      ru: { official: 'Республика Гаити', common: 'Гаити' },
      slk: { official: 'Haitská republika', common: 'Haiti' },
      es: { official: 'República de Haití', common: 'Haití' },
      swe: { official: 'Republiken Haiti', common: 'Haiti' },
      tr: { official: 'Haiti Cumhuriyeti', common: 'Haiti' },
      urd: { official: 'جمہوریہ ہیٹی', common: 'ہیٹی' },
      cn: { official: '海地共和国', common: '海地' },
    },
    latlng: [19.0, -72.41666666],
    landlocked: false,
    borders: ['DOM'],
    area: 27750.0,
    demonyms: { eng: { f: 'Haitian', m: 'Haitian' }, fr: { f: 'Haïtienne', m: 'Haïtien' } },
    flag: '\uD83C\uDDED\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        fr: { official: 'République démocratique du Congo', common: 'RD Congo' },
    ...
    languages: { fr: 'French', kon: 'Kikongo', lin: 'Lingala', lua: 'Tshiluba', swa: 'Swahili' },
    translations: {
      ...
      de: { official: 'Demokratische Republik Kongo', common: 'Kongo (Dem. Rep.)' },
      ...
      fr: { official: 'République démocratique du Congo', common: 'Congo (Rép. dém.)' },
      ...
      it: { official: 'Repubblica Democratica del Congo', common: 'Congo (Rep. Dem.)' },
      jp: { official: 'コンゴ民主共和国', common: 'コンゴ民主共和国' },
      kr: { official: '콩고 민주 공화국', common: '콩고 민주 공화국' },
      nld: { official: 'Democratische Republiek Congo', common: 'Congo (DRC)' },
      ir: { official: 'جمهوری دموکراتیک کنگو', common: 'کنگو دموکراتیک' },
      pol: { official: 'Demokratyczna Republika Konga', common: 'Demokratyczna Republika Konga' },
      pt: { official: 'República Democrática do Congo', common: 'República Democrática do Congo' },
      ru: { official: 'Демократическая Республика Конго', common: 'Демократическая Республика Конго' },
      slk: { official: 'Konžská demokratická republika', common: 'Kongo' },
      es: { official: 'República Democrática del Congo', common: 'Congo (Rep. Dem.)' },
      swe: { official: 'Demokratiska republiken Kongo', common: 'Kongo-Kinshasa' },
      tr: { official: 'Kongo Demokratik Cumhuriyeti', common: 'Kongo Demokratik Cumhuriyeti' },
      urd: { official: 'جمہوری جمہوریہ کانگو', common: 'کانگو' },
      cn: { official: '刚果民主共和国', common: '民主刚果' },
    },
    latlng: [0.0, 25.0],
    landlocked: false,
    borders: ['AGO', 'BDI', 'CAF', 'COG', 'RWA', 'SSD', 'TZA', 'UGA', 'ZMB'],
    area: 2344858.0,
    demonyms: { eng: { f: 'Congolese', m: 'Congolese' }, fr: { f: 'Congolaise', m: 'Congolais' } },
    flag: '\uD83C\uDDE8\uD83C\uDDE9',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'グアム', common: 'グアム' },
      kr: { official: '괌', common: '괌' },
      nld: { official: 'Guam', common: 'Guam' },
      ir: { official: 'گوآم', common: 'گوآم' },
      pol: { official: 'Terytorium Guamu', common: 'Guam' },
      pt: { official: 'Guam', common: 'Guam' },
      ru: { official: 'Гуам', common: 'Гуам' },
      slk: { official: 'Guam', common: 'Guam' },
      es: { official: 'Guam', common: 'Guam' },
      swe: { official: 'Guam', common: 'Guam' },
      tr: { official: 'Guam Toprağı', common: 'Guam' },
      urd: { official: 'گوام', common: 'گوام' },
      cn: { official: '关岛', common: '关岛' },
    },
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'オーランド諸島', common: 'オーランド諸島' },
      kr: { official: '올란드 제도', common: '올란드 제도' },
      nld: { official: 'Åland eilanden', common: 'Ålandeilanden' },
      ir: { official: 'جزایر الند', common: 'جزایر الند' },
      pol: { official: 'Wyspy Alandzkie', common: 'Wyspy Alandzkie' },
      pt: { official: 'Ilhas Åland', common: 'Alândia' },
      ru: { official: 'Аландские острова', common: 'Аландские острова' },
      slk: { official: 'Alandské ostrovy', common: 'Alandy' },
      es: { official: 'Islas Åland', common: 'Alandia' },
      swe: { official: 'Åland', common: 'Åland' },
      tr: { official: 'Åland Adaları', common: 'Åland' },
      urd: { official: 'جزائر اولند', common: 'جزائر اولند' },
      cn: { official: '奥兰群岛', common: '奥兰群岛' },
    },
    latlng: [60.116667, 19.9],
    landlocked: false,
    area: 1580.0,
    demonyms: { eng: { f: 'Ålandish', m: 'Ålandish' }, fr: { f: 'Ålandaise', m: 'Ålandais' } },
    flag: '\uD83C\uDDE6\uD83C\uDDFD',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'イラク共和国', common: 'イラク' },
      kr: { official: '이라크 공화국', common: '이라크' },
      nld: { official: 'Republiek Irak', common: 'Irak' },
      ir: { official: 'جمهوری عراق', common: 'عراق' },
      pol: { official: 'Republika Iraku', common: 'Irak' },
      pt: { official: 'República do Iraque', common: 'Iraque' },
      ru: { official: 'Республика Ирак', common: 'Ирак' },
      ...
      tr: { official: 'Irak Cumhuriyeti', common: 'Irak' },
      urd: { official: 'جمہوریہ عراق', common: 'عراق' },
      cn: { official: '伊拉克共和国', common: '伊拉克' },
    },
    latlng: [33.0, 44.0],
    landlocked: false,
    borders: ['IRN', 'JOR', 'KWT', 'SAU', 'SYR', 'TUR'],
    area: 438317.0,
    demonyms: { eng: { f: 'Iraqi', m: 'Iraqi' }, fr: { f: 'Irakienne', m: 'Irakien' } },
    flag: '\uD83C\uDDEE\uD83C\uDDF6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Königreich Dänemark', common: 'Dänemark' },
      ...
      jp: { official: 'デンマーク王国', common: 'デンマーク' },
      kr: { official: '덴마크 왕국', common: '덴마크' },
      nld: { official: 'Koninkrijk Denemarken', common: 'Denemarken' },
      ir: { official: 'پادشاهی دانمارک', common: 'دانمارک' },
      pol: { official: 'Królestwo Danii', common: 'Dania' },
      pt: { official: 'Reino da Dinamarca', common: 'Dinamarca' },
      ru: { official: 'Королевство Дания', common: 'Дания' },
      ...
      tr: { official: 'Danimarka Krallığı', common: 'Danimarka' },
      urd: { official: 'مملکتِ ڈنمارک', common: 'ڈنمارک' },
      cn: { official: '丹麦王国', common: '丹麦' },
    },
    latlng: [56.0, 10.0],
    landlocked: false,
    borders: ['DEU'],
    area: 43094.0,
    demonyms: { eng: { f: 'Danish', m: 'Danish' }, fr: { f: 'Danoise', m: 'Danois' } },
    flag: '\uD83C\uDDE9\uD83C\uDDF0',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'République fédérale du Nigeria', common: 'Nigéria' },
      ...
      jp: { official: 'ナイジェリア連邦共和国', common: 'ナイジェリア' },
      kr: { official: '나이지리아 연방 공화국', common: '나이지리아' },
      nld: { official: 'Federale Republiek Nigeria', common: 'Nigeria' },
      ir: { official: 'جمهوری فدرال نیجریه', common: 'نیجریه' },
      pol: { official: 'Federalna Republika Nigerii', common: 'Nigeria' },
      pt: { official: 'República Federal da Nigéria', common: 'Nigéria' },
      ru: { official: 'Федеративная Республика Нигерия', common: 'Нигерия' },
      ...
      tr: { official: 'Nijerya Federal Cumhuriyeti', common: 'Nijerya' },
      urd: { official: 'وفاقی جمہوریہ نائجیریا', common: 'نائجیریا' },
      cn: { official: '尼日利亚联邦共和国', common: '尼日利亚' },
    },
    latlng: [10.0, 8.0],
    landlocked: false,
    borders: ['BEN', 'CMR', 'TCD', 'NER'],
    area: 923768.0,
    demonyms: { eng: { f: 'Nigerian', m: 'Nigerian' }, fr: { f: 'Nigériane', m: 'Nigérian' } },
    flag: '\uD83C\uDDF3\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'マラウイ共和国', common: 'マラウイ' },
      kr: { official: '말라위 공화국', common: '말라위' },
      nld: { official: 'Republiek Malawi', common: 'Malawi' },
      ir: { official: 'جمهوری مالاوی', common: 'مالاوی' },
      pol: { official: 'Republika Malawi', common: 'Malawi' },
      pt: { official: 'República do Malawi', common: 'Malawi' },
      ru: { official: 'Республика Малави', common: 'Малави' },
      ...
      tr: { official: 'Malavi Cumhuriyeti', common: 'Malavi' },
      urd: { official: 'جمہوریہ ملاوی', common: 'ملاوی' },
      cn: { official: '马拉维共和国', common: '马拉维' },
    },
    latlng: [-13.5, 34.0],
    landlocked: true,
    borders: ['MOZ', 'TZA', 'ZMB'],
    area: 118484.0,
    demonyms: { eng: { f: 'Malawian', m: 'Malawian' }, fr: { f: 'Malawienne', m: 'Malawien' } },
    flag: '\uD83C\uDDF2\uD83C\uDDFC',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República de Colombia', common: 'Colombia' } },
    },
    tld: ['.co'],
    code: 'CO',
    ccn3: '170',
    ...
    translations: {
      ...
      jp: { official: 'コロンビア共和国', common: 'コロンビア' },
      kr: { official: '콜롬비아 공화국', common: '콜롬비아' },
      nld: { official: 'Republiek Colombia', common: 'Colombia' },
      ir: { official: 'جمهوری کلمبیا', common: 'کلمبیا' },
      pol: { official: 'Republika Kolumbii', common: 'Kolumbia' },
      pt: { official: 'República da Colômbia', common: 'Colômbia' },
      ru: { official: 'Республика Колумбия', common: 'Колумбия' },
      ...
      tr: { official: 'Kolombiya Cumhuriyeti', common: 'Kolombiya' },
      urd: { official: 'جمہوریہ کولمبیا', common: 'کولمبیا' },
      cn: { official: '哥伦比亚共和国', common: '哥伦比亚' },
    },
    latlng: [4.0, -72.0],
    landlocked: false,
    borders: ['BRA', 'ECU', 'PAN', 'PER', 'VEN'],
    area: 1141748.0,
    demonyms: { eng: { f: 'Colombian', m: 'Colombian' }, fr: { f: 'Colombienne', m: 'Colombien' } },
    flag: '\uD83C\uDDE8\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República de Guatemala', common: 'Guatemala' } },
    },
    tld: ['.gt'],
    code: 'GT',
    ccn3: '320',
    ...
    translations: {
      ...
      jp: { official: 'グアテマラ共和国', common: 'グアテマラ' },
      kr: { official: '과테말라 공화국', common: '과테말라' },
      nld: { official: 'Republiek Guatemala', common: 'Guatemala' },
      ir: { official: 'جمهوری گواتِمالا', common: 'گواتِمالا' },
      pol: { official: 'Republika Gwatemali', common: 'Gwatemala' },
      pt: { official: 'República da Guatemala', common: 'Guatemala' },
      ru: { official: 'Республика Гватемала', common: 'Гватемала' },
      ...
      tr: { official: 'Guatemala Cumhuriyeti', common: 'Guatemala' },
      urd: { official: 'جمہوریہ گواتیمالا', common: 'گواتیمالا' },
      cn: { official: '危地马拉共和国', common: '危地马拉' },
    },
    latlng: [15.5, -90.25],
    landlocked: false,
    borders: ['BLZ', 'SLV', 'HND', 'MEX'],
    area: 108889.0,
    demonyms: { eng: { f: 'Guatemalan', m: 'Guatemalan' }, fr: { f: 'Guatémaltèque', m: 'Guatémaltèque' } },
    flag: '\uD83C\uDDEC\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Falklandinseln', common: 'Falklandinseln' },
      ...
      it: { official: 'Isole Falkland', common: 'Isole Falkland o Isole Malvine' },
      jp: { official: 'フォークランド', common: 'フォークランド（マルビナス）諸島' },
      kr: { official: '포클랜드 제도', common: '포클랜드 제도' },
      nld: { official: 'Falkland eilanden', common: 'Falklandeilanden' },
      ir: { official: 'جزایر فالکلند', common: 'جزایر فالکلند' },
      pol: { official: 'Falklandy', common: 'Falklandy' },
      pt: { official: 'Ilhas Malvinas', common: 'Ilhas Malvinas' },
      ru: { official: 'Фолклендские острова', common: 'Фолклендские острова' },
      ...
      tr: { official: 'Falkland (Malvina) Adaları', common: 'Falkland (Malvina) Adaları' },
      urd: { official: 'جزائر فاکلینڈ', common: 'جزائر فاکلینڈ' },
      cn: { official: '福克兰群岛', common: '福克兰群岛' },
    },
    latlng: [-51.75, -59.0],
    landlocked: false,
    area: 12173.0,
    demonyms: { eng: { f: 'Falkland Islander', m: 'Falkland Islander' }, fr: { f: 'Malouinne', m: 'Malouin' } },
    flag: '\uD83C\uDDEB\uD83C\uDDF0',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Republik Trinidad und Tobago', common: 'Trinidad und Tobago' },
      ...
      fr: { official: 'République de Trinité-et-Tobago', common: 'Trinité-et-Tobago' },
      ...
      it: { official: 'Repubblica di Trinidad e Tobago', common: 'Trinidad e Tobago' },
      jp: { official: 'トリニダード·トバゴ共和国', common: 'トリニダード・トバゴ' },
      kr: { official: '트리니다드 토바고 공화국', common: '트리니다드 토바고' },
      nld: { official: 'Republiek Trinidad en Tobago', common: 'Trinidad en Tobago' },
      ir: { official: 'جمهوری ترینیداد و توباگو', common: 'ترینیداد و توباگو' },
      pol: { official: 'Trynidad i Tobago', common: 'Trynidad i Tobago' },
      pt: { official: 'República de Trinidad e Tobago', common: 'Trinidade e Tobago' },
      ru: { official: 'Республика Тринидад и Тобаго', common: 'Тринидад и Тобаго' },
      slk: { official: 'Republika Trinidad a Tobaga', common: 'Trinidad a Tobago' },
      es: { official: 'República de Trinidad y Tobago', common: 'Trinidad y Tobago' },
      swe: { official: 'Republiken Trinidad och Tobago', common: 'Trinidad och Tobago' },
      tr: { official: 'Trinidad ve Tobago', common: 'Trinidad ve Tobago' },
      urd: { official: 'جمہوریہ ٹرینیڈاڈ و ٹوباگو', common: 'ٹرینیڈاڈ و ٹوباگو' },
      cn: { official: '特立尼达和多巴哥共和国', common: '特立尼达和多巴哥' },
    },
    latlng: [10.6918, 61.2225],
    landlocked: false,
    area: 5130.0,
    demonyms: { eng: { f: 'Trinidadian', m: 'Trinidadian' }, fr: { f: 'Trinidadienne', m: 'Trinidadien' } },
    flag: '\uD83C\uDDF9\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    name: {
      common: 'North Krea',
      official: "Democratic People's Republic of Krea",
      nativeName: { kr: { official: '조선민주주의인민공화국', common: '조선' } },
    },
    tld: ['.kp'],
    code: 'KP',
    ccn3: '408',
    ...
    status: 'officially-assigned',
    unMember: true,
    currencies: { KPW: { name: 'North Krean won', symbol: '₩' } },
    idd: { root: '+8', suffixes: ['50'] },
    capital: ['Pyongyang'],
    altSpellings: [
      'KP',
      "Democratic People's Republic of Krea",
      'DPRK',
      '조선민주주의인민공화국',
      'Chosŏn Minjujuŭi Inmin Konghwaguk',
      "Krea, Democratic People's Republic of",
      '북한',
      '북조선',
    ],
    region: 'Asia',
    ...
    translations: {
      ...
      bre: { official: 'Republik Poblel ha Demokratel Krea', common: 'Krea an Norzh' },
      ces: { official: 'Krejská lidově demokratická republika', common: 'Severní Krea' },
      cym: { official: "Democratic People's Republic of Krea", common: 'North Krea' },
      de: { official: 'Demokratische Volksrepublik Krea', common: 'Nordkrea' },
      est: { official: 'Krea Rahvademokraatlik Vabariik', common: 'Põhja-Krea' },
      fin: { official: 'Krean demokraattinen kansantasavalta', common: 'Pohjois-Krea' },
      fr: { official: 'République populaire démocratique de Corée', common: 'Corée du Nord' },
      hrv: { official: 'Demokratska Narodna Republika Kreja', common: 'Sjeverna Kreja' },
      hun: { official: 'Kreai Népi Demokratikus Köztársaság', common: 'Észak-Krea' },
      it: { official: 'Repubblica democratica popolare di Corea', common: 'Corea del Nord' },
      jp: { official: '朝鮮民主主義人民共和国', common: '朝鮮民主主義人民共和国' },
      kr: { official: '조선민주주의인민공화국', common: '조선' },
      nld: { official: 'Democratische Volksrepubliek Krea', common: 'Noord-Krea' },
      ir: { official: 'جمهوری دموکراتیک خلق کره', common: 'کُره شمالی' },
      pol: { official: 'Kreańska Republika Ludowo-Demokratyczna', common: 'Krea Północna' },
      pt: { official: 'República Popular Democrática da Coreia', common: 'Coreia do Norte' },
      ru: { official: 'Корейская Народно-Демократическая Республика Корея', common: 'Северная Корея' },
      slk: { official: 'Kórejská ľudovodemokratická republika', common: 'Severná Kórea' },
      es: { official: 'República Popular Democrática de Corea', common: 'Corea del Norte' },
      swe: { official: 'Demokratiska Folkrepubliken Krea', common: 'Nordkrea' },
      tr: { official: 'Kre Demokratik Halk Cumhuriyeti', common: 'Kuzey Kre' },
      urd: { official: 'جمہوری عوامی جمہوریہ کوریا', common: 'شمالی کوریا' },
      cn: { official: '朝鲜人民民主共和国', common: '朝鲜' },
    },
    latlng: [40.0, 127.0],
    landlocked: false,
    borders: ['CHN', 'KR', 'RUS'],
    area: 120538.0,
    demonyms: { eng: { f: 'North Krean', m: 'North Krean' }, fr: { f: 'Nord-coréenne', m: 'Nord-coréen' } },
    flag: '\uD83C\uDDF0\uD83C\uDDF5',
    maps: {
  ...
  },
  {
    name: {
      common: 'Tuvalu',
      official: 'Tuvalu',
      nativeName: { eng: { official: 'Tuvalu', common: 'Tuvalu' }, tvl: { official: 'Tuvalu', common: 'Tuvalu' } },
    },
    tld: ['.tv'],
    code: 'TV',
    ccn3: '798',
    ...
    translations: {
      ...
      jp: { official: 'ツバル', common: 'ツバル' },
      kr: { official: '투발루', common: '투발루' },
      nld: { official: 'Tuvalu', common: 'Tuvalu' },
      ir: { official: 'تووالو', common: 'تووالو' },
      pol: { official: 'Tuvalu', common: 'Tuvalu' },
      pt: { official: 'Tuvalu', common: 'Tuvalu' },
      ru: { official: 'Тувалу', common: 'Тувалу' },
      slk: { official: 'Tuvalu', common: 'Tuvalu' },
      es: { official: 'Tuvalu', common: 'Tuvalu' },
      swe: { official: 'Tuvalu', common: 'Tuvalu' },
      tr: { official: 'Tuvalu', common: 'Tuvalu' },
      urd: { official: 'تووالو', common: 'تووالو' },
      cn: { official: '图瓦卢', common: '图瓦卢' },
    },
    latlng: [-8.0, 178.0],
    landlocked: false,
    area: 26.0,
    demonyms: { eng: { f: 'Tuvaluan', m: 'Tuvaluan' }, fr: { f: 'Tuvaluane', m: 'Tuvaluan' } },
    flag: '\uD83C\uDDF9\uD83C\uDDFB',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: "République d'Indonésie", common: 'Indonésie' },
      ...
      jp: { official: 'インドネシア共和国', common: 'インドネシア' },
      kr: { official: '인도네시아 공화국', common: '인도네시아' },
      nld: { official: 'Republiek Indonesië', common: 'Indonesië' },
      ir: { official: 'جمهوری اندونزی', common: 'اندونزی' },
      pol: { official: 'Republika Indonezji', common: 'Indonezja' },
      pt: { official: 'República da Indonésia', common: 'Indonésia' },
      ru: { official: 'Республика Индонезия', common: 'Индонезия' },
      ...
      tr: { official: 'Endonezya Cumhuriyeti', common: 'Endonezya' },
      urd: { official: 'جمہوریہ انڈونیشیا', common: 'انڈونیشیا' },
      cn: { official: '印度尼西亚共和国', common: '印度尼西亚' },
    },
    latlng: [-5.0, 120.0],
    landlocked: false,
    borders: ['TLS', 'MYS', 'PNG'],
    area: 1904569.0,
    demonyms: { eng: { f: 'Indonesian', m: 'Indonesian' }, fr: { f: 'Indonésienne', m: 'Indonésien' } },
    flag: '\uD83C\uDDEE\uD83C\uDDE9',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Demokratische Bundesrepublik Äthiopien', common: 'Äthiopien' },
      ...
      fr: { official: "République fédérale démocratique d'Éthiopie", common: 'Éthiopie' },
      ...
      it: { official: 'Repubblica federale democratica di Etiopia', common: 'Etiopia' },
      jp: { official: 'エチオピア連邦民主共和国', common: 'エチオピア' },
      kr: { official: '에티오피아 연방 민주 공화국', common: '에티오피아' },
      nld: { official: 'Federale Democratische Republiek Ethiopië', common: 'Ethiopië' },
      ir: { official: 'جمهوری فدرال دموکراتیک اتیوپی', common: 'اِتیوپی' },
      pol: { official: 'Federalna Demokratyczna Republika Etiopii', common: 'Etiopia' },
      pt: { official: 'República Federal Democrática da Etiópia', common: 'Etiópia' },
      ru: { official: 'Федеративная Демократическая Республика Эфиопия', common: 'Эфиопия' },
      slk: { official: 'Etiópska federatívna demokratická republika', common: 'Etiópia' },
      es: { official: 'República Democrática Federal de Etiopía', common: 'Etiopía' },
      swe: { official: 'Demokratiska förbundsrepubliken Etiopien', common: 'Etiopien' },
      tr: { official: 'Etiyopya Federal Demokratik Cumhuriyeti', common: 'Etiyopya' },
      urd: { official: 'وفاقی جمہوری جمہوریہ ایتھوپیا', common: 'ایتھوپیا' },
      cn: { official: '埃塞俄比亚联邦民主共和国', common: '埃塞俄比亚' },
    },
    latlng: [8.0, 38.0],
    landlocked: true,
    borders: ['DJI', 'ERI', 'KEN', 'SOM', 'SSD', 'SDN'],
    area: 1104300.0,
    demonyms: { eng: { f: 'Ethiopian', m: 'Ethiopian' }, fr: { f: 'Éthiopienne', m: 'Éthiopien' } },
    flag: '\uD83C\uDDEA\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    ...
    region: 'Americas',
    subregion: 'South America',
    languages: { aym: 'Aymara', grn: 'Guaraní', que: 'Quechua', es: 'Spanish' },
    translations: {
      ...
      de: { official: 'Plurinationaler Staat Bolivien', common: 'Bolivien' },
      ...
      jp: { official: 'ボリビアの多民族国', common: 'ボリビア多民族国' },
      kr: { official: '볼리비아 다민족국', common: '볼리비아' },
      nld: { official: 'Plurinationale Staat van Bolivia', common: 'Bolivia' },
      ir: { official: 'جمهوری بولیوی', common: 'بولیوی' },
      pol: { official: 'Wielonarodowe Państwo Boliwia', common: 'Boliwia' },
      pt: { official: 'Estado Plurinacional da Bolívia', common: 'Bolívia' },
      ru: { official: 'Многонациональное Государство Боливия', common: 'Боливия' },
      slk: { official: 'Bolívijská republika', common: 'Bolívia' },
      es: { official: 'Estado Plurinacional de Bolivia', common: 'Bolivia' },
      swe: { official: 'Mångnationella staten Bolivia', common: 'Bolivia' },
      tr: { official: 'Bolivya Çokuluslu Devleti', common: 'Bolivya' },
      urd: { official: 'جمہوریہ بولیویا', common: 'بولیویا' },
      cn: { official: '多民族玻利维亚国', common: '玻利维亚' },
    },
    latlng: [-17.0, -65.0],
    landlocked: true,
    borders: ['ARG', 'BRA', 'CHL', 'PRY', 'PER'],
    area: 1098581.0,
    demonyms: { eng: { f: 'Bolivian', m: 'Bolivian' }, fr: { f: 'Bolivienne', m: 'Bolivien' } },
    flag: '\uD83C\uDDE7\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'République de Sierra Leone', common: 'Sierra Leone' },
      ...
      jp: { official: 'シエラレオネ共和国', common: 'シエラレオネ' },
      kr: { official: '시에라리온 공화국', common: '시에라리온' },
      nld: { official: 'Republiek Sierra Leone', common: 'Sierra Leone' },
      ir: { official: 'جمهوری سیرالئون', common: 'سیرالئون' },
      pol: { official: 'Sierra Leone', common: 'Sierra Leone' },
      pt: { official: 'República da Serra Leoa', common: 'Serra Leoa' },
      ru: { official: 'Республика Сьерра-Леоне', common: 'Сьерра-Леоне' },
      ...
      tr: { official: 'Sierra Leone Cumhuriyeti', common: 'Sierra Leone' },
      urd: { official: 'جمہوریہ سیرالیون', common: 'سیرالیون' },
      cn: { official: '塞拉利昂共和国', common: '塞拉利昂' },
    },
    latlng: [8.5, -11.5],
    landlocked: false,
    borders: ['GIN', 'LBR'],
    area: 71740.0,
    demonyms: { eng: { f: 'Sierra Leonean', m: 'Sierra Leonean' }, fr: { f: 'Sierra-leonaise', m: 'Sierra-leonais' } },
    flag: '\uD83C\uDDF8\uD83C\uDDF1',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'モンテネグロ', common: 'モンテネグロ' },
      kr: { official: '몬테네그로', common: '몬테네그로' },
      nld: { official: 'Montenegro', common: 'Montenegro' },
      ir: { official: 'مونته‌نگرو', common: 'مونته‌نگرو' },
      pol: { official: 'Czarnogóra', common: 'Czarnogóra' },
      pt: { official: 'Montenegro', common: 'Montenegro' },
      ru: { official: 'Черногория', common: 'Черногория' },
      ...
      tr: { official: 'Karadağ', common: 'Karadağ' },
      urd: { official: 'مونٹینیگرو', common: 'مونٹینیگرو' },
      cn: { official: '黑山', common: '黑山' },
    },
    latlng: [42.5, 19.3],
    landlocked: false,
    borders: ['ALB', 'BIH', 'HRV', 'UNK', 'SRB'],
    area: 13812.0,
    demonyms: { eng: { f: 'Montenegrin', m: 'Montenegrin' }, fr: { f: 'Monténégrine', m: 'Monténégrin' } },
    flag: '\uD83C\uDDF2\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'オーストラリア連邦', common: 'オーストラリア' },
      kr: { official: '오스트레일리아 연방', common: '호주' },
      nld: { official: 'Gemenebest van Australië', common: 'Australië' },
      ir: { official: 'قلمرو همسود استرالیا', common: 'استرالیا' },
      pol: { official: 'Związek Australijski', common: 'Australia' },
      pt: { official: 'Comunidade da Austrália', common: 'Austrália' },
      ru: { official: 'Содружество Австралии', common: 'Австралия' },
      ...
      tr: { official: 'Avustralya Federal Devleti', common: 'Avustralya' },
      urd: { official: 'دولتِ مشترکہ آسٹریلیا', common: 'آسٹریلیا' },
      cn: { official: '澳大利亚联邦', common: '澳大利亚' },
    },
    latlng: [-27.0, 133.0],
    landlocked: false,
    area: 7692024.0,
    demonyms: { eng: { f: 'Australian', m: 'Australian' }, fr: { f: 'Australienne', m: 'Australien' } },
    flag: '\uD83C\uDDE6\uD83C\uDDFA',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        fr: { official: 'République du Congo', common: 'République du Congo' },
    ...
    region: 'Africa',
    subregion: 'Middle Africa',
    languages: { fr: 'French', kon: 'Kikongo', lin: 'Lingala' },
    translations: {
      ...
      jp: { official: 'コンゴ共和国', common: 'コンゴ共和国' },
      kr: { official: '콩고', common: '콩고' },
      nld: { official: 'Republiek Congo', common: 'Congo' },
      ir: { official: 'جمهوری برازاویل کُنگو', common: 'جمهوری کُنگو' },
      pol: { official: 'Republika Konga', common: 'Kongo' },
      pt: { official: 'República do Congo', common: 'Congo' },
      ru: { official: 'Республика Конго', common: 'Республика Конго' },
      ...
      tr: { official: 'Kongo Cumhuriyeti', common: 'Kongo Cumhuriyeti' },
      urd: { official: 'جمہوریہ کانگو', common: 'جمہوریہ کانگو' },
      cn: { official: '刚果共和国', common: '刚果' },
    },
    latlng: [-1.0, 15.0],
    landlocked: false,
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'République du Burkina', common: 'Burkina Faso' } },
    },
    tld: ['.bf'],
    code: 'BF',
    ccn3: '854',
    ...
    translations: {
      ...
      jp: { official: 'ブルキナファソ', common: 'ブルキナファソ' },
      kr: { official: '부르키나파소', common: '부르키나파소' },
      nld: { official: 'Burkina Faso', common: 'Burkina Faso' },
      ir: { official: 'بورکینافاسو', common: 'بورکینافاسو' },
      pol: { official: 'Burkina Faso', common: 'Burkina Faso' },
      pt: { official: 'Burkina Faso', common: 'Burkina Faso' },
      ru: { official: 'Буркина -Фасо', common: 'Буркина-Фасо' },
      ...
      tr: { official: 'Burkina Faso', common: 'Burkina Faso' },
      urd: { official: 'برکینا فاسو', common: 'برکینا فاسو' },
      cn: { official: '布基纳法索', common: '布基纳法索' },
    },
    latlng: [13.0, -2.0],
    landlocked: true,
    borders: ['BEN', 'CIV', 'GHA', 'MLI', 'NER', 'TGO'],
    area: 272967.0,
    demonyms: { eng: { f: 'Burkinabe', m: 'Burkinabe' }, fr: { f: 'Burkinabée', m: 'Burkinabé' } },
    flag: '\uD83C\uDDE7\uD83C\uDDEB',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'イスラエル国', common: 'イスラエル' },
      kr: { official: '이스라엘국', common: '이스라엘' },
      nld: { official: 'Staat Israël', common: 'Israël' },
      ir: { official: 'فلسطين اشغالی', common: 'فلسطين اشغالی' },
      pol: { official: 'Państwo Izrael', common: 'Izrael' },
      pt: { official: 'Estado de Israel', common: 'Israel' },
      ru: { official: 'Государство Израиль', common: 'Израиль' },
      ...
      tr: { official: 'İsrail Devleti', common: 'İsrail' },
      urd: { official: 'ریاستِ اسرائیل', common: 'اسرائیل' },
      cn: { official: '以色列国', common: '以色列' },
    },
    latlng: [31.47, 35.13],
    landlocked: false,
    borders: ['EGY', 'JOR', 'LBN', 'PSE', 'SYR'],
    area: 20770.0,
    demonyms: { eng: { f: 'Israeli', m: 'Israeli' }, fr: { f: 'Israélienne', m: 'Israélien' } },
    flag: '\uD83C\uDDEE\uD83C\uDDF1',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República Oriental del Uruguay', common: 'Uruguay' } },
    },
    tld: ['.uy'],
    code: 'UY',
    ccn3: '858',
    ...
    translations: {
      ...
      fr: { official: "République orientale de l'Uruguay", common: 'Uruguay' },
      ...
      jp: { official: 'ウルグアイ東方共和国', common: 'ウルグアイ' },
      kr: { official: '우루과이 동방 공화국', common: '우루과이' },
      nld: { official: 'Oosterse Republiek Uruguay', common: 'Uruguay' },
      ir: { official: 'جمهوری اروگوئه', common: 'اروگوئه' },
      pol: { official: 'Wschodnia Republika Urugwaju', common: 'Urugwaj' },
      pt: { official: 'República Oriental do Uruguai', common: 'Uruguai' },
      ru: { official: 'Восточной Республики Уругвай', common: 'Уругвай' },
      ...
      tr: { official: 'Uruguay Doğu Cumhuriyeti', common: 'Uruguay' },
      urd: { official: 'جمہوریہ شرقیہ یوراگوئے', common: 'یوراگوئے' },
      cn: { official: '乌拉圭东岸共和国', common: '乌拉圭' },
    },
    latlng: [-33.0, -56.0],
    landlocked: false,
    borders: ['ARG', 'BRA'],
    area: 181034.0,
    demonyms: { eng: { f: 'Uruguayan', m: 'Uruguayan' }, fr: { f: 'Uruguayenne', m: 'Uruguayen' } },
    flag: '\uD83C\uDDFA\uD83C\uDDFE',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      bre: { official: 'Republik Iwercnn', common: 'Iwercnn' },
      ...
      jp: { official: 'アイルランド共和国', common: 'アイルランド' },
      kr: { official: '아일랜드 공화국', common: '아일랜드' },
      nld: { official: 'Republic of Ireland', common: 'Ierland' },
      ir: { official: 'ایرلند', common: 'ایرلند' },
      pol: { official: 'Republika Irlandii', common: 'Irlandia' },
      pt: { official: 'República da Irlanda', common: 'Irlanda' },
      ru: { official: 'Ирландия', common: 'Ирландия' },
      ...
      tr: { official: 'İrlanda Cumhuriyeti', common: 'İrlanda' },
      urd: { official: 'جمہوریہ جزیرہ آئرلینڈ', common: 'جزیرہ آئرلینڈ' },
      cn: { official: '爱尔兰共和国', common: '爱尔兰' },
    },
    latlng: [53.0, -8.0],
    landlocked: false,
    borders: ['GBR'],
    area: 70273.0,
    demonyms: { eng: { f: 'Irish', m: 'Irish' }, fr: { f: 'Irlandaise', m: 'Irlandais' } },
    flag: '\uD83C\uDDEE\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: "Territoire de l'île Christmas", common: 'Île Christmas' },
      hrv: { official: 'Teritorij Božićni otok', common: 'Božićni otok' },
      hun: { official: 'Karácsony-sziget', common: 'Karácsony-sziget' },
      it: { official: 'Territorio di Christmas Island', common: 'Isola di Natale' },
      jp: { official: 'クリスマス島の領土', common: 'クリスマス島' },
      kr: { official: '크리스마스 섬', common: '크리스마스 섬' },
      nld: { official: 'Grondgebied van Christmas Island', common: 'Christmaseiland' },
      ir: { official: 'جزیرهٔ کریسمس', common: 'جزیرهٔ کریسمس' },
      pol: { official: 'Wyspa Bożego Narodzenia', common: 'Wyspa Bożego Narodzenia' },
      pt: { official: 'Território da Ilha Christmas', common: 'Ilha do Natal' },
      ru: { official: 'Территория острова Рождества', common: 'Остров Рождества' },
      slk: { official: 'Teritórium Vianočného ostrova', common: 'Vianočnú ostrov' },
      es: { official: 'Territorio de la Isla de Navidad', common: 'Isla de Navidad' },
      swe: { official: 'Julön', common: 'Julön' },
      tr: { official: 'Christmas Adası', common: 'Christmas Adası' },
      urd: { official: 'ریاستِ جزیرہ کرسمس', common: 'جزیرہ کرسمس' },
      cn: { official: '圣诞岛', common: '圣诞岛' },
    },
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Bonaire, Sint Eustatius und Saba', common: 'Karibische Niederlande' },
      ...
      fr: { official: 'Bonaire, Saint-Eustache et Saba', common: 'Pays-Bas caribéens' },
      hrv: { official: 'Bonaire, Sint Eustatius i Saba', common: 'Bonaire, Sint Eustatius i Saba' },
      hun: { official: 'Bonaire', common: 'Bonaire' },
      it: { official: 'Bonaire, Sint Eustatius e Saba', common: 'Paesi Bassi caraibici' },
      jp: {
        official: 'ボネール、シント・ユースタティウスおよびサバ',
        common: 'ボネール、シント・ユースタティウスおよびサバ',
      },
      kr: { official: '보네르, 신트외스타티위스, 사바', common: '카리브 네덜란드' },
      nld: { official: 'Bonaire, Sint Eustatius en Saba', common: 'Caribisch Nederland' },
      ir: { official: 'جزایر کارائیب هلند', common: 'جزایر کارائیب هلند' },
      pol: { official: 'Bonaire, Sint Eustatius i Saba', common: 'Antyle Holenderskie' },
      pt: { official: 'Bonaire, Saba e Santo Eustáquio', common: 'Países Baixos Caribenhos' },
      ru: { official: 'Бонэйр, Синт-Эстатиус и Саба', common: 'Карибские Нидерланды' },
      slk: { official: 'Bonaire, Sint Eustatius a Saba', common: 'Bonaire, Sint Eustatius a Saba' },
      es: { official: 'Bonaire, San Eustaquio y Saba', common: 'Caribe Neerlandés' },
      swe: { official: 'Bonaire, Sint Eustatius and Saba', common: 'Karibiska Nederländerna' },
      tr: { official: 'Karayip Hollandası', common: 'Karayip Hollandası' },
      urd: { official: 'بونایر، سینٹ ایوسٹائیس اور سابا', common: 'کیریبین نیدرلینڈز' },
      cn: { official: '荷蘭加勒比區', common: '荷蘭加勒比區' },
    },
    latlng: [12.18, -68.25],
    landlocked: false,
    area: 328.0,
    demonyms: { eng: { f: 'Dutch', m: 'Dutch' }, fr: { f: 'Néerlandaise', m: 'Néerlandais' } },
    flag: '\uD83C\uDDE7\uD83C\uDDF6',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { cn: { official: '中華民國', common: '台灣' } },
    },
    tld: ['.tw', '.台灣', '.台湾'],
    code: 'TW',
    ccn3: '158',
    ...
    translations: {
      ...
      fr: { official: 'République de Chine (Taïwan)', common: 'Taïwan' },
      ...
      jp: { official: '中華民国', common: '台湾' },
      kr: { official: '중화민국', common: '대만' },
      nld: { official: 'Republiek China (Taiwan)', common: 'Taiwan' },
      ir: { official: 'جمهوری چین', common: 'تایوان' },
      pol: { official: 'Republika Chińska (Tajwan)', common: 'Tajwan' },
      pt: { official: 'República da China', common: 'Ilha Formosa' },
      ru: { official: 'Китайская Республика', common: 'Тайвань' },
      slk: { official: 'Čínska republika', common: 'Taiwan' },
      es: { official: 'República de China en Taiwán', common: 'Taiwán' },
      swe: { official: 'Republiken Kina', common: 'Taiwan' },
      tr: { official: 'Çin Cumhuriyeti (Tayvan)', common: 'Tayvan' },
      urd: { official: 'جمہوریہ چین (تائیوان)', common: 'تائیوان' },
    },
    latlng: [23.5, 121.0],
    landlocked: false,
    area: 36193.0,
    demonyms: { eng: { f: 'Taiwanese', m: 'Taiwanese' }, fr: { f: 'Taïwanaise', m: 'Taïwanais' } },
    flag: '\uD83C\uDDF9\uD83C\uDDFC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ボツワナ共和国', common: 'ボツワナ' },
      kr: { official: '보츠와나 공화국', common: '보츠와나' },
      nld: { official: 'Republiek Botswana', common: 'Botswana' },
      ir: { official: 'جمهوری بوتسوانا', common: 'بوتسوانا' },
      pol: { official: 'Republika Botswany', common: 'Botswana' },
      pt: { official: 'República do Botswana', common: 'Botswana' },
      ru: { official: 'Республика Ботсвана', common: 'Ботсвана' },
      ...
      tr: { official: 'Botsvana Cumhuriyeti', common: 'Botsvana' },
      urd: { official: 'جمہوریہ بوٹسوانا', common: 'بوٹسوانا' },
      cn: { official: '博茨瓦纳共和国', common: '博茨瓦纳' },
    },
    latlng: [-22.0, 24.0],
    landlocked: true,
    borders: ['NAM', 'ZAF', 'ZMB', 'ZWE'],
    area: 582000.0,
    demonyms: { eng: { f: 'Motswana', m: 'Motswana' }, fr: { f: 'Botswanaise', m: 'Botswanais' } },
    flag: '\uD83C\uDDE7\uD83C\uDDFC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ザンビア共和国', common: 'ザンビア' },
      kr: { official: '잠비아 공화국', common: '잠비아' },
      nld: { official: 'Republiek Zambia', common: 'Zambia' },
      ir: { official: 'جمهوری زامبیا', common: 'زامبیا' },
      pol: { official: 'Republika Zambii', common: 'Zambia' },
      pt: { official: 'República da Zâmbia', common: 'Zâmbia' },
      ru: { official: 'Республика Замбия', common: 'Замбия' },
      ...
      tr: { official: 'Zambiya Cumhuriyeti', common: 'Zambiya' },
      urd: { official: 'جمہوریہ زیمبیا', common: 'زیمبیا' },
      cn: { official: '赞比亚共和国', common: '赞比亚' },
    },
    latlng: [-15.0, 30.0],
    landlocked: true,
    borders: ['AGO', 'BWA', 'COD', 'MWI', 'MOZ', 'NAM', 'TZA', 'ZWE'],
    area: 752612.0,
    demonyms: { eng: { f: 'Zambian', m: 'Zambian' }, fr: { f: 'Zambienne', m: 'Zambien' } },
    flag: '\uD83C\uDDFF\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'République gabonaise', common: 'Gabon' } },
    },
    tld: ['.ga'],
    code: 'GA',
    ccn3: '266',
    ...
    translations: {
      ...
      jp: { official: 'ガボン共和国', common: 'ガボン' },
      kr: { official: '가봉 공화국', common: '가봉' },
      nld: { official: 'Republiek Gabon', common: 'Gabon' },
      ir: { official: 'جمهوری گابُن', common: 'گابن' },
      pol: { official: 'Republika Gabońska', common: 'Gabon' },
      pt: { official: 'República do Gabão', common: 'Gabão' },
      ru: { official: 'Габона Республика', common: 'Габон' },
      ...
      tr: { official: 'Gabon Cumhuriyeti', common: 'Gabon' },
      urd: { official: 'جمہوریہ گیبون', common: 'گیبون' },
      cn: { official: '加蓬共和国', common: '加蓬' },
    },
    latlng: [-1.0, 11.75],
    landlocked: false,
    borders: ['CMR', 'COG', 'GNQ'],
    area: 267668.0,
    demonyms: { eng: { f: 'Gabonese', m: 'Gabonese' }, fr: { f: 'Gabonaise', m: 'Gabonais' } },
    flag: '\uD83C\uDDEC\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'フィンランド共和国', common: 'フィンランド' },
      kr: { official: '핀란드 공화국', common: '핀란드' },
      nld: { official: 'Republiek Finland', common: 'Finland' },
      ir: { official: 'جمهوری فنلاند', common: 'فنلاند' },
      pol: { official: 'Republika Finlandii', common: 'Finlandia' },
      pt: { official: 'República da Finlândia', common: 'Finlândia' },
      ru: { official: 'Финляндская Республика', common: 'Финляндия' },
      slk: { official: 'Fínska republika', common: 'Fínsko' },
      es: { official: 'República de Finlandia', common: 'Finlandia' },
      swe: { official: 'Republiken Finland', common: 'Finland' },
      tr: { official: 'Finlandiya Cumhuriyeti', common: 'Finlandiya' },
      urd: { official: 'جمہوریہ فن لینڈ', common: 'فن لینڈ' },
      cn: { official: '芬兰共和国', common: '芬兰' },
    },
    latlng: [64.0, 26.0],
    landlocked: false,
    borders: ['NOR', 'SWE', 'RUS'],
    area: 338424.0,
    demonyms: { eng: { f: 'Finnish', m: 'Finnish' }, fr: { f: 'Finlandaise', m: 'Finlandais' } },
    flag: '\uD83C\uDDEB\uD83C\uDDEE',
    maps: { googleMaps: 'https://goo.gl/maps/HjgWDCNKRAYHrkMn8', openStreetMaps: 'openstreetmap.org/relation/54224' },
    population: 5530719,
    gini: { '2018': 27.3 },
    fifa: 'FIN',
  ...
  },
  {
    name: {
      ...
      nativeName: {
        pt: { official: 'Região Administrativa Especial de Macau da República Popular da China', common: 'Macau' },
        cn: { official: '中华人民共和国澳门特别行政区', common: '澳门' },
      },
    },
    tld: ['.mo'],
    code: 'MO',
    ...
    region: 'Asia',
    subregion: 'Eastern Asia',
    languages: { pt: 'Portuguese', cn: 'Chinese' },
    translations: {
      ara: { official: 'منطقة ماكاو الإدارية التابعة لجمهورية الصين الشعبية', common: 'ماكاو' },
      bre: { official: 'Rannvro velestradurel arbennik Makao eus Republik pobl Sina', common: 'Makao' },
      ...
      de: { official: 'Sonderverwaltungsregion Macau der Volksrepublik China', common: 'Macao' },
      ...
      fr: { official: 'Région administrative spéciale de Macao de la République populaire de Chine', common: 'Macao' },
      hrv: { official: 'Makao Posebnog upravnog područjaNarodne Republike Kine', common: 'Makao' },
      hun: { official: 'Makaó', common: 'Makaó' },
      it: { official: 'Macao Regione amministrativa speciale della Repubblica Popolare Cinese', common: 'Macao' },
      jp: { official: '中華人民共和国マカオ特別行政区', common: 'マカオ' },
      kr: { official: '중화인민공화국 마카오 특별행정구', common: '마카오' },
      nld: { official: 'Speciale Administratieve Regio Macau van de Volksrepubliek China', common: 'Macao' },
      ir: { official: 'ماکائو', common: 'ماکائو' },
      pol: { official: 'Specjalny Region Administracyjny Chińskiej Republiki Ludowej Makau', common: 'Makau' },
      pt: { official: 'Macau Região Administrativa Especial da República Popular da China', common: 'Macau' },
      ru: {
      ...
      es: { official: 'Macao, Región Administrativa Especial de la República Popular China', common: 'Macao' },
      swe: { official: 'Macao', common: 'Macao' },
      tr: { official: 'Çin Halk Cumhuriyeti Makao Özel İdari Bölgesi', common: 'Makao' },
    ...
    borders: ['CHN'],
    area: 30.0,
    demonyms: { eng: { f: 'Macanese', m: 'Macanese' }, fr: { f: 'Macanaise', m: 'Macanais' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: '南極大陸', common: '南極' },
      kr: { official: '남극', common: '남극' },
      nld: { official: 'antarctica', common: 'antarctica' },
      ir: { official: 'جنوبگان', common: 'جنوبگان' },
      pol: { official: 'Antarktyka', common: 'Antarktyka' },
      pt: { official: 'Antártica', common: 'Antártida' },
      ru: { official: 'Антарктида', common: 'Антарктида' },
      slk: { official: 'Antarktída', common: 'Antarktída' },
      es: { official: 'Antártida', common: 'Antártida' },
      swe: { official: 'Antarktis', common: 'Antarktis' },
      tr: { official: 'Antarktika', common: 'Antarktika' },
      urd: { official: 'انٹارکٹکا', common: 'انٹارکٹکا' },
      cn: { official: '南极洲', common: '南极洲' },
    },
    latlng: [-90.0, 0.0],
    landlocked: false,
    area: 1.4e7,
    demonyms: { eng: { f: 'Antarctican', m: 'Antarctican' }, fr: { f: 'Antarcticaine', m: 'Antarcticain' } },
    flag: '\uD83C\uDDE6\uD83C\uDDF6',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República de El Salvador', common: 'El Salvador' } },
    },
    tld: ['.sv'],
    code: 'SV',
    ccn3: '222',
    ...
    translations: {
      ...
      jp: { official: 'エルサルバドル共和国', common: 'エルサルバドル' },
      kr: { official: '엘살바도르 공화국', common: '엘살바도르' },
      nld: { official: 'Republiek El Salvador', common: 'El Salvador' },
      ir: { official: 'جمهوری السالوادور', common: 'السالوادور' },
      pol: { official: 'Republika Salwadoru', common: 'Salwador' },
      pt: { official: 'República de El Salvador', common: 'El Salvador' },
      ru: { official: 'Республика Эль-Сальвадор', common: 'Сальвадор' },
      ...
      tr: { official: 'El Salvador Cumhuriyeti', common: 'El Salvador' },
      urd: { official: 'جمہوریہ ایل سیلواڈور', common: 'ایل سیلواڈور' },
      cn: { official: '萨尔瓦多共和国', common: '萨尔瓦多' },
    },
    latlng: [13.83333333, -88.91666666],
    landlocked: false,
    borders: ['GTM', 'HND'],
    area: 21041.0,
    demonyms: { eng: { f: 'Salvadoran', m: 'Salvadoran' }, fr: { f: 'Salvadorienne', m: 'Salvadorien' } },
    flag: '\uD83C\uDDF8\uD83C\uDDFB',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Vereinigte Staaten von Amerika', common: 'Vereinigte Staaten' },
      est: { official: 'Ameerika Ühendriigid', common: 'Ameerika Ühendriigid' },
      fin: { official: 'Amerikan yhdysvallat', common: 'Yhdysvallat' },
      fr: { official: "Les états-unis d'Amérique", common: 'États-Unis' },
      ...
      it: { official: "Stati Uniti d'America", common: "Stati Uniti d'America" },
      jp: { official: 'アメリカ合衆国', common: 'アメリカ合衆国' },
      kr: { official: '아메리카 합중국', common: '미국' },
      nld: { official: 'Verenigde Staten van Amerika', common: 'Verenigde Staten' },
      ir: { official: 'ایالات متحده آمریکا', common: 'ایالات متحده آمریکا' },
      pol: { official: 'Stany Zjednoczone Ameryki', common: 'Stany Zjednoczone' },
      pt: { official: 'Estados Unidos da América', common: 'Estados Unidos' },
      ru: { official: 'Соединенные Штаты Америки', common: 'Соединённые Штаты Америки' },
      slk: { official: 'Spojené štáty Americké', common: 'Spojené štáty americké' },
      es: { official: 'Estados Unidos de América', common: 'Estados Unidos' },
      swe: { official: 'Amerikas förenta stater', common: 'USA' },
      tr: { official: 'Amerika Birleşik Devletleri', common: 'Amerika Birleşik Devletleri' },
      urd: { official: 'ریاستہائے متحدہ امریکا', common: 'ریاستہائے متحدہ' },
      cn: { official: '美利坚合众国', common: '美国' },
    },
    latlng: [38.0, -97.0],
    landlocked: false,
    borders: ['CAN', 'MEX'],
    area: 9372610.0,
    demonyms: { eng: { f: 'American', m: 'American' }, fr: { f: 'Américaine', m: 'Américain' } },
    flag: '\uD83C\uDDFA\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Republik Marshallinseln', common: 'Marshallinseln' },
      ...
      fr: { official: 'République des Îles Marshall', common: 'Îles Marshall' },
      hrv: { official: 'Republika Maršalovi Otoci', common: 'Maršalovi Otoci' },
      hun: { official: 'Marshall-szigetek', common: 'Marshall-szigetek' },
      it: { official: 'Repubblica delle Isole Marshall', common: 'Isole Marshall' },
      jp: { official: 'マーシャル諸島共和国', common: 'マーシャル諸島' },
      kr: { official: '마셜 제도 공화국', common: '마셜 제도' },
      nld: { official: 'Republiek van de Marshall-eilanden', common: 'Marshalleilanden' },
      ir: { official: 'جمهوری جزایر مارشال', common: 'جزایر مارشال' },
      pol: { official: 'Republika Wysp Marshalla', common: 'Wyspy Marshalla' },
      pt: { official: 'República das Ilhas Marshall', common: 'Ilhas Marshall' },
      ru: { official: 'Республика Маршалловы острова', common: 'Маршалловы Острова' },
      slk: { official: 'Republika Marshallových ostrovov', common: 'Marshallove ostrovy' },
      es: { official: 'República de las Islas Marshall', common: 'Islas Marshall' },
      swe: { official: 'Republiken Marshallöarna', common: 'Marshallöarna' },
      tr: { official: 'Marshall Adaları Cumhuriyeti', common: 'Marshall Adaları' },
      urd: { official: 'جمہوریہ جزائر مارشل', common: 'جزائر مارشل' },
      cn: { official: '马绍尔群岛共和国', common: '马绍尔群岛' },
    },
    latlng: [9.0, 168.0],
    landlocked: false,
    area: 181.0,
    demonyms: { eng: { f: 'Marshallese', m: 'Marshallese' }, fr: { f: 'Marshallaise', m: 'Marshallais' } },
    flag: '\uD83C\uDDF2\uD83C\uDDED',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'フィジー共和国', common: 'フィジー' },
      kr: { official: '피지 공화국', common: '피지' },
      nld: { official: 'Republiek Fiji', common: 'Fiji' },
      ir: { official: 'جمهوری جزایر فیجی', common: 'فیجی' },
      pol: { official: 'Republika Fidżi', common: 'Fidżi' },
      pt: { official: 'República de Fiji', common: 'Fiji' },
      ru: { official: 'Республика Фиджи', common: 'Фиджи' },
      ...
      tr: { official: 'Fiji Cumhuriyeti', common: 'Fiji' },
      urd: { official: 'جمہوریہ فجی', common: 'فجی' },
      cn: { official: '斐济共和国', common: '斐济' },
    },
    latlng: [17.7134, 178.065],
    landlocked: false,
    area: 18272.0,
    demonyms: { eng: { f: 'Fijian', m: 'Fijian' }, fr: { f: 'Fidjienne', m: 'Fidjien' } },
    flag: '\uD83C\uDDEB\uD83C\uDDEF',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { de: { official: 'Bundesrepublik Deutschland', common: 'Deutschland' } },
    },
    tld: ['.de'],
    code: 'DE',
    ccn3: '276',
    ...
    translations: {
      ...
      fr: { official: "République fédérale d'Allemagne", common: 'Allemagne' },
      ...
      jp: { official: 'ドイツ連邦共和国', common: 'ドイツ' },
      kr: { official: '독일 연방 공화국', common: '독일' },
      nld: { official: 'Bondsrepubliek Duitsland', common: 'Duitsland' },
      ir: { official: 'جمهوری فدرال آلمان', common: 'آلمان' },
      pol: { official: 'Republika Federalna Niemiec', common: 'Niemcy' },
      pt: { official: 'República Federal da Alemanha', common: 'Alemanha' },
      ru: { official: 'Федеративная Республика Германия', common: 'Германия' },
      ...
      tr: { official: 'Almanya Federal Cumhuriyeti', common: 'Almanya' },
      urd: { official: 'وفاقی جمہوریہ جرمنی', common: 'جرمنی' },
      cn: { official: '德意志联邦共和国', common: '德国' },
    },
    latlng: [51.0, 9.0],
    landlocked: false,
    borders: ['AUT', 'BEL', 'CZE', 'DNK', 'FRA', 'LUX', 'NLD', 'POL', 'CHE'],
    area: 357114.0,
    demonyms: { eng: { f: 'German', m: 'German' }, fr: { f: 'Allemande', m: 'Allemand' } },
    flag: '\uD83C\uDDE9\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    region: 'Americas',
    subregion: 'Central America',
    languages: { bjz: 'Belizean Creole', eng: 'English', es: 'Spanish' },
    translations: {
      ...
      jp: { official: 'ベリーズ', common: 'ベリーズ' },
      kr: { official: '벨리즈', common: '벨리즈' },
      nld: { official: 'Belize', common: 'Belize' },
      ir: { official: 'بلیز', common: 'بلیز' },
      pol: { official: 'Belize', common: 'Belize' },
      pt: { official: 'Belize', common: 'Belize' },
      ru: { official: 'Белиз', common: 'Белиз' },
      slk: { official: 'Belize', common: 'Belize' },
      es: { official: 'Belice', common: 'Belice' },
      swe: { official: 'Belize', common: 'Belize' },
      tr: { official: 'Belize', common: 'Belize' },
      urd: { official: 'بیلیز', common: 'بیلیز' },
      cn: { official: '伯利兹', common: '伯利兹' },
    },
    latlng: [17.25, -88.75],
    landlocked: false,
    borders: ['GTM', 'MEX'],
    area: 22966.0,
    demonyms: { eng: { f: 'Belizean', m: 'Belizean' }, fr: { f: 'Bélizienne', m: 'Bélizien' } },
    flag: '\uD83C\uDDE7\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        vcym: { official: 'Republic of Zimbabwe', common: 'Zimbabwe' },
    ...
    translations: {
      ...
      jp: { official: 'ジンバブエ共和国', common: 'ジンバブエ' },
      kr: { official: '짐바브웨 공화국', common: '짐바브웨' },
      nld: { official: 'Republiek Zimbabwe', common: 'Zimbabwe' },
      ir: { official: 'جمهوری زیمبابوه', common: 'زیمبابوه' },
      pol: { official: 'Republika Zimbabwe', common: 'Zimbabwe' },
      pt: { official: 'República do Zimbabwe', common: 'Zimbabwe' },
      ru: { official: 'Республика Зимбабве', common: 'Зимбабве' },
      ...
      tr: { official: 'Zimbabve Cumhuriyeti', common: 'Zimbabve' },
      urd: { official: 'جمہوریہ زمبابوے', common: 'زمبابوے' },
      cn: { official: '津巴布韦共和国', common: '津巴布韦' },
    },
    latlng: [-20.0, 30.0],
    landlocked: true,
    borders: ['BWA', 'MOZ', 'ZAF', 'ZMB'],
    area: 390757.0,
    demonyms: { eng: { f: 'Zimbabwean', m: 'Zimbabwean' }, fr: { f: 'Zimbabwéenne', m: 'Zimbabwéen' } },
    flag: '\uD83C\uDDFF\uD83C\uDDFC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'カタール国', common: 'カタール' },
      kr: { official: '카타르국', common: '카타르' },
      nld: { official: 'Staat Qatar', common: 'Qatar' },
      ir: { official: 'دولت قطر', common: 'قطر' },
      pol: { official: 'Państwo Katar', common: 'Katar' },
      pt: { official: 'Estado do Qatar', common: 'Catar' },
      ru: { official: 'Государство Катар', common: 'Катар' },
      slk: { official: 'Katarský štát', common: 'Katar' },
      es: { official: 'Estado de Qatar', common: 'Catar' },
      swe: { official: 'Staten Qatar', common: 'Qatar' },
      tr: { official: 'Katar Devleti', common: 'Katar' },
      urd: { official: 'ریاستِ قطر', common: 'قطر' },
      cn: { official: '卡塔尔国', common: '卡塔尔' },
    },
    latlng: [25.5, 51.25],
    landlocked: false,
    borders: ['SAU'],
    area: 11586.0,
    demonyms: { eng: { f: 'Qatari', m: 'Qatari' }, fr: { f: 'Qatarienne', m: 'Qatarien' } },
    flag: '\uD83C\uDDF6\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'アングィラ', common: 'アンギラ' },
      kr: { official: '앵귈라', common: '앵귈라' },
      nld: { official: 'Anguilla', common: 'Anguilla' },
      ir: { official: 'آنگویلا', common: 'آنگویلا' },
      pol: { official: 'Anguilla', common: 'Anguilla' },
      pt: { official: 'Anguilla', common: 'Anguilla' },
      ru: { official: 'Ангилья', common: 'Ангилья' },
      slk: { official: 'Anguilla', common: 'Anguilla' },
      es: { official: 'Anguila', common: 'Anguilla' },
      swe: { official: 'Anguilla', common: 'Anguilla' },
      tr: { official: 'Anguilla', common: 'Anguilla' },
      urd: { official: 'اینگویلا', common: 'اینگویلا' },
      cn: { official: '安圭拉', common: '安圭拉' },
    },
    latlng: [18.25, -63.16666666],
    landlocked: false,
    area: 91.0,
    demonyms: { eng: { f: 'Anguillian', m: 'Anguillian' }, fr: { f: 'Anguillane', m: 'Anguillan' } },
    flag: '\uD83C\uDDE6\uD83C\uDDEE',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { pt: { official: 'República de Angola', common: 'Angola' } },
    },
    tld: ['.ao'],
    code: 'AO',
    ccn3: '024',
    ...
    translations: {
      ...
      jp: { official: 'アンゴラ共和国', common: 'アンゴラ' },
      kr: { official: '앙골라 공화국', common: '앙골라' },
      nld: { official: 'Republiek Angola', common: 'Angola' },
      ir: { official: 'جمهوری آنگولا', common: 'آنگولا' },
      pol: { official: 'Republika Angoli', common: 'Angola' },
      pt: { official: 'República de Angola', common: 'Angola' },
      ru: { official: 'Республика Ангола', common: 'Ангола' },
      ...
      tr: { official: 'Angola Cumhuriyeti', common: 'Angola' },
      urd: { official: 'جمہوریہ انگولہ', common: 'انگولہ' },
      cn: { official: '安哥拉共和国', common: '安哥拉' },
    },
    latlng: [-12.5, 18.5],
    landlocked: false,
    borders: ['COG', 'COD', 'ZMB', 'NAM'],
    area: 1246700.0,
    demonyms: { eng: { f: 'Angolan', m: 'Angolan' }, fr: { f: 'Angolaise', m: 'Angolais' } },
    flag: '\uD83C\uDDE6\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { it: { official: 'Repubblica italiana', common: 'Italia' } },
    },
    tld: ['.it'],
    code: 'IT',
    ccn3: '380',
    ...
    translations: {
      ...
      jp: { official: 'イタリア共和国', common: 'イタリア' },
      kr: { official: '이탈리아 공화국', common: '이탈리아' },
      nld: { official: 'Italiaanse Republiek', common: 'Italië' },
      ir: { official: 'جمهوری ایتالیا', common: 'ایتالیا' },
      pol: { official: 'Republika Włoska', common: 'Włochy' },
      pt: { official: 'República Italiana', common: 'Itália' },
      ru: { official: 'итальянская Республика', common: 'Италия' },
      ...
      tr: { official: 'İtalyan Cumhuriyeti', common: 'İtalya' },
      urd: { official: 'جمہوریہ اطالیہ', common: 'اطالیہ' },
      cn: { official: '意大利共和国', common: '意大利' },
    },
    latlng: [42.83333333, 12.83333333],
    landlocked: false,
    borders: ['AUT', 'FRA', 'SMR', 'SVN', 'CHE', 'VAT'],
    area: 301336.0,
    demonyms: { eng: { f: 'Italian', m: 'Italian' }, fr: { f: 'Italienne', m: 'Italien' } },
    flag: '\uD83C\uDDEE\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'République togolaise', common: 'Togo' } },
    },
    tld: ['.tg'],
    code: 'TG',
    ccn3: '768',
    ...
    translations: {
      ...
      jp: { official: 'トーゴ共和国', common: 'トーゴ' },
      kr: { official: '토고 공화국', common: '토고' },
      nld: { official: 'Republiek Togo', common: 'Togo' },
      ir: { official: 'جمهوری توگو', common: 'توگو' },
      pol: { official: 'Republika Togijska', common: 'Togo' },
      pt: { official: 'República do Togo', common: 'Togo' },
      ru: { official: 'Того Республика', common: 'Того' },
      ...
      tr: { official: 'Togo Cumhuriyeti', common: 'Togo' },
      urd: { official: 'جمہوریہ ٹوگو', common: 'ٹوگو' },
      cn: { official: '多哥共和国', common: '多哥' },
    },
    latlng: [8.0, 1.16666666],
    landlocked: false,
    borders: ['BEN', 'BFA', 'GHA'],
    area: 56785.0,
    demonyms: { eng: { f: 'Togolese', m: 'Togolese' }, fr: { f: 'Togolaise', m: 'Togolais' } },
    flag: '\uD83C\uDDF9\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Commonwealth der Nördlichen Marianen', common: 'Nördliche Marianen' },
      est: { official: 'Põhja-Mariaani Ühendus', common: 'Põhja-Mariaanid' },
      fin: { official: 'Pohjois-Mariaanit', common: 'Pohjois-Mariaanit' },
      fr: { official: 'Commonwealth des îles Mariannes du Nord', common: 'Îles Mariannes du Nord' },
      ...
      it: { official: 'Commonwealth delle Isole Marianne Settentrionali', common: 'Isole Marianne Settentrionali' },
      jp: { official: '北マリアナ諸島', common: '北マリアナ諸島' },
      kr: { official: '북마리아나 제도', common: '북마리아나 제도' },
      nld: { official: 'Commonwealth van de Noordelijke Marianen', common: 'Noordelijke Marianeneilanden' },
      ir: { official: 'جزایر ماریانای شمالی', common: 'جزایر ماریانای شمالی' },
      pol: { official: 'Wspólnota Marianów Północnych', common: 'Mariany Północne' },
      pt: { official: 'Comunidade das Ilhas Marianas do Norte', common: 'Marianas Setentrionais' },
      ru: { official: 'Содружество Северных Марианских островов', common: 'Северные Марианские острова' },
      slk: { official: 'Spoločenstvo ostrovov Severné Mariány', common: 'Severné Mariány' },
      es: { official: 'Mancomunidad de las Islas Marianas del Norte', common: 'Islas Marianas del Norte' },
      swe: { official: 'Nordmarianerna', common: 'Nordmarianerna' },
      tr: { official: 'Kuzey Mariana Adaları Milletler Topluluğu', common: 'Kuzey Mariana Adaları' },
      urd: { official: 'دولتِ مشترکہ جزائر شمالی ماریانا', common: 'جزائر شمالی ماریانا' },
      cn: { official: '北马里亚纳群岛', common: '北马里亚纳群岛' },
    },
    latlng: [15.2, 145.75],
    landlocked: false,
    area: 464.0,
    demonyms: { eng: { f: 'American', m: 'American' }, fr: { f: 'Américaine', m: 'Américan' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF5',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'Nouvelle-Zélande', common: 'Nouvelle-Zélande' },
      ...
      jp: { official: 'ニュージーランド', common: 'ニュージーランド' },
      kr: { official: '뉴질랜드', common: '뉴질랜드' },
      nld: { official: 'Nieuw Zeeland', common: 'Nieuw-Zeeland' },
      ir: { official: 'نیوزیلند', common: 'نیوزیلند' },
      pol: { official: 'Nowa Zelandia', common: 'Nowa Zelandia' },
      pt: { official: 'nova Zelândia', common: 'Nova Zelândia' },
      ru: { official: 'Новая Зеландия', common: 'Новая Зеландия' },
      ...
      tr: { official: 'Yeni Zelanda', common: 'Yeni Zelanda' },
      urd: { official: 'نیوزی لینڈ', common: 'نیوزی لینڈ' },
      cn: { official: '新西兰', common: '新西兰' },
    },
    latlng: [-41.0, 174.0],
    landlocked: false,
    area: 270467.0,
    demonyms: { eng: { f: 'New Zealander', m: 'New Zealander' }, fr: { f: 'Neo-Zélandaise', m: 'Neo-Zélandais' } },
    flag: '\uD83C\uDDF3\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Republik der Union Myanmar', common: 'Myanmar' },
      est: { official: 'Myanmari Liidu Vabariik', common: 'Myanmar' },
      fin: { official: 'Myanmarin liiton tasavalta', common: 'Myanmar' },
      fr: { official: "République de l'Union du Myanmar", common: 'Birmanie' },
      ...
      jp: { official: 'ミャンマー連邦共和国', common: 'ミャンマー' },
      kr: { official: '미얀마 연방 공화국', common: '미얀마' },
      nld: { official: 'Republiek van de Unie van Myanmar', common: 'Myanmar' },
      ir: { official: 'اتحادیه جمهوری میانمار', common: 'میانمار' },
      pol: { official: 'Republika Związku Mjanmy', common: 'Mjanma' },
      pt: { official: 'República da União de Myanmar', common: 'Myanmar' },
      ru: { official: 'Республика Союза Мьянма', common: 'Мьянма' },
      slk: { official: 'Mjanmarská zväzová republika', common: 'Mjanmarsko' },
      es: { official: 'República de la Unión de Myanmar', common: 'Myanmar' },
      swe: { official: 'Republiken Unionen Myanmar', common: 'Myanmar' },
      tr: { official: 'Myanmar Birliği Cumhuriyeti', common: 'Myanmar' },
      urd: { official: 'متحدہ جمہوریہ میانمار', common: 'میانمار' },
      cn: { official: '缅甸联邦共和国', common: '缅甸' },
    },
    latlng: [22.0, 98.0],
    landlocked: false,
    borders: ['BGD', 'CHN', 'IND', 'LAO', 'THA'],
    area: 676578.0,
    demonyms: { eng: { f: 'Burmese', m: 'Burmese' }, fr: { f: 'Birmane', m: 'Birman' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'オマーン·スルタン国', common: 'オマーン' },
      kr: { official: '오만 술탄국', common: '오만' },
      nld: { official: 'Sultanaat van Oman', common: 'Oman' },
      ir: { official: 'سلطان‌نشین عُمان', common: 'عمان' },
      pol: { official: 'Sułtanat Omanu', common: 'Oman' },
      pt: { official: 'Sultanato de Omã', common: 'Omã' },
      ru: { official: 'Султанат Оман', common: 'Оман' },
      ...
      tr: { official: 'Umman Sultanlığı', common: 'Umman' },
      urd: { official: 'سلطنت عمان', common: 'عمان' },
      cn: { official: '阿曼苏丹国', common: '阿曼' },
    },
    latlng: [21.0, 57.0],
    landlocked: false,
    borders: ['SAU', 'ARE', 'YEM'],
    area: 309500.0,
    demonyms: { eng: { f: 'Omani', m: 'Omani' }, fr: { f: 'Omanaise', m: 'Omanais' } },
    flag: '\uD83C\uDDF4\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'サモア独立国', common: 'サモア' },
      kr: { official: '사모아 독립국', common: '사모아' },
      nld: { official: 'Onafhankelijke Staat Samoa', common: 'Samoa' },
      ir: { official: 'ایالت مستقل ساموآ', common: 'ساموآ' },
      pol: { official: 'Niezależne Państwo Samoa', common: 'Samoa' },
      pt: { official: 'Estado Independente de Samoa', common: 'Samoa' },
      ru: { official: 'Независимое Государство Самоа', common: 'Самоа' },
      ...
      tr: { official: 'Bağımsız Samoa Devleti', common: 'Bağımsız Samoa Devleti' },
      urd: { official: 'آزاد سلطنتِ ساموا', common: 'سامووا' },
      cn: { official: '萨摩亚独立国', common: '萨摩亚' },
    },
    latlng: [-13.58333333, -172.33333333],
    landlocked: false,
    area: 2842.0,
    demonyms: { eng: { f: 'Samoan', m: 'Samoan' }, fr: { f: 'Samoane', m: 'Samoan' } },
    flag: '\uD83C\uDDFC\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'République du Bénin', common: 'Bénin' } },
    },
    tld: ['.bj'],
    code: 'BJ',
    ccn3: '204',
    ...
    translations: {
      ...
      jp: { official: 'ベナン共和国', common: 'ベナン' },
      kr: { official: '베냉 공화국', common: '베냉' },
      nld: { official: 'Republiek Benin', common: 'Benin' },
      ir: { official: 'جمهوری بنین', common: 'بنین' },
      pol: { official: 'Benin', common: 'Benin' },
      pt: { official: 'República do Benin', common: 'Benin' },
      ru: { official: 'Республика Бенин', common: 'Бенин' },
      ...
      tr: { official: 'Benin Cumhuriyeti', common: 'Benin' },
      urd: { official: 'جمہوریہ بینن', common: 'بینن' },
      cn: { official: '贝宁共和国', common: '贝宁' },
    },
    latlng: [9.5, 2.25],
    landlocked: false,
    borders: ['BFA', 'NER', 'NGA', 'TGO'],
    area: 112622.0,
    demonyms: { eng: { f: 'Beninese', m: 'Beninese' }, fr: { f: 'Béninoise', m: 'Béninois' } },
    flag: '\uD83C\uDDE7\uD83C\uDDEF',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Föderation von St. Kitts und Nevis', common: 'St. Kitts und Nevis' },
      ...
      fr: { official: 'Fédération de Saint-Christophe-et-Niévès', common: 'Saint-Christophe-et-Niévès' },
      ...
      it: { official: 'Federazione di Saint Christopher e Nevis', common: 'Saint Kitts e Nevis' },
      jp: { official: 'セントクリストファーNevis連盟', common: 'セントクリストファー・ネイビス' },
      kr: { official: '세인트키츠 네비스 연방', common: '세인트키츠 네비스' },
      nld: { official: 'Federatie van Saint Kitts en Nevis', common: 'Saint Kitts en Nevis' },
      ir: { official: 'فدراسیون سنت کیتس و نویس', common: 'سنت کیتس و نویس' },
      pol: { official: 'Federacja Saint Kitts i Nevis', common: 'Saint Kitts i Nevis' },
      pt: { official: 'Federação de São Cristóvão e Nevis', common: 'São Cristóvão e Nevis' },
      ru: { official: 'Федерация Сент-Кристофер и Н е в и с', common: 'Сент-Китс и Невис' },
      slk: { official: 'Feder໡cia Svätého Krištofa a Nevisu', common: 'Svätý Krištof a Nevis' },
      es: { official: 'Federación de San Cristóbal y Nevis', common: 'San Cristóbal y Nieves' },
      swe: { official: 'Federationen Saint Kitts och Nevis', common: 'Saint Kitts och Nevis' },
      tr: { official: 'Saint Kitts ve Nevis Federasyonu', common: 'Saint Kitts ve Nevis' },
      urd: { official: 'وفاقِ سینٹ کیٹز و ناویس', common: 'سینٹ کیٹز و ناویس' },
      cn: { official: '圣克里斯托弗和尼维斯联邦', common: '圣基茨和尼维斯' },
    },
    ...
    demonyms: {
      ...
      fr: { f: 'Kittitienne-et-nevicienne', m: 'Kittitien-et-nevicien' },
    },
    flag: '\uD83C\uDDF0\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Islamische Republik Mauretanien', common: 'Mauretanien' },
      ...
      fr: { official: 'République islamique de Mauritanie', common: 'Mauritanie' },
      ...
      it: { official: 'Repubblica islamica di Mauritania', common: 'Mauritania' },
      jp: { official: 'モーリタニア·イスラム共和国', common: 'モーリタニア' },
      kr: { official: '모리타니 이슬람 공화국', common: '모리타니' },
      nld: { official: 'Islamitische Republiek Mauritanië', common: 'Mauritanië' },
      ir: { official: 'جمهوری اسلامی موریتانی', common: 'موریتانی' },
      pol: { official: 'Islamska Republika Mauretańska', common: 'Mauretania' },
      pt: { official: 'República Islâmica da Mauritânia', common: 'Mauritânia' },
      ru: { official: 'Исламская Республика Мавритания', common: 'Мавритания' },
      slk: { official: 'Mauritánska islamská republika', common: 'Mauritánia' },
      es: { official: 'República Islámica de Mauritania', common: 'Mauritania' },
      swe: { official: 'Islamiska republiken Mauretanien', common: 'Mauretanien' },
      tr: { official: 'Moritanya İslam Cumhuriyeti', common: 'Moritanya' },
      urd: { official: 'اسلامی جمہوریہ موریتانیہ', common: 'موریتانیہ' },
      cn: { official: '毛里塔尼亚伊斯兰共和国', common: '毛里塔尼亚' },
    },
    latlng: [20.0, -12.0],
    landlocked: false,
    borders: ['DZA', 'MLI', 'SEN', 'ESH'],
    area: 1030700.0,
    demonyms: { eng: { f: 'Mauritanian', m: 'Mauritanian' }, fr: { f: 'Mauritanienne', m: 'Mauritanien' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        eng: { official: 'United States Minor Outlying Islands', common: 'United States Minor Outlying Islands' },
      },
    },
    tld: ['.us'],
    code: 'UM',
    ...
    translations: {
      ...
      bre: { official: 'Inizi Minor A-bell Stadoù-Unanet', common: 'Inizi Minor A-bell Stadoù-Unanet' },
      ...
      fr: { official: 'Îles mineures éloignées des États-Unis', common: 'Îles mineures éloignées des États-Unis' },
      ...
      it: { official: 'Stati Uniti Isole Minori', common: "Isole minori esterne degli Stati Uniti d'America" },
      jp: { official: 'アメリカ合衆国外諸島', common: '合衆国領有小離島' },
      kr: { official: '미국령 군소 제도', common: '미국령 군소 제도' },
      nld: {
        official: 'Kleine afgelegen eilanden van de Verenigde Staten',
        common: 'Kleine afgelegen eilanden van de Verenigde Staten',
      },
      ir: { official: 'جزایر کوچک حاشیه‌ای ایالات متحده آمریکا', common: 'جزایر کوچک حاشیه‌ای ایالات متحده آمریکا' },
      pol: {
        official: 'Dalekie Wyspy Mniejsze Stanów Zjednoczonych',
        common: 'Dalekie Wyspy Mniejsze Stanów Zjednoczonych',
      },
      pt: { official: 'Estados Unidos Ilhas Menores Distantes', common: 'Ilhas Menores Distantes dos Estados Unidos' },
      ru: { official: 'Внешние малые острова США', common: 'Внешние малые острова США' },
      ...
      cn: { official: '美国本土外小岛屿', common: '美国本土外小岛屿' },
    },
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'グリーンランド', common: 'グリーンランド' },
      kr: { official: '그린란드', common: '그린란드' },
      nld: { official: 'Groenland', common: 'Groenland' },
      ir: { official: 'گروئنلند', common: 'گرینلند' },
      pol: { official: 'Grenlandia', common: 'Grenlandia' },
      pt: { official: 'Groenlândia', common: 'Gronelândia' },
      ru: { official: 'Гренландия', common: 'Гренландия' },
      slk: { official: 'Grónsko', common: 'Grónsko' },
      es: { official: 'Groenlandia', common: 'Groenlandia' },
      swe: { official: 'Grönland', common: 'Grönland' },
      tr: { official: 'Grönland', common: 'Grönland' },
      urd: { official: 'گرین لینڈ', common: 'گرین لینڈ' },
      cn: { official: '格陵兰', common: '格陵兰' },
    },
    latlng: [72.0, -40.0],
    landlocked: false,
    area: 2166086.0,
    demonyms: { eng: { f: 'Greenlandic', m: 'Greenlandic' }, fr: { f: 'Groenlandaise', m: 'Groenlandais' } },
    flag: '\uD83C\uDDEC\uD83C\uDDF1',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Bosnien und Herzegowina', common: 'Bosnien und Herzegowina' },
      ...
      fr: { official: 'Bosnie-et-Herzégovine', common: 'Bosnie-Herzégovine' },
      hrv: { official: 'Bosna i Hercegovina', common: 'Bosna i Hercegovina' },
      hun: { official: 'Bosznia-Hercegovina', common: 'Bosznia-Hercegovina' },
      it: { official: 'Bosnia-Erzegovina', common: 'Bosnia ed Erzegovina' },
      jp: { official: 'ボスニア·ヘルツェゴビナ', common: 'ボスニア・ヘルツェゴビナ' },
      kr: { official: '보스니아 헤르체고비나', common: '보스니아 헤르체고비나' },
      nld: { official: 'Bosnië-Herzegovina', common: 'Bosnië en Herzegovina' },
      ir: { official: 'بوسنی و هرزگوین', common: 'بوسنی و هرزگوین' },
      pol: { official: 'Bośnia i Hercegowina', common: 'Bośnia i Hercegowina' },
      pt: { official: 'Bósnia e Herzegovina', common: 'Bósnia e Herzegovina' },
      ru: { official: 'Босния и Герцеговина', common: 'Босния и Герцеговина' },
      ...
      tr: { official: 'Bosna ve Hersek', common: 'Bosna-Hersek' },
      urd: { official: 'بوسنیا و ہرزیگووینا', common: 'بوسنیا و ہرزیگووینا' },
      cn: { official: '波斯尼亚和黑塞哥维那', common: '波斯尼亚和黑塞哥维那' },
    },
    latlng: [44.0, 18.0],
    landlocked: false,
    borders: ['HRV', 'MNE', 'SRB'],
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Königreich Eswatini', common: 'Swasiland' },
      est: { official: 'eSwatini Kuningriik', common: 'Svaasimaa' },
      fin: { official: 'Swazimaan kuningaskunta', common: 'Swazimaa' },
      fr: { official: 'Royaume d’Eswatini', common: 'Swaziland' },
      hrv: { official: 'Kraljevina eSwatini', common: 'Svazi' },
      hun: { official: 'Szváziföldi Királyság', common: 'Szváziföld' },
      it: { official: 'Regno di eSwatini', common: 'Swaziland' },
      jp: { official: 'スワジランド王国', common: 'スワジランド' },
      kr: { official: '에스와티니 왕국', common: '에스와티니' },
      nld: { official: 'Koninkrijk eSwatini', common: 'Swaziland' },
      ir: { official: 'پادشاهی سوازیلند', common: 'اسواتینی' },
      pol: { official: 'Królestwo Suazi', common: 'Suazi' },
      pt: { official: 'Reino de eSwatini', common: 'Suazilândia' },
      ru: { official: 'Королевство Свазиленд', common: 'Свазиленд' },
      slk: { official: 'Svazijské kráľovstvo', common: 'Svazijsko' },
      es: { official: 'Reino de eSwatini', common: 'Suazilandia' },
      swe: { official: 'Konungariket Eswatini', common: 'Swaziland' },
      tr: { official: 'Esvatini Krallığı', common: 'Esvatini' },
      urd: { official: 'مملکتِ سوازی لینڈ', common: 'سوازی لینڈ' },
      cn: { official: '斯威士兰王国', common: '斯威士兰' },
    },
    latlng: [-26.5, 31.5],
    landlocked: true,
    borders: ['MOZ', 'ZAF'],
    area: 17364.0,
    demonyms: { eng: { f: 'Swazi', m: 'Swazi' }, fr: { f: 'Swazie', m: 'Swazie' } },
    flag: '\uD83C\uDDF8\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        it: { official: 'Stato della Città del Vaticano', common: 'Vaticano' },
    ...
    translations: {
      ...
      it: { official: 'Città del Vaticano', common: 'Città del Vaticano' },
      jp: { official: 'バチカン市国の状態', common: 'バチカン市国' },
      kr: { official: '바티칸 시국', common: '바티칸' },
      nld: { official: 'Vaticaanstad', common: 'Vaticaanstad' },
      ir: { official: 'دولت‌شهر واتیکان', common: 'واتیکان' },
      pol: { official: 'Państwo Watykańskie', common: 'Watykan' },
      pt: { official: 'Cidade do Vaticano', common: 'Cidade do Vaticano' },
      ru: { official: 'Город-государство Ватикан', common: 'Ватикан' },
      ...
      tr: { official: 'Vatikan Şehir Devleti', common: 'Vatikan' },
      urd: { official: 'ویٹیکن سٹی', common: 'ویٹیکن سٹی' },
      cn: { official: '梵蒂冈城国', common: '梵蒂冈' },
    },
    latlng: [41.9, 12.45],
    landlocked: true,
    borders: ['ITA'],
    area: 0.44,
    demonyms: { eng: { f: 'Vatican', m: 'Vatican' }, fr: { f: 'Vaticane', m: 'Vatican' } },
    flag: '\uD83C\uDDFB\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'République française', common: 'France' } },
    },
    tld: ['.fr'],
    code: 'FR',
    ccn3: '250',
    ...
    translations: {
      ...
      jp: { official: 'フランス共和国', common: 'フランス' },
      kr: { official: '프랑스 공화국', common: '프랑스' },
      nld: { official: 'Franse Republiek', common: 'Frankrijk' },
      ir: { official: 'جمهوری فرانسه', common: 'فرانسه' },
      pol: { official: 'Republika Francuska', common: 'Francja' },
      pt: { official: 'República Francesa', common: 'França' },
      ru: { official: 'Французская Республика', common: 'Франция' },
      ...
      tr: { official: 'Fransa Cumhuriyeti', common: 'Fransa' },
      urd: { official: 'جمہوریہ فرانس', common: 'فرانس' },
      cn: { official: '法兰西共和国', common: '法国' },
    },
    latlng: [46.0, 2.0],
    landlocked: false,
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ポーランド共和国', common: 'ポーランド' },
      kr: { official: '폴란드 공화국', common: '폴란드' },
      nld: { official: 'Republiek Polen', common: 'Polen' },
      ir: { official: 'جمهوری لهستان', common: 'لهستان' },
      pol: { official: 'Rzeczpospolita Polska', common: 'Polska' },
      pt: { official: 'República da Polónia', common: 'Polónia' },
      ru: { official: 'Республика Польша', common: 'Польша' },
      ...
      tr: { official: 'Polonya Cumhuriyeti', common: 'Polonya' },
      urd: { official: 'جمہوریہ پولینڈ', common: 'پولینڈ' },
      cn: { official: '波兰共和国', common: '波兰' },
    },
    latlng: [52.0, 20.0],
    landlocked: false,
    borders: ['BLR', 'CZE', 'DEU', 'LTU', 'RUS', 'SVK', 'UKR'],
    area: 312679.0,
    demonyms: { eng: { f: 'Polish', m: 'Polish' }, fr: { f: 'Polonaise', m: 'Polonais' } },
    flag: '\uD83C\uDDF5\uD83C\uDDF1',
    maps: {
  ...
  },
  {
    ...
    region: 'Africa',
    subregion: 'Eastern Africa',
    languages: { ara: 'Arabic', fr: 'French', zdj: 'Comorian' },
    translations: {
      ...
      de: { official: 'Union der Komoren', common: 'Komoren' },
      ...
      jp: { official: 'コモロ連合', common: 'コモロ' },
      kr: { official: '코모로 연방', common: '코모로' },
      nld: { official: 'Unie van de Comoren', common: 'Comoren' },
      ir: { official: 'مجمع‌الجزایر قمر', common: 'اتحاد قُمُر' },
      pol: { official: 'Związek Komorów', common: 'Komory' },
      pt: { official: 'União das Comores', common: 'Comores' },
      ru: { official: 'Союз Коморских Островов', common: 'Коморы' },
      ...
      tr: { official: 'Komorlar Birliği', common: 'Komorlar' },
      urd: { official: 'اتحاد القمری', common: 'القمری' },
      cn: { official: '科摩罗联盟', common: '科摩罗' },
    },
    latlng: [-12.16666666, 44.25],
    landlocked: false,
    area: 1862.0,
    demonyms: { eng: { f: 'Comoran', m: 'Comoran' }, fr: { f: 'Comorienne', m: 'Comorien' } },
    flag: '\uD83C\uDDF0\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Unabhängiger Staat Papua-Neuguinea', common: 'Papua-Neuguinea' },
      ...
      fr: { official: 'État indépendant de Papouasie-Nouvelle-Guinée', common: 'Papouasie-Nouvelle-Guinée' },
      ...
      it: { official: 'Stato indipendente di Papua Nuova Guinea', common: 'Papua Nuova Guinea' },
      jp: { official: 'パプアニューギニア独立国', common: 'パプアニューギニア' },
      kr: { official: '파푸아뉴기니 독립국', common: '파푸아뉴기니' },
      nld: { official: 'Onafhankelijke Staat Papoea -Nieuw-Guinea', common: 'Papoea-Nieuw-Guinea' },
      ir: { official: 'مملکت مستقل پاپوآ گینهٔ نو', common: 'پاپوآ گینه نو' },
      pol: { official: 'Niezależne Państwo Papui-Nowej Gwinei', common: 'Papua-Nowa Gwinea' },
      pt: { official: 'Estado Independente da Papua Nova Guiné', common: 'Papua Nova Guiné' },
      ru: { official: 'Независимое Государство Папуа-Новой Гвинеи', common: 'Папуа — Новая Гвинея' },
      slk: { official: 'Nezávislý štát Papua-Nová Guinea', common: 'Papua-Nová Guinea' },
      es: { official: 'Estado Independiente de Papúa Nueva Guinea', common: 'Papúa Nueva Guinea' },
      swe: { official: 'Den oberoende staten Papua Nya Guinea', common: 'Papua Nya Guinea' },
      tr: { official: 'Papua Yeni Gine Bağımsız Devleti', common: 'Papua Yeni Gine' },
      urd: { official: 'آزاد ریاستِ پاپوا نیو گنی', common: 'پاپوا نیو گنی' },
      cn: { official: '巴布亚新几内亚', common: '巴布亚新几内亚' },
    },
    latlng: [-6.0, 147.0],
    landlocked: false,
    borders: ['IDN'],
    area: 462840.0,
    demonyms: { eng: { f: 'Papua New Guinean', m: 'Papua New Guinean' }, fr: { f: 'Papouasienne', m: 'Papouasien' } },
    flag: '\uD83C\uDDF5\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ケニア共和国', common: 'ケニア' },
      kr: { official: '케냐 공화국', common: '케냐' },
      nld: { official: 'Republiek Kenia', common: 'Kenia' },
      ir: { official: 'جمهوری کنیا', common: 'کنیا' },
      pol: { official: 'Republika Kenii', common: 'Kenia' },
      pt: { official: 'República do Quénia', common: 'Quénia' },
      ru: { official: 'Республика Кения', common: 'Кения' },
      ...
      tr: { official: 'Kenya Cumhuriyeti', common: 'Kenya' },
      urd: { official: 'جمہوریہ کینیا', common: 'کینیا' },
      cn: { official: '肯尼亚共和国', common: '肯尼亚' },
    },
    latlng: [1.0, 38.0],
    landlocked: false,
    borders: ['ETH', 'SOM', 'SSD', 'TZA', 'UGA'],
    area: 580367.0,
    demonyms: { eng: { f: 'Kenyan', m: 'Kenyan' }, fr: { f: 'Kényane', m: 'Kényan' } },
    flag: '\uD83C\uDDF0\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'République socialiste du Viêt Nam', common: 'Viêt Nam' },
      ...
      jp: { official: 'ベトナム社会主義共和国', common: 'ベトナム' },
      kr: { official: '베트남 사회주의 공화국', common: '베트남' },
      nld: { official: 'Socialistische Republiek Vietnam', common: 'Vietnam' },
      ir: { official: 'جمهوری سوسیالیستی ویتنام', common: 'ویتنام' },
      pol: { official: 'Socjalistyczna Republika Wietnamu', common: 'Wietnam' },
      pt: { official: 'República Socialista do Vietname', common: 'Vietname' },
      ru: { official: 'Социалистическая Республика Вьетнам', common: 'Вьетнам' },
      slk: { official: 'Vietnamská socialistická republika', common: 'Vietnam' },
      es: { official: 'República Socialista de Vietnam', common: 'Vietnam' },
      swe: { official: 'Socialistiska republiken Vietnam', common: 'Vietnam' },
      tr: { official: 'Vietnam Sosyalist Cumhuriyeti', common: 'Vietnam' },
      urd: { official: 'اشتراکی جمہوریہ ویتنام', common: 'ویتنام' },
      cn: { official: '越南社会主义共和国', common: '越南' },
    },
    latlng: [16.16666666, 107.83333333],
    landlocked: false,
    borders: ['KHM', 'CHN', 'LAO'],
    area: 331212.0,
    demonyms: { eng: { f: 'Vietnamese', m: 'Vietnamese' }, fr: { f: 'Vietnamienne', m: 'Vietnamien' } },
    flag: '\uD83C\uDDFB\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    ...
    region: 'Oceania',
    subregion: 'Melanesia',
    languages: { bis: 'Bislama', eng: 'English', fr: 'French' },
    translations: {
      ...
      jp: { official: 'バヌアツ共和国', common: 'バヌアツ' },
      kr: { official: '바누아투 공화국', common: '바누아투' },
      nld: { official: 'Republiek Vanuatu', common: 'Vanuatu' },
      ir: { official: 'جمهوری وانواتو', common: 'وانواتو' },
      pol: { official: 'Republika Vanuatu', common: 'Vanuatu' },
      pt: { official: 'República de Vanuatu', common: 'Vanuatu' },
      ru: { official: 'Республика Вануату', common: 'Вануату' },
      ...
      tr: { official: 'Vanuatu Cumhuriyeti', common: 'Vanuatu' },
      urd: { official: 'جمہوریہ وانواتو', common: 'وانواتو' },
      cn: { official: '瓦努阿图共和国', common: '瓦努阿图' },
    },
    latlng: [-16.0, 167.0],
    landlocked: false,
    area: 12189.0,
    demonyms: { eng: { f: 'Ni-Vanuatu', m: 'Ni-Vanuatu' }, fr: { f: 'Vanuatuane', m: 'Vanuatuan' } },
    flag: '\uD83C\uDDFB\uD83C\uDDFA',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        pt: { official: 'República da Guiné-Bissau', common: 'Guiné-Bissau' },
    ...
    region: 'Africa',
    subregion: 'Western Africa',
    languages: { pt: 'Portuguese', pov: 'Upper Guinea Creole' },
    translations: {
      ...
      fr: { official: 'République de Guinée-Bissau', common: 'Guinée-Bissau' },
      ...
      jp: { official: 'ギニアビサウ共和国', common: 'ギニアビサウ' },
      kr: { official: '기니비사우 공화국', common: '기니비사우' },
      nld: { official: 'Republiek Guinee-Bissau', common: 'Guinee-Bissau' },
      ir: { official: 'جمهوری گینه بیسائو', common: 'گینه بیسائو' },
      pol: { official: 'Republika Gwinei Bissau', common: 'Gwinea Bissau' },
      pt: { official: 'República da Guiné-Bissau', common: 'Guiné-Bissau' },
      ru: { official: 'Республика Гвинея -Бисау', common: 'Гвинея-Бисау' },
      slk: { official: 'Guinejsko-bissauská republika', common: 'Guinea-Bissau' },
      es: { official: 'República de Guinea-Bissau', common: 'Guinea-Bisáu' },
      swe: { official: 'Republiken Guinea-Bissau', common: 'Guinea-Bissau' },
      tr: { official: 'Gine-Bissau Cumhuriyeti', common: 'Gine-Bissau' },
      urd: { official: 'جمہوریہ گنی بساؤ', common: 'گنی بساؤ' },
      cn: { official: '几内亚比绍共和国', common: '几内亚比绍' },
    },
    latlng: [12.0, -15.0],
    landlocked: false,
    borders: ['GIN', 'SEN'],
    ...
    demonyms: {
      ...
      fr: { f: 'Bissau-Guinéenne', m: 'Bissau-Guinéen' },
    },
    flag: '\uD83C\uDDEC\uD83C\uDDFC',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        fr: { official: 'Collectivité territoriale de Saint-Pierre-et-Miquelon', common: 'Saint-Pierre-et-Miquelon' },
      },
    },
    tld: ['.pm'],
    code: 'PM',
    ...
    translations: {
      ...
      de: { official: 'St. Pierre und Miquelon', common: 'St. Pierre und Miquelon' },
      ...
      fr: { official: 'Saint-Pierre-et-Miquelon', common: 'Saint-Pierre-et-Miquelon' },
      ...
      it: { official: 'Saint Pierre e Miquelon', common: 'Saint-Pierre e Miquelon' },
      jp: { official: 'サンピエール島·ミクロン島', common: 'サンピエール島・ミクロン島' },
      kr: { official: '생피에르 미클롱', common: '생피에르 미클롱' },
      nld: { official: 'Saint-Pierre en Miquelon', common: 'Saint Pierre en Miquelon' },
      ir: { official: 'سن-پیر-ا-میکلون', common: 'سن-پیِر و میکلُن' },
      pol: { official: 'Saint-Pierre i Miquelon', common: 'Saint-Pierre i Miquelon' },
      pt: { official: 'Saint Pierre e Miquelon', common: 'Saint-Pierre e Miquelon' },
      ru: { official: 'Сен-Пьер и Микелон', common: 'Сен-Пьер и Микелон' },
      slk: { official: 'Ostrovy Saint Pierre a Miquelon', common: 'Saint Pierre a Miquelon' },
      es: { official: 'San Pedro y Miquelón', common: 'San Pedro y Miquelón' },
      swe: { official: 'Saint-Pierre och Miquelon', common: 'Saint-Pierre och Miquelon' },
      tr: { official: 'Saint Pierre ve Miquelon', common: 'Saint Pierre ve Miquelon' },
      urd: { official: 'سینٹ پیئر و میکیلون', common: 'سینٹ پیئر و میکیلون' },
      cn: { official: '圣皮埃尔和密克隆', common: '圣皮埃尔和密克隆' },
    },
    ...
    demonyms: {
      ...
      fr: { f: 'Saint-Pierraise, Miquelonaise', m: 'Saint-Pierrais, Miquelonais' },
    },
    flag: '\uD83C\uDDF5\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      tr: { official: 'Saint Helena', common: 'Saint Helena' },
      urd: { official: 'سینٹ ہلینا، اسینشن و ترسٹان دا کونیا', common: 'سینٹ ہلینا، اسینشن و ترسٹان دا کونیا' },
      cn: { official: '圣赫勒拿、阿森松和特里斯坦-达库尼亚', common: '圣赫勒拿、阿森松和特里斯坦-达库尼亚' },
    },
    latlng: [-15.95, -5.72],
    landlocked: false,
    area: 394.0,
    demonyms: {
      ...
      fr: { f: 'Sainte-Hélénoise', m: 'Sainte-Hélènois' },
    },
    flag: '\uD83C\uDDF8\uD83C\uDDED',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ウガンダ共和国', common: 'ウガンダ' },
      kr: { official: '우간다 공화국', common: '우간다' },
      nld: { official: 'Republiek Uganda', common: 'Oeganda' },
      ir: { official: 'جمهوری اوگاندا', common: 'اوگاندا' },
      pol: { official: 'Republika Ugandy', common: 'Uganda' },
      pt: { official: 'República do Uganda', common: 'Uganda' },
      ru: { official: 'Республика Уганда', common: 'Уганда' },
      ...
      tr: { official: 'Uganda Cumhuriyeti', common: 'Uganda' },
      urd: { official: 'جمہوریہ یوگنڈا', common: 'یوگنڈا' },
      cn: { official: '乌干达共和国', common: '乌干达' },
    },
    latlng: [1.0, 32.0],
    landlocked: true,
    borders: ['COD', 'KEN', 'RWA', 'SSD', 'TZA'],
    area: 241550.0,
    demonyms: { eng: { f: 'Ugandan', m: 'Ugandan' }, fr: { f: 'Ougandaise', m: 'Ougandais' } },
    flag: '\uD83C\uDDFA\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ru: { official: 'Республика Узбекистан', common: 'Узбекистан' },
    ...
    languages: { ru: 'Russian', uzb: 'Uzbek' },
    translations: {
      ...
      fr: { official: "République d'Ouzbékistan", common: 'Ouzbékistan' },
      ...
      jp: { official: 'ウズベキスタン共和国', common: 'ウズベキスタン' },
      kr: { official: '우즈베키스탄 공화국', common: '우즈베키스탄' },
      nld: { official: 'Republiek Oezbekistan', common: 'Oezbekistan' },
      ir: { official: 'جمهوری ازبکستان', common: 'ازبکستان' },
      pol: { official: 'Republika Uzbekistanu', common: 'Uzbekistan' },
      pt: { official: 'República do Usbequistão', common: 'Uzbequistão' },
      ru: { official: 'Республика Узбекистан', common: 'Узбекистан' },
      slk: { official: 'Uzbecká republika', common: 'Uzbekistan' },
      es: { official: 'República de Uzbekistán', common: 'Uzbekistán' },
      swe: { official: 'Republiken Uzbekistan', common: 'Uzbekistan' },
      tr: { official: 'Özbekistan Cumhuriyeti', common: 'Özbekistan' },
      urd: { official: 'جمہوریہ ازبکستان', common: 'ازبکستان' },
      cn: { official: '乌兹别克斯坦共和国', common: '乌兹别克斯坦' },
    },
    latlng: [41.0, 64.0],
    landlocked: true,
    borders: ['AFG', 'KAZ', 'KGZ', 'TJK', 'TKM'],
    area: 447400.0,
    demonyms: { eng: { f: 'Uzbekistani', m: 'Uzbekistani' }, fr: { f: 'Ouzbèke', m: 'Ouzbèke' } },
    flag: '\uD83C\uDDFA\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'Nouvelle-Calédonie', common: 'Nouvelle-Calédonie' } },
    },
    tld: ['.nc'],
    code: 'NC',
    ccn3: '540',
    ...
    translations: {
      ...
      fr: { official: 'Nouvelle-Calédonie', common: 'Nouvelle-Calédonie' },
      ...
      jp: { official: 'ニューカレドニア', common: 'ニューカレドニア' },
      kr: { official: '누벨칼레도니', common: '누벨칼레도니' },
      nld: { official: 'nieuw -Caledonië', common: 'Nieuw-Caledonië' },
      ir: { official: 'کالدونیای جدید', common: 'کالدونیای جدید' },
      pol: { official: 'Nowa Kaledonia', common: 'Nowa Kaledonia' },
      pt: { official: 'New Caledonia', common: 'Nova Caledónia' },
      ru: { official: 'Новая Каледония', common: 'Новая Каледония' },
      ...
      tr: { official: 'Yeni Kaledonya', common: 'Yeni Kaledonya' },
      urd: { official: 'نیو کیلیڈونیا', common: 'نیو کیلیڈونیا' },
      cn: { official: '新喀里多尼亚', common: '新喀里多尼亚' },
    },
    latlng: [-21.5, 165.5],
    landlocked: false,
    area: 18575.0,
    demonyms: {
      ...
      fr: { f: 'Néo-Calédonienne', m: 'Néo-Calédonien' },
    },
    flag: '\uD83C\uDDF3\uD83C\uDDE8',
    maps: {
  ...
  },
  {
    ...
    region: 'Americas',
    subregion: 'South America',
    languages: { grn: 'Guaraní', es: 'Spanish' },
    translations: {
      ...
      jp: { official: 'パラグアイ共和国', common: 'パラグアイ' },
      kr: { official: '파라과이 공화국', common: '파라과이' },
      nld: { official: 'Republiek Paraguay', common: 'Paraguay' },
      ir: { official: 'جمهوری پاراگوئه', common: 'پاراگوئه' },
      pol: { official: 'Republika Paragwaju', common: 'Paragwaj' },
      pt: { official: 'República do Paraguai', common: 'Paraguai' },
      ru: { official: 'Республика Парагвай', common: 'Парагвай' },
      slk: { official: 'Paraguajská republika', common: 'Paraguaj' },
      es: { official: 'República de Paraguay', common: 'Paraguay' },
      swe: { official: 'Republiken Paraguay', common: 'Paraguay' },
      tr: { official: 'Paraguay Cumhuriyeti', common: 'Paraguay' },
      urd: { official: 'جمہوریہ پیراگوئے', common: 'پیراگوئے' },
      cn: { official: '巴拉圭共和国', common: '巴拉圭' },
    },
    latlng: [-23.0, -58.0],
    landlocked: true,
    borders: ['ARG', 'BOL', 'BRA'],
    area: 406752.0,
    demonyms: { eng: { f: 'Paraguayan', m: 'Paraguayan' }, fr: { f: 'Paraguayenne', m: 'Paraguayen' } },
    flag: '\uD83C\uDDF5\uD83C\uDDFE',
    maps: {
  ...
  },
  {
    name: {
      common: 'Canada',
      official: 'Canada',
      nativeName: { eng: { official: 'Canada', common: 'Canada' }, fr: { official: 'Canada', common: 'Canada' } },
    },
    tld: ['.ca'],
    code: 'CA',
    ccn3: '124',
    ...
    region: 'Americas',
    subregion: 'North America',
    languages: { eng: 'English', fr: 'French' },
    translations: {
      ...
      jp: { official: 'カナダ', common: 'カナダ' },
      kr: { official: '캐나다', common: '캐나다' },
      nld: { official: 'Canada', common: 'Canada' },
      ir: { official: 'کانادا', common: 'کانادا' },
      pol: { official: 'Kanada', common: 'Kanada' },
      pt: { official: 'Canadá', common: 'Canadá' },
      ru: { official: 'Канада', common: 'Канада' },
      slk: { official: 'Kanada', common: 'Kanada' },
      es: { official: 'Canadá', common: 'Canadá' },
      swe: { official: 'Kanada', common: 'Kanada' },
      tr: { official: 'Kanada', common: 'Kanada' },
      urd: { official: 'کینیڈا', common: 'کینیڈا' },
      cn: { official: '加拿大', common: '加拿大' },
    },
    latlng: [60.0, -95.0],
    landlocked: false,
    borders: ['USA'],
    area: 9984670.0,
    demonyms: { eng: { f: 'Canadian', m: 'Canadian' }, fr: { f: 'Canadienne', m: 'Canadien' } },
    flag: '\uD83C\uDDE8\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ニウエ', common: 'ニウエ' },
      kr: { official: '니우에', common: '니우에' },
      nld: { official: 'Niue', common: 'Niue' },
      ir: { official: 'نیووی', common: 'نیووی' },
      pol: { official: 'Niue', common: 'Niue' },
      pt: { official: 'Niue', common: 'Niue' },
      ru: { official: 'Ниуэ', common: 'Ниуэ' },
      slk: { official: 'Niue', common: 'Niue' },
      es: { official: 'Niue', common: 'Niue' },
      swe: { official: 'Niue', common: 'Niue' },
      tr: { official: 'Niue', common: 'Niue' },
      urd: { official: 'نیووے', common: 'نیووے' },
      cn: { official: '纽埃', common: '纽埃' },
    },
    latlng: [-19.03333333, -169.86666666],
    landlocked: false,
    area: 260.0,
    demonyms: { eng: { f: 'Niuean', m: 'Niuean' }, fr: { f: 'Niuéenne', m: 'Niuéen' } },
    flag: '\uD83C\uDDF3\uD83C\uDDFA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'タイ王国', common: 'タイ' },
      kr: { official: '타이 왕국', common: '태국' },
      nld: { official: 'Koninkrijk Thailand', common: 'Thailand' },
      ir: { official: 'پادشاهی تایلند', common: 'تایلند' },
      pol: { official: 'Królestwo Tajlandii', common: 'Tajlandia' },
      pt: { official: 'Reino da Tailândia', common: 'Tailândia' },
      ru: { official: 'Королевство Таиланд', common: 'Таиланд' },
      ...
      tr: { official: 'Tayland Krallığı', common: 'Tayland' },
      urd: { official: 'مملکتِ تھائی لینڈ', common: 'تھائی لینڈ' },
      cn: { official: '泰王国', common: '泰国' },
    },
    latlng: [15.0, 100.0],
    landlocked: false,
    borders: ['MMR', 'KHM', 'LAO', 'MYS'],
    area: 513120.0,
    demonyms: { eng: { f: 'Thai', m: 'Thai' }, fr: { f: 'Thaïlandaise', m: 'Thaïlandais' } },
    flag: '\uD83C\uDDF9\uD83C\uDDED',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'オーストリア共和国', common: 'オーストリア' },
      kr: { official: '오스트리아 공화국', common: '오스트리아' },
      nld: { official: 'Republiek Oostenrijk', common: 'Oostenrijk' },
      ir: { official: 'جمهوری اتریش', common: 'اتریش' },
      pol: { official: 'Republika Austrii', common: 'Austria' },
      pt: { official: 'República da Áustria', common: 'Áustria' },
      ru: { official: 'Австрийская Республика', common: 'Австрия' },
      ...
      tr: { official: 'Avusturya Cumhuriyeti', common: 'Avusturya' },
      urd: { official: 'جمہوریہ آسٹریا', common: 'آسٹریا' },
      cn: { official: '奥地利共和国', common: '奥地利' },
    },
    latlng: [47.33333333, 13.33333333],
    landlocked: true,
    borders: ['CZE', 'DEU', 'HUN', 'ITA', 'LIE', 'SVK', 'SVN', 'CHE'],
    area: 83871.0,
    demonyms: { eng: { f: 'Austrian', m: 'Austrian' }, fr: { f: 'Autrichienne', m: 'Autrichien' } },
    flag: '\uD83C\uDDE6\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'バーレーン王国', common: 'バーレーン' },
      kr: { official: '바레인 왕국', common: '바레인' },
      nld: { official: 'Koninkrijk Bahrein', common: 'Bahrein' },
      ir: { official: 'پادشاهی بحرین', common: 'بحرین' },
      pol: { official: 'Królestwo Bahrajnu', common: 'Bahrajn' },
      pt: { official: 'Reino do Bahrein', common: 'Bahrein' },
      ru: { official: 'Королевство Бахрейн', common: 'Бахрейн' },
      ...
      tr: { official: 'Bahreyn Krallığı', common: 'Bahreyn' },
      urd: { official: 'مملکتِ بحرین', common: 'بحرین' },
      cn: { official: '巴林王国', common: '巴林' },
    },
    latlng: [26.0, 50.55],
    landlocked: false,
    area: 765.0,
    demonyms: { eng: { f: 'Bahraini', m: 'Bahraini' }, fr: { f: 'Bahreïnienne', m: 'Bahreïnien' } },
    flag: '\uD83C\uDDE7\uD83C\uDDED',
    maps: {
  ...
  },
  {
    ...
    status: 'officially-assigned',
    unMember: true,
    currencies: { NPT: { name: 'Nepalese rupee', symbol: '₨' } },
    ...
    translations: {
      ...
      de: { official: 'Demokratische Bundesrepublik Nepal', common: 'Nepal' },
      ...
      it: { official: 'Repubblica federale democratica del Nepal', common: 'Nepal' },
      jp: { official: 'ネパール連邦民主共和国', common: 'ネパール' },
      kr: { official: '네팔 연방 민주 공화국', common: '네팔' },
      nld: { official: 'Federale Democratische Republiek Nepal', common: 'Nepal' },
      ir: { official: 'جمهوری فدرال دموکراتیک نپال', common: 'نپال' },
      pol: { official: 'Federalna Demokratyczna Republika Nepalu', common: 'Nepal' },
      pt: { official: 'República Democrática Federal do Nepal', common: 'Nepal' },
      ru: { official: 'Федеративная Демократическая Республика Непал', common: 'Непал' },
      slk: { official: 'Nepálska federatívna demokratická republika', common: 'Nepál' },
      es: { official: 'República Democrática Federal de Nepal', common: 'Nepal' },
      swe: { official: 'Demokratiska förbundsrepubliken Nepal', common: 'Nepal' },
      tr: { official: 'Nepal Federal Demokratik Cumhuriyeti', common: 'Nepal' },
      urd: { official: 'وفاقی جمہوری جمہوریہ نیپال', common: 'نیپال' },
      cn: { official: '尼泊尔联邦民主共和国', common: '尼泊尔' },
    },
    latlng: [28.0, 84.0],
    landlocked: true,
    borders: ['CHN', 'IND'],
    area: 147181.0,
    demonyms: { eng: { f: 'Nepalese', m: 'Nepalese' }, fr: { f: 'Népalaise', m: 'Népalais' } },
    flag: '\uD83C\uDDF3\uD83C\uDDF5',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Demokratische Volksrepublik Algerien', common: 'Algerien' },
      ...
      fr: { official: "République démocratique et populaire d'Algérie", common: 'Algérie' },
      ...
      it: { official: 'Repubblica popolare democratica di Algeria', common: 'Algeria' },
      jp: { official: 'アルジェリア人民民主共和国', common: 'アルジェリア' },
      kr: { official: '알제리 인민 민주 공화국', common: '알제리' },
      nld: { official: 'Democratische Volksrepubliek Algerije', common: 'Algerije' },
      ir: { official: 'جمهوری دموکراتیک خلق الجزایر', common: 'الجزایر' },
      pol: { official: 'Algierska Republika Ludowo-Demokratyczna', common: 'Algieria' },
      pt: { official: 'República Argelina Democrática e Popular', common: 'Argélia' },
      ru: { official: 'Народно-Демократическая Республика Алжир', common: 'Алжир' },
      slk: { official: 'Alžírska demokratická ľudová republika', common: 'Alžírsko' },
      es: { official: 'República Argelina Democrática y Popular', common: 'Argelia' },
      swe: { official: 'Demokratiska folkrepubliken Algeriet', common: 'Algeriet' },
      tr: { official: 'Cezayir Demokratik Halk Cumhuriyeti', common: 'Cezayir' },
      urd: { official: 'عوامی جمہوری جمہوریہ الجزائر', common: 'الجزائر' },
      cn: { official: '阿尔及利亚人民民主共和国', common: '阿尔及利亚' },
    },
    latlng: [28.0, 3.0],
    landlocked: false,
    borders: ['TUN', 'LBY', 'NER', 'ESH', 'MRT', 'MLI', 'MAR'],
    area: 2381741.0,
    demonyms: { eng: { f: 'Algerian', m: 'Algerian' }, fr: { f: 'Algérienne', m: 'Algérien' } },
    flag: '\uD83C\uDDE9\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        ru: { official: 'Республика Казахстан', common: 'Казахстан' },
      },
    },
    tld: ['.kz', '.қаз'],
    code: 'KZ',
    ...
    region: 'Asia',
    subregion: 'Central Asia',
    languages: { kaz: 'Kazakh', ru: 'Russian' },
    translations: {
      ...
      jp: { official: 'カザフスタン共和国', common: 'カザフスタン' },
      kr: { official: '카자흐스탄 공화국', common: '카자흐스탄' },
      nld: { official: 'Republiek Kazachstan', common: 'Kazachstan' },
      ir: { official: 'جمهوری قزاقستان', common: 'قزاقستان' },
      pol: { official: 'Republika Kazachstanu', common: 'Kazachstan' },
      pt: { official: 'República do Cazaquistão', common: 'Cazaquistão' },
      ru: { official: 'Республика Казахстан', common: 'Казахстан' },
      slk: { official: 'Kazašská republika', common: 'Kazachstan' },
      es: { official: 'República de Kazajstán', common: 'Kazajistán' },
      swe: { official: 'Republiken Kazakstan', common: 'Kazakstan' },
      tr: { official: 'Kazakistan Cumhuriyeti', common: 'Kazakistan' },
      urd: { official: 'جمہوریہ قازقستان', common: 'قازقستان' },
      cn: { official: '哈萨克斯坦共和国', common: '哈萨克斯坦' },
    },
    latlng: [48.0196, 66.9237],
    landlocked: true,
    borders: ['CHN', 'KGZ', 'RUS', 'TKM', 'UZB'],
    area: 2724900.0,
    demonyms: { eng: { f: 'Kazakhstani', m: 'Kazakhstani' }, fr: { f: 'Kazakhstanaise', m: 'Kazakhstanais' } },
    flag: '\uD83C\uDDF0\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Demokratische Volksrepublik Laos', common: 'Laos' },
      est: { official: 'Laose Demokraatlik Rahvavabariik', common: 'Laos' },
      fin: { official: 'Laosin demokraattinen kansantasavalta', common: 'Laos' },
      fr: { official: 'République démocratique populaire lao', common: 'Laos' },
      hrv: { official: 'Narodna Demokratska Republika', common: 'Laos' },
      hun: { official: 'Laoszi Népi Demokratikus Köztársaság', common: 'Laosz' },
      it: { official: 'Repubblica democratica popolare del Laos', common: 'Laos' },
      jp: { official: 'ラオス人民民主共和国', common: 'ラオス人民民主共和国' },
      kr: { official: '라오 인민 민주 공화국', common: '라오스' },
      nld: { official: 'Lao Democratische Volksrepubliek', common: 'Laos' },
      ir: { official: 'جمهوری دموکراتیک خلق لائوس', common: 'لائوس' },
      pol: { official: 'Laotańska Republika Ludowo-Demokratyczna', common: 'Laos' },
      pt: { official: 'Laos, República Democrática', common: 'Laos' },
      ru: { official: 'Лаосская Народно-Демократическая Республика', common: 'Лаос' },
      slk: { official: 'Laoská ľudovodemokratická republika', common: 'Laos' },
      es: { official: 'República Democrática Popular Lao', common: 'Laos' },
      swe: { official: 'Demokratiska folkrepubliken Laos', common: 'Laos' },
      tr: { official: 'Laos Demokratik Halk Cumhuriyeti', common: 'Laos' },
      urd: { official: 'عوامی جمہوری جمہوریہ لاؤ', common: 'لاؤس' },
      cn: { official: '老挝人民民主共和国', common: '老挝' },
    },
    latlng: [18.0, 105.0],
    landlocked: true,
    borders: ['MMR', 'KHM', 'CHN', 'THA', 'VNM'],
    area: 236800.0,
    demonyms: { eng: { f: 'Laotian', m: 'Laotian' }, fr: { f: 'Laotienne', m: 'Laotien' } },
    flag: '\uD83C\uDDF1\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Republik Kosovo', common: 'Kosovo' },
      ...
      it: { official: 'Repubblica del Kosovo', common: 'Kosovo' },
      kr: { official: '코소보 공화국', common: '코소보' },
      nld: { official: 'Republiek Kosovo', common: 'Kosovo' },
      ir: { official: 'جمهوری کوزوو', common: 'کوزوو' },
      pol: { official: 'Republika Kosowa', common: 'Kosowo' },
      pt: { official: 'República do Kosovo', common: 'Kosovo' },
      ru: { official: 'Республика Косово', common: 'Республика Косово' },
      ...
      tr: { official: 'Kosova Cumhuriyeti', common: 'Kosova' },
      urd: { official: 'جمہوریہ کوسووہ', common: 'کوسووہ' },
      cn: { official: '科索沃共和国', common: '科索沃' },
    },
    latlng: [42.666667, 21.166667],
    landlocked: true,
    borders: ['ALB', 'MKD', 'MNE', 'SRB'],
    area: 10908.0,
    demonyms: { eng: { f: 'Kosovar', m: 'Kosovar' }, fr: { f: 'Kosovare', m: 'Kosovar' } },
    flag: '\uD83C\uDDFD\uD83C\uDDF0',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: "République de Côte d'Ivoire", common: "Côte d'Ivoire" } },
    },
    tld: ['.ci'],
    code: 'CI',
    ccn3: '384',
    ...
    translations: {
      ...
      de: { official: "Republik Côte d'Ivoire", common: 'Elfenbeinküste' },
      ...
      fr: { official: "République de Côte d' Ivoire", common: "Côte d'Ivoire" },
      ...
      it: { official: "Repubblica della Costa d'Avorio", common: "Costa d'Avorio" },
      jp: { official: 'コートジボワール共和国', common: 'コートジボワール' },
      kr: { official: '코트디부아르 공화국', common: '코트디부아르' },
      nld: { official: 'Republiek Ivoorkust', common: 'Ivoorkust' },
      ir: { official: 'جمهوری ساحل عاج', common: 'ساحل عاج' },
      pol: { official: 'Republika WybrzeŻa Kości Słoniowej', common: 'WybrzeŻe Kości Słoniowej' },
      pt: { official: "República da Côte d'Ivoire", common: 'Costa do Marfim' },
      ru: { official: "Республика Кот-д'Ивуаре", common: 'Кот-д’Ивуар' },
      slk: { official: 'Republika Pobrežie Slonoviny', common: 'Pobržie Slonoviny' },
      es: { official: "República de Côte d'Ivoire", common: 'Costa de Marfil' },
      swe: { official: 'Republiken Elfenbenskusten', common: 'Elfenbenskusten' },
      tr: { official: 'Fildişi Sahili', common: 'Fildişi Sahili' },
      urd: { official: 'جمہوریہ کوت دیواغ', common: 'آئیوری کوسٹ' },
      cn: { official: '科特迪瓦共和国', common: '科特迪瓦' },
    },
    latlng: [8.0, -5.0],
    landlocked: false,
    borders: ['BFA', 'GHA', 'GIN', 'LBR', 'MLI'],
    area: 322463.0,
    demonyms: { eng: { f: 'Ivorian', m: 'Ivorian' }, fr: { f: 'Ivoirienne', m: 'Ivoirien' } },
    flag: '\uD83C\uDDE8\uD83C\uDDEE',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'Îles Caïmans', common: 'Îles Caïmans' },
      ...
      jp: { official: 'ケイマン諸島', common: 'ケイマン諸島' },
      kr: { official: '케이맨 제도', common: '케이맨 제도' },
      nld: { official: 'Caymaneilanden', common: 'Caymaneilanden' },
      ir: { official: 'جزایر کیمن', common: 'جزایر کیمن' },
      pol: { official: 'Kajmany', common: 'Kajmany' },
      pt: { official: 'Ilhas Cayman', common: 'Ilhas Caimão' },
      ru: { official: 'Каймановы острова', common: 'Каймановы острова' },
      ...
      tr: { official: 'Cayman Adaları', common: 'Cayman Adaları' },
      urd: { official: 'جزائر کیمین', common: 'جزائر کیمین' },
      cn: { official: '开曼群岛', common: '开曼群岛' },
    },
    latlng: [19.3133, 81.2546],
    landlocked: false,
    area: 264.0,
    demonyms: { eng: { f: 'Caymanian', m: 'Caymanian' }, fr: { f: 'Caïmanienne', m: 'Caïmanien' } },
    flag: '\uD83C\uDDF0\uD83C\uDDFE',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'チャド共和国', common: 'チャド' },
      kr: { official: '차드 공화국', common: '차드' },
      nld: { official: 'Republiek Tsjaad', common: 'Tsjaad' },
      ir: { official: 'جمهوری چاد', common: 'چاد' },
      pol: { official: 'Republika Czadu', common: 'Czad' },
      pt: { official: 'República do Chade', common: 'Chade' },
      ru: { official: 'Республика Чад', common: 'Чад' },
      ...
      tr: { official: 'Çad Cumhuriyeti', common: 'Çad' },
      urd: { official: 'جمہوریہ چاڈ', common: 'چاڈ' },
      cn: { official: '乍得共和国', common: '乍得' },
    },
    latlng: [15.0, 19.0],
    landlocked: true,
    borders: ['CMR', 'CAF', 'LBY', 'NER', 'NGA', 'SDN'],
    area: 1284000.0,
    demonyms: { eng: { f: 'Chadian', m: 'Chadian' }, fr: { f: 'Tchadienne', m: 'Tchadien' } },
    flag: '\uD83C\uDDF9\uD83C\uDDE9',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ru: { official: 'Туркменистан', common: 'Туркмения' },
    ...
    region: 'Asia',
    subregion: 'Central Asia',
    languages: { ru: 'Russian', tuk: 'Turkmen' },
    translations: {
      ...
      jp: { official: 'トルクメニスタン', common: 'トルクメニスタン' },
      kr: { official: '투르크메니스탄', common: '투르크메니스탄' },
      nld: { official: 'Turkmenistan', common: 'Turkmenistan' },
      ir: { official: 'جمهوری خلق ترکمنستان', common: 'ترکمنستان' },
      pol: { official: 'Republika Turkmenistanu', common: 'Turkmenistan' },
      pt: { official: 'Turcomenistão', common: 'Turquemenistão' },
      ru: { official: 'Туркменистан', common: 'Туркмения' },
      ...
      tr: { official: 'Türkmenistan', common: 'Türkmenistan' },
      urd: { official: 'ترکمانستان', common: 'ترکمانستان' },
      cn: { official: '土库曼斯坦', common: '土库曼斯坦' },
    },
    latlng: [40.0, 60.0],
    landlocked: true,
    borders: ['AFG', 'IRN', 'KAZ', 'UZB'],
    area: 488100.0,
    demonyms: { eng: { f: 'Turkmen', m: 'Turkmen' }, fr: { f: 'Turkmène', m: 'Turkmène' } },
    flag: '\uD83C\uDDF9\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        es: { official: 'Estado Libre Asociado de Puerto Rico', common: 'Puerto Rico' },
      },
    },
    tld: ['.pr'],
    code: 'PR',
    ...
    region: 'Americas',
    subregion: 'Caribbean',
    languages: { eng: 'English', es: 'Spanish' },
    translations: {
      ...
      de: { official: 'Freistaat Puerto Rico', common: 'Puerto Rico' },
      ...
      jp: { official: 'プエルトリコのコモンウェルス', common: 'プエルトリコ' },
      kr: { official: '푸에르토리코', common: '푸에르토리코' },
      nld: { official: 'Gemenebest van Puerto Rico', common: 'Puerto Rico' },
      ir: { official: 'قلمرو همسود پورتوریکو', common: 'پورتوریکو' },
      pol: { official: 'Wolne Stowarzyszone Państwo Portoryko', common: 'Portoryko' },
      pt: { official: 'Commonwealth of Puerto Rico', common: 'Porto Rico' },
      ru: { official: 'Содружество Пуэрто-Рико', common: 'Пуэрто-Рико' },
      ...
      tr: { official: 'Porto Riko Topluluğu', common: 'Porto Riko' },
      urd: { official: ' دولتِ مشترکہ پورٹو ریکو', common: 'پورٹو ریکو' },
      cn: { official: '波多黎各联邦', common: '波多黎各' },
    },
    latlng: [18.25, -66.5],
    landlocked: false,
    area: 8870.0,
    demonyms: { eng: { f: 'Puerto Rican', m: 'Puerto Rican' }, fr: { f: 'Portoricaine', m: 'Portoricain' } },
    flag: '\uD83C\uDDF5\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { pt: { official: 'República Federativa do Brasil', common: 'Brasil' } },
    },
    tld: ['.br'],
    code: 'BR',
    ccn3: '076',
    ...
    translations: {
      ...
      de: { official: 'Föderative Republik Brasilien', common: 'Brasilien' },
      est: { official: 'Brasiilia Liitvabariik', common: 'Brasiilia' },
      fin: { official: 'Brasilian liittotasavalta', common: 'Brasilia' },
      fr: { official: 'République fédérative du Brésil', common: 'Brésil' },
      ...
      jp: { official: 'ブラジル連邦共和国', common: 'ブラジル' },
      kr: { official: '브라질 연방 공화국', common: '브라질' },
      nld: { official: 'Federale Republiek Brazilië', common: 'Brazilië' },
      ir: { official: 'جمهوری فدراتیو برزیل', common: 'برزیل' },
      pol: { official: 'Federacyjna Republika Brazylii', common: 'Brazylia' },
      pt: { official: 'República Federativa do Brasil', common: 'Brasil' },
      ru: { official: 'Федеративная Республика Бразилия', common: 'Бразилия' },
      ...
      tr: { official: 'Brezilya Federal Cumhuriyeti', common: 'Brezilya' },
      urd: { official: 'وفاقی جمہوریہ برازیل', common: 'برازیل' },
      cn: { official: '巴西联邦共和国', common: '巴西' },
    },
    latlng: [-10.0, -55.0],
    landlocked: false,
    borders: ['ARG', 'BOL', 'COL', 'GUF', 'GUY', 'PRY', 'PER', 'SUR', 'URY', 'VEN'],
    area: 8515767.0,
    demonyms: { eng: { f: 'Brazilian', m: 'Brazilian' }, fr: { f: 'Brésilienne', m: 'Brésilien' } },
    flag: '\uD83C\uDDE7\uD83C\uDDF7',
    maps: {
  ...
  {
    name: { common: 'Romania', official: 'Romania', nativeName: { ron: { official: 'România', common: 'România' } } },
    tld: ['.ro'],
    code: 'RO',
    ccn3: '642',
    cca3: 'ROU',
    ...
    translations: {
      ...
      jp: { official: 'ルーマニア', common: 'ルーマニア' },
      kr: { official: '루마니아', common: '루마니아' },
      nld: { official: 'Roemenië', common: 'Roemenië' },
      ir: { official: 'رومانی', common: 'رومانی' },
      pol: { official: 'Rumunia', common: 'Rumunia' },
      pt: { official: 'Romênia', common: 'Roménia' },
      ru: { official: 'Румыния', common: 'Румыния' },
      slk: { official: 'Rumunsko', common: 'Rumunsko' },
      es: { official: 'Rumania', common: 'Rumania' },
      swe: { official: 'Rumänien', common: 'Rumänien' },
      tr: { official: 'Romanya', common: 'Romanya' },
      urd: { official: 'رومانیہ', common: 'رومانیہ' },
      cn: { official: '罗马尼亚', common: '罗马尼亚' },
    },
    latlng: [46.0, 25.0],
    landlocked: false,
    borders: ['BGR', 'HUN', 'MDA', 'SRB', 'UKR'],
    area: 238391.0,
    demonyms: { eng: { f: 'Romanian', m: 'Romanian' }, fr: { f: 'Roumaine', m: 'Roumain' } },
    flag: '\uD83C\uDDF7\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    ...
    region: 'Americas',
    subregion: 'Caribbean',
    languages: { eng: 'English', fr: 'French', nld: 'Dutch' },
    translations: {
      ...
      jp: { official: 'シントマールテン島', common: 'シント・マールテン' },
      kr: { official: '신트마르턴', common: '신트마르턴' },
      nld: { official: 'Sint Maarten', common: 'Sint Maarten' },
      ir: { official: 'سن مارتن', common: 'سن مارتن' },
      pol: { official: 'Sint Maarten', common: 'Sint Maarten' },
      pt: { official: 'Sint Maarten', common: 'São Martinho' },
      ru: { official: 'Синт-Маартен', common: 'Синт-Мартен' },
      ...
      tr: { official: 'Sint Maarten', common: 'Sint Maarten' },
      urd: { official: 'سنٹ مارٹن', common: 'سنٹ مارٹن' },
      cn: { official: '圣马丁岛', common: '圣马丁岛' },
    },
    latlng: [18.033333, -63.05],
    landlocked: false,
    borders: ['MAF'],
    area: 34.0,
    demonyms: { eng: { f: 'St. Maartener', m: 'St. Maartener' }, fr: { f: 'Saint-Martinoise', m: 'Saint-Martinois' } },
    flag: '\uD83C\uDDF8\uD83C\uDDFD',
    maps: {
  ...
  },
  {
    ...
    region: 'Europe',
    subregion: 'Western Europe',
    languages: { fr: 'French', gsw: 'Swiss German', it: 'Italian', roh: 'Romansh' },
    translations: {
      ...
      it: { official: 'Confederazione svizzera', common: 'Svizzera' },
      jp: { official: 'スイス連邦', common: 'スイス' },
      kr: { official: '스위스 연방', common: '스위스' },
      nld: { official: 'Zwitserse Confederatie', common: 'Zwitserland' },
      ir: { official: 'کنفدراسیون سوئیس', common: 'سوئیس' },
      pol: { official: 'Konfederacja Szwajcarska', common: 'Szwajcaria' },
      pt: { official: 'Confederação Suíça', common: 'Suíça' },
      ru: { official: 'Швейцарская Конфедерация', common: 'Швейцария' },
      ...
      tr: { official: 'İsviçre Konfederasyonu', common: 'İsviçre' },
      urd: { official: 'سوئیس  متحدہ', common: 'سویٹذرلینڈ' },
      cn: { official: '瑞士联邦', common: '瑞士' },
    },
    latlng: [47.0, 8.0],
    landlocked: true,
    borders: ['AUT', 'FRA', 'ITA', 'LIE', 'DEU'],
    area: 41284.0,
    demonyms: { eng: { f: 'Swiss', m: 'Swiss' }, fr: { f: 'Suisse', m: 'Suisse' } },
    flag: '\uD83C\uDDE8\uD83C\uDDED',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { pt: { official: 'República Democrática do São Tomé e Príncipe', common: 'São Tomé e Príncipe' } },
    },
    tld: ['.st'],
    code: 'ST',
    ccn3: '678',
    ...
    translations: {
      ...
      de: { official: 'Demokratische Republik São Tomé und Príncipe', common: 'São Tomé und Príncipe' },
      ...
      fr: { official: 'République démocratique de São Tomé et Príncipe', common: 'São Tomé et Príncipe' },
      ...
      it: { official: 'Repubblica democratica di São Tomé e Príncipe', common: 'São Tomé e Príncipe' },
      jp: { official: 'サントメ·プリンシペ民主共和国', common: 'サントメ・プリンシペ' },
      kr: { official: '상투메 프린시페 민주 공화국', common: '상투메 프린시페' },
      nld: { official: 'Democratische Republiek Sao Tomé en Principe', common: 'Sao Tomé en Principe' },
      ir: { official: 'جمهوری دموکراتیک سائوتومه و پرنسیپ', common: 'سائوتومه و پرنسیپ' },
      pol: {
        official: 'Demokratyczna Republika Wysp Świętego Tomasza i Książęcej',
        common: 'Wyspy Świętego Tomasza i Książęca',
      },
      pt: { official: 'República Democrática de São Tomé e Príncipe', common: 'São Tomé e Príncipe' },
      ru: { official: 'Демократическая Республика Сан-Томе и Принсипи', common: 'Сан-Томе и Принсипи' },
      slk: {
        official: 'Demokratická republika Svätého Tomáša A princovho ostrova',
        common: 'Svätý Tomáš a Princov ostrov',
      },
      es: { official: 'República Democrática de Santo Tomé y Príncipe', common: 'Santo Tomé y Príncipe' },
      swe: { official: 'Demokratiska republiken São Tomé och Príncipe', common: 'São Tomé och Príncipe' },
      tr: { official: 'São Tomé ve Príncipe Demokratik Cumhuriyeti', common: 'São Tomé ve Príncipe' },
      urd: { official: 'جمہوریہ ساؤ ٹومے و پرنسپے', common: 'ساؤ ٹومے و پرنسپے' },
      cn: { official: '圣多美和普林西比民主共和国', common: '圣多美和普林西比' },
    },
    latlng: [1.0, 7.0],
    landlocked: false,
    area: 964.0,
    demonyms: { eng: { f: 'Sao Tomean', m: 'Sao Tomean' }, fr: { f: 'Santoméenne', m: 'Santoméen' } },
    flag: '\uD83C\uDDF8\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'République islamique du Pakistan', common: 'Pakistan' },
      ...
      jp: { official: 'パキスタン', common: 'パキスタン' },
      kr: { official: '파키스탄 이슬람 공화국', common: '파키스탄' },
      nld: { official: 'Islamitische Republiek Pakistan', common: 'Pakistan' },
      ir: { official: 'جمهوری اسلامی پاکستان', common: 'پاکستان' },
      pol: { official: 'Islamska Republika Pakistanu', common: 'Pakistan' },
      pt: { official: 'República Islâmica do Paquistão', common: 'Paquistão' },
      ru: { official: 'Исламская Республика Пакистан', common: 'Пакистан' },
      slk: { official: 'Pakistanská islamská republika', common: 'Pakistan' },
      es: { official: 'República Islámica de Pakistán', common: 'Pakistán' },
      swe: { official: 'Islamiska republiken Pakistan', common: 'Pakistan' },
      tr: { official: 'Pakistan İslam Cumhuriyeti', common: 'Pakistan' },
      urd: { official: 'اسلامی جمہوریہ پاکستان', common: 'پاکستان' },
      cn: { official: '巴基斯坦伊斯兰共和国', common: '巴基斯坦' },
    },
    latlng: [30.0, 70.0],
    landlocked: false,
    borders: ['AFG', 'CHN', 'IND', 'IRN'],
    area: 881912.0,
    demonyms: { eng: { f: 'Pakistani', m: 'Pakistani' }, fr: { f: 'Pakistanaise', m: 'Pakistanais' } },
    flag: '\uD83C\uDDF5\uD83C\uDDF0',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { tr: { official: 'Türkiye Cumhuriyeti', common: 'Türkiye' } },
    },
    tld: ['.tr'],
    code: 'TR',
    ccn3: '792',
    ...
    translations: {
      ...
      hun: { official: 'Török Köztársaság', common: 'Törökrszág' },
      it: { official: 'Repubblica di Turchia', common: 'Turchia' },
      jp: { official: 'トルコ共和国', common: 'トルコ' },
      kr: { official: '터키 공화국', common: '터키' },
      nld: { official: 'Republiek Turkije', common: 'Turkije' },
      ir: { official: 'جمهوری ترکیه', common: 'ترکیه' },
      pol: { official: 'Republika Turcji', common: 'Turcja' },
      pt: { official: 'República da Turquia', common: 'Turquia' },
      ru: { official: 'Республика Турции', common: 'Турция' },
      ...
      tr: { official: 'Türkiye Cumhuriyeti', common: 'Türkiye' },
      urd: { official: 'جمہوریہ ترکی', common: 'ترکی' },
      cn: { official: '土耳其共和国', common: '土耳其' },
    },
    latlng: [39.0, 35.0],
    landlocked: false,
    borders: ['ARM', 'AZE', 'BGR', 'GEO', 'GRC', 'IRN', 'IRQ', 'SYR'],
    area: 783562.0,
    demonyms: { eng: { f: 'Turkish', m: 'Turkish' }, fr: { f: 'Turque', m: 'Turc' } },
    flag: '\uD83C\uDDF9\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'スリナム共和国', common: 'スリナム' },
      kr: { official: '수리남 공화국', common: '수리남' },
      nld: { official: 'Republiek Suriname', common: 'Suriname' },
      ir: { official: 'جمهوری سورینام', common: 'سورینام' },
      pol: { official: 'Republika Surinamu', common: 'Surinam' },
      pt: { official: 'República do Suriname', common: 'Suriname' },
      ru: { official: 'Республика Суринам', common: 'Суринам' },
      ...
      tr: { official: 'Surinam Cumhuriyeti', common: 'Surinam' },
      urd: { official: 'جمہوریہ سرینام', common: 'سرینام' },
      cn: { official: '苏里南共和国', common: '苏里南' },
    },
    latlng: [4.0, -56.0],
    landlocked: false,
    borders: ['BRA', 'GUF', 'GUY'],
    area: 163820.0,
    demonyms: { eng: { f: 'Surinamer', m: 'Surinamer' }, fr: { f: 'Surinamaise', m: 'Surinamais' } },
    flag: '\uD83C\uDDF8\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Gebiet der Norfolkinsel', common: 'Norfolkinsel' },
      est: { official: 'Norfolki saare ala', common: 'Norfolk' },
      fin: { official: 'Norfolkinsaaren territorio', common: 'Norfolkinsaari' },
      fr: { official: "Territoire de l'île Norfolk", common: 'Île Norfolk' },
      ...
      jp: { official: 'ノーフォーク島の領土', common: 'ノーフォーク島' },
      kr: { official: '노퍽 섬', common: '노퍽 섬' },
      nld: { official: 'Grondgebied van Norfolk Island', common: 'Norfolkeiland' },
      ir: { official: 'قلمرو جزایر نورفک', common: 'جزیره نورفک' },
      pol: { official: 'Terytorium Wyspy Norfolk', common: 'Wyspa Norfolk' },
      pt: { official: 'Território da Ilha Norfolk', common: 'Ilha Norfolk' },
      ru: { official: 'Территория острова Норфолк', common: 'Норфолк' },
      slk: { official: 'Teritórium ostrova Norfolk', common: 'Norfolk' },
      es: { official: 'Territorio de la Isla Norfolk', common: 'Isla de Norfolk' },
      swe: { official: 'Norfolkön', common: 'Norfolkön' },
      tr: { official: 'Norfolk Adası', common: 'Norfolk Adası' },
      urd: { official: 'جزیرہ نورفک خطہ', common: 'جزیرہ نورفک' },
      cn: { official: '诺福克岛', common: '诺福克岛' },
    },
    latlng: [-29.03333333, 167.95],
    landlocked: false,
    area: 36.0,
    demonyms: { eng: { f: 'Norfolk Islander', m: 'Norfolk Islander' }, fr: { f: 'Norfolkaise', m: 'Norfolkais' } },
    flag: '\uD83C\uDDF3\uD83C\uDDEB',
    maps: {
  ...
  },
  {
    ...
    region: 'Asia',
    subregion: 'South-Eastern Asia',
    languages: { cn: 'Chinese', eng: 'English', msa: 'Malay', tam: 'Tamil' },
    translations: {
      ...
      jp: { official: 'シンガポール共和国', common: 'シンガポール' },
      kr: { official: '싱가포르 공화국', common: '싱가포르' },
      nld: { official: 'Republiek Singapore', common: 'Singapore' },
      ir: { official: 'جمهوری سنگاپور', common: 'سنگاپور' },
      pol: { official: 'Republika Singapuru', common: 'Singapur' },
      pt: { official: 'República de Singapura', common: 'Singapura' },
      ru: { official: 'Республика Сингапур', common: 'Сингапур' },
      ...
      tr: { official: 'Singapur Cumhuriyeti', common: 'Singapur' },
      urd: { official: 'جمہوریہ سنگاپور', common: 'سنگاپور' },
    },
    latlng: [1.36666666, 103.8],
    landlocked: false,
    area: 710.0,
    demonyms: { eng: { f: 'Singaporean', m: 'Singaporean' }, fr: { f: 'Singapourienne', m: 'Singapourien' } },
    flag: '\uD83C\uDDF8\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'タンザニア連合共和国', common: 'タンザニア' },
      kr: { official: '탄자니아 연합 공화국', common: '탄자니아' },
      nld: { official: 'Verenigde Republiek Tanzania', common: 'Tanzania' },
      ir: { official: 'جمهوری متحد تانزانیا', common: 'تانزانیا' },
      pol: { official: 'Zjednoczona Republika Tanzanii', common: 'Tanzania' },
      pt: { official: 'República Unida da Tanzânia', common: 'Tanzânia' },
      ru: { official: 'Объединенная Республика Танзания', common: 'Танзания' },
      ...
      tr: { official: 'Tanzanya Birleşik Cumhuriyeti', common: 'Tanzanya' },
      urd: { official: 'متحدہ جمہوریہ تنزانیہ', common: 'تنزانیہ' },
      cn: { official: '坦桑尼亚联合共和国', common: '坦桑尼亚' },
    },
    latlng: [-6.0, 35.0],
    landlocked: false,
    borders: ['BDI', 'COD', 'KEN', 'MWI', 'MOZ', 'RWA', 'UGA', 'ZMB'],
    area: 945087.0,
    demonyms: { eng: { f: 'Tanzanian', m: 'Tanzanian' }, fr: { f: 'Tanzanienne', m: 'Tanzanien' } },
    flag: '\uD83C\uDDF9\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Föderierte Staaten von Mikronesien', common: 'Mikronesien' },
      est: { official: 'Mikroneesia Liiduriigid', common: 'Mikroneesia' },
      fin: { official: 'Mikronesian liittovaltio', common: 'Mikronesia' },
      fr: { official: 'États fédérés de Micronésie', common: 'Micronésie' },
      ...
      jp: { official: 'ミクロネシア連邦', common: 'ミクロネシア連邦' },
      kr: { official: '미크로네시아 연방', common: '미크로네시아' },
      nld: { official: 'Federale Staten van Micronesia', common: 'Micronesië' },
      ir: { official: 'ایالات فدرال میکرونزی', common: 'میکرونزی' },
      pol: { official: 'Sfederowane Stany Mikronezji', common: 'Mikronezja' },
      pt: { official: 'Estados Federados da Micronésia', common: 'Micronésia' },
      ru: { official: 'Федеративные Штаты Микронезии', common: 'Федеративные Штаты Микронезии' },
      ...
      tr: { official: 'Mikronezya Federal Devletleri', common: 'Mikronezya' },
      urd: { official: 'ریاستہائے وفاقیہ مائکرونیشیا', common: 'مائکرونیشیا' },
      cn: { official: '密克罗尼西亚联邦', common: '密克罗尼西亚' },
    },
    latlng: [6.91666666, 158.25],
    landlocked: false,
    area: 702.0,
    demonyms: { eng: { f: 'Micronesian', m: 'Micronesian' }, fr: { f: 'Micronésienne', m: 'Micronésien' } },
    flag: '\uD83C\uDDEB\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'スロバキア共和国', common: 'スロバキア' },
      kr: { official: '슬로바키아 공화국', common: '슬로바키아' },
      nld: { official: 'Slowaakse Republiek', common: 'Slowakije' },
      ir: { official: 'جمهوری اسلواکی', common: 'اِسلُواکی' },
      pol: { official: 'Republika Słowacka', common: 'Słowacja' },
      pt: { official: 'República Eslovaca', common: 'Eslováquia' },
      ru: { official: 'Словацкая Республика', common: 'Словакия' },
      slk: { official: 'Slovenská republika', common: 'Slovensko' },
      es: { official: 'República Eslovaca', common: 'República Eslovaca' },
      swe: { official: 'Republiken Slovakien', common: 'Slovakien' },
      tr: { official: 'Slovak Cumhuriyeti', common: 'Slovakya' },
      urd: { official: 'جمہوریہ سلوواکیہ', common: 'سلوواکیہ' },
      cn: { official: '斯洛伐克共和国', common: '斯洛伐克' },
    },
    latlng: [48.66666666, 19.5],
    landlocked: true,
    borders: ['AUT', 'CZE', 'HUN', 'POL', 'UKR'],
    area: 49037.0,
    demonyms: { eng: { f: 'Slovak', m: 'Slovak' }, fr: { f: 'Slovaque', m: 'Slovaque' } },
    flag: '\uD83C\uDDF8\uD83C\uDDF0',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        cn: { official: '中华人民共和国香港特别行政区', common: '香港' },
      },
    },
    tld: ['.hk', '.香港'],
    code: 'HK',
    ...
    region: 'Asia',
    subregion: 'Eastern Asia',
    languages: { eng: 'English', cn: 'Chinese' },
    translations: {
      ara: { official: 'منطقة هونغ كونغ الادارية التابعة لجمهورية الصين الشعبية', common: 'هونغ كونغ' },
      bre: { official: 'Rannvro velestradurel arbennik Hong Kong eus Republik pobl Sina', common: 'Hong Kong' },
      ces: { official: 'Zvláštní administrativní oblast Čínské lidové republiky Hongkong', common: 'Hongkong' },
      cym: {
        official: "Hong Kong Special Administrative Region of the People's Republic of China",
        common: 'Hong Kong',
      },
      de: { official: 'Sonderverwaltungszone Hongkong der Volksrepublik China', common: 'Hongkong' },
      ...
      jp: { official: '中華人民共和国香港特別行政区', common: '香港' },
      kr: { official: '중화인민공화국 홍콩 특별행정구', common: '홍콩' },
      nld: { official: 'Hong Kong Speciale Administratieve Regio van de Volksrepubliek China', common: 'Hongkong' },
      ir: { official: 'هُنگ کُنگ', common: 'هُنگ کُنگ' },
      pol: { official: 'Specjalny Region Administracyjny Chińskiej Republiki Ludowej Hongkong', common: 'Hongkong' },
      pt: { official: 'Hong Kong Região Administrativa Especial da República Popular da China', common: 'Hong Kong' },
      ru: {
      ...
      es: { official: 'Hong Kong Región Administrativa Especial de la República Popular China', common: 'Hong Kong' },
      swe: { official: 'Hongkong', common: 'Hongkong' },
      tr: { official: 'Çin Halk Cumhuriyeti Hong Kong Özel İdari Bölgesi', common: 'Hong Kong' },
    ...
    borders: ['CHN'],
    area: 1104.0,
    demonyms: { eng: { f: 'Hong Konger', m: 'Hong Konger' }, fr: { f: 'Hongkongaise', m: 'Hongkongais' } },
    flag: '\uD83C\uDDED\uD83C\uDDF0',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'アルバニア共和国', common: 'アルバニア' },
      kr: { official: '알바니아 공화국', common: '알바니아' },
      nld: { official: 'Republiek Albanië', common: 'Albanië' },
      ir: { official: 'جمهوری آلبانی', common: 'آلبانی' },
      pol: { official: 'Republika Albanii', common: 'Albania' },
      pt: { official: 'República da Albânia', common: 'Albânia' },
      ru: { official: 'Республика Албания', common: 'Албания' },
      ...
      tr: { official: 'Arnavutluk Cumhuriyeti', common: 'Arnavutluk' },
      urd: { official: 'جمہوریہ البانیا', common: 'البانیا' },
      cn: { official: '阿尔巴尼亚共和国', common: '阿尔巴尼亚' },
    },
    latlng: [41.0, 20.0],
    landlocked: false,
    borders: ['MNE', 'GRC', 'MKD', 'UNK'],
    area: 28748.0,
    demonyms: { eng: { f: 'Albanian', m: 'Albanian' }, fr: { f: 'Albanaise', m: 'Albanais' } },
    flag: '\uD83C\uDDE6\uD83C\uDDF1',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'インド共和国', common: 'インド' },
      kr: { official: '인도 공화국', common: '인도' },
      nld: { official: 'Republiek India', common: 'India' },
      ir: { official: 'جمهوری هندوستان', common: 'هند' },
      pol: { official: 'Republika Indii', common: 'Indie' },
      pt: { official: 'República da Índia', common: 'Índia' },
      ru: { official: 'Республика Индия', common: 'Индия' },
      ...
      tr: { official: 'Hindistan Cumhuriyeti', common: 'Hindistan' },
      urd: { official: 'جمہوریہ بھارت', common: 'بھارت' },
      cn: { official: '印度共和国', common: '印度' },
    },
    latlng: [20.0, 77.0],
    landlocked: false,
    borders: ['BGD', 'BTN', 'MMR', 'CHN', 'NPL', 'PAK'],
    area: 3287590.0,
    demonyms: { eng: { f: 'Indian', m: 'Indian' }, fr: { f: 'Indienne', m: 'Indien' } },
    flag: '\uD83C\uDDEE\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República de Nicaragua', common: 'Nicaragua' } },
    },
    tld: ['.ni'],
    code: 'NI',
    ccn3: '558',
    ...
    translations: {
      ...
      jp: { official: 'ニカラグア共和国', common: 'ニカラグア' },
      kr: { official: '니카라과 공화국', common: '니카라과' },
      nld: { official: 'Republiek Nicaragua', common: 'Nicaragua' },
      ir: { official: 'جمهوری نیکاراگوئه', common: 'نیکاراگوئه' },
      pol: { official: 'Republika Nikaragui', common: 'Nikaragua' },
      pt: { official: 'República da Nicarágua', common: 'Nicarágua' },
      ru: { official: 'Республика Никарагуа', common: 'Никарагуа' },
      ...
      tr: { official: 'Nikaragua Cumhuriyeti', common: 'Nikaragua' },
      urd: { official: 'جمہوریہ نکاراگوا', common: 'نکاراگوا' },
      cn: { official: '尼加拉瓜共和国', common: '尼加拉瓜' },
    },
    latlng: [13.0, -85.0],
    landlocked: false,
    borders: ['CRI', 'HND'],
    area: 130373.0,
    demonyms: { eng: { f: 'Nicaraguan', m: 'Nicaraguan' }, fr: { f: 'Nicaraguayenne', m: 'Nicaraguayen' } },
    flag: '\uD83C\uDDF3\uD83C\uDDEE',
    maps: {
  ...
  {
    name: { common: 'Japan', official: 'Japan', nativeName: { jp: { official: '日本', common: '日本' } } },
    tld: ['.jp', '.みんな'],
    code: 'JP',
    ccn3: '392',
    cca3: 'JP',
    ...
    translations: {
      ...
      jp: { official: '日本', common: '日本' },
      kr: { official: '일본국', common: '일본' },
      nld: { official: 'Japan', common: 'Japan' },
      ir: { official: 'ژاپن', common: 'ژاپن' },
      pol: { official: 'Japonia', common: 'Japonia' },
      pt: { official: 'Japão', common: 'Japão' },
      ru: { official: 'Япония', common: 'Япония' },
      slk: { official: 'Japonsko', common: 'Japonsko' },
      es: { official: 'Japón', common: 'Japón' },
      swe: { official: 'Japan', common: 'Japan' },
      tr: { official: 'Japonya', common: 'Japonya' },
      urd: { official: 'جاپان', common: 'جاپان' },
      cn: { official: '日本国', common: '日本' },
    },
    latlng: [36.0, 138.0],
    landlocked: false,
    area: 377930.0,
    demonyms: { eng: { f: 'Japanese', m: 'Japanese' }, fr: { f: 'Japonaise', m: 'Japonais' } },
    flag: '\uD83C\uDDEF\uD83C\uDDF5',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'アルゼンチン共和国', common: 'アルゼンチン' },
      kr: { official: '아르헨티나 공화국', common: '아르헨티나' },
      nld: { official: 'Argentijnse Republiek', common: 'Argentinië' },
      ir: { official: 'جمهوری آرژانتین', common: 'آرژانتین' },
      pol: { official: 'Republika Argentyńska', common: 'Argentyna' },
      pt: { official: 'República Argentina', common: 'Argentina' },
      ru: { official: 'Аргентинская Республика', common: 'Аргентина' },
      slk: { official: 'Argentínska republika', common: 'Argentína' },
      es: { official: 'República Argentina', common: 'Argentina' },
      swe: { official: 'Republiken Argentina', common: 'Argentina' },
      tr: { official: 'Arjantin Cumhuriyeti', common: 'Arjantin' },
      urd: { official: 'جمہوریہ ارجنٹائن', common: 'ارجنٹائن' },
      cn: { official: '阿根廷共和国', common: '阿根廷' },
    },
    latlng: [-34.0, -64.0],
    landlocked: false,
    borders: ['BOL', 'BRA', 'CHL', 'PRY', 'URY'],
    area: 2780400.0,
    demonyms: { eng: { f: 'Argentine', m: 'Argentine' }, fr: { f: 'Argentine', m: 'Argentin' } },
    flag: '\uD83C\uDDE6\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { pt: { official: 'República de Cabo Verde', common: 'Cabo Verde' } },
    },
    tld: ['.cv'],
    code: 'CV',
    ccn3: '132',
    ...
    translations: {
      ...
      fr: { official: 'République du Cap-Vert', common: 'Îles du Cap-Vert' },
      ...
      jp: { official: 'カーボベルデ共和国', common: 'カーボベルデ' },
      kr: { official: '카보베르데 공화국', common: '카보베르데' },
      nld: { official: 'Republiek van Cabo Verde', common: 'Kaapverdië' },
      ir: { official: 'جمهوری کبو ورد', common: 'دماغهٔ سبز' },
      pol: { official: 'Republika Zielonego Przylądka', common: 'Republika Zielonego Przylądka' },
      pt: { official: 'República de Cabo Verde', common: 'Cabo Verde' },
      ru: { official: 'Республика Кабо -Верде', common: 'Кабо-Верде' },
      ...
      tr: { official: 'Yeşil Burun Cumhuriyeti', common: 'Yeşil Burun' },
      urd: { official: 'جمہوریہ کیپ ورڈی', common: 'کیپ ورڈی' },
      cn: { official: '佛得角共和国', common: '佛得角' },
    },
    latlng: [16.5388, 23.0418],
    landlocked: false,
    area: 4033.0,
    demonyms: { eng: { f: 'Cape Verdian', m: 'Cape Verdian' }, fr: { f: 'Cap-verdienne', m: 'Cap-verdien' } },
    flag: '\uD83C\uDDE8\uD83C\uDDFB',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Republik Moldau', common: 'Moldawien' },
      ...
      jp: { official: 'モルドバ共和国', common: 'モルドバ共和国' },
      kr: { official: '몰도바 공화국', common: '몰도바' },
      nld: { official: 'Republiek Moldavië', common: 'Moldavië' },
      ir: { official: 'جمهوری مولداوی', common: 'مولداوی' },
      pol: { official: 'Republika Mołdawii', common: 'Mołdawia' },
      pt: { official: 'República da Moldávia', common: 'Moldávia' },
      ru: { official: 'Молдова', common: 'Молдавия' },
      ...
      tr: { official: 'Moldova Cumhuriyeti', common: 'Moldova' },
      urd: { official: 'جمہوریہ مالدووا', common: 'مالدووا' },
      cn: { official: '摩尔多瓦共和国', common: '摩尔多瓦' },
    },
    latlng: [47.0, 29.0],
    landlocked: true,
    borders: ['ROU', 'UKR'],
    area: 33846.0,
    demonyms: { eng: { f: 'Moldovan', m: 'Moldovan' }, fr: { f: 'Moldave', m: 'Moldave' } },
    flag: '\uD83C\uDDF2\uD83C\uDDE9',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República de Panamá', common: 'Panamá' } },
    },
    tld: ['.pa'],
    code: 'PA',
    ccn3: '591',
    ...
    translations: {
      ...
      jp: { official: 'パナマ共和国', common: 'パナマ' },
      kr: { official: '파나마 공화국', common: '파나마' },
      nld: { official: 'Republiek Panama', common: 'Panama' },
      ir: { official: 'جمهوری پاناما', common: 'پاناما' },
      pol: { official: 'Republika Panamy', common: 'Panama' },
      pt: { official: 'República do Panamá', common: 'Panamá' },
      ru: { official: 'Республика Панама', common: 'Панама' },
      ...
      tr: { official: 'Panama Cumhuriyeti', common: 'Panama' },
      urd: { official: 'جمہوریہ پاناما', common: 'پاناما' },
      cn: { official: '巴拿马共和国', common: '巴拿马' },
    },
    latlng: [9.0, -80.0],
    landlocked: false,
    borders: ['COL', 'CRI'],
    area: 75417.0,
    demonyms: { eng: { f: 'Panamanian', m: 'Panamanian' }, fr: { f: 'Panaméenne', m: 'Panaméen' } },
    flag: '\uD83C\uDDF5\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Spitzbergen und Jan Mayen', common: 'Spitzbergen und Jan Mayen' },
      ...
      jp: { official: 'スバールバル諸島OGヤンマイエン', common: 'スヴァールバル諸島およびヤンマイエン島' },
      kr: { official: '스발바르 얀마옌 제도', common: '스발바르 얀마옌 제도' },
      nld: { official: 'Svalbard og Jan Mayen', common: 'Svalbard en Jan Mayen' },
      ir: { official: 'سوالبارد و یان ماین', common: 'سوالبارد و یان ماین' },
      pol: { official: 'Svalbard i Jan Mayen', common: 'Svalbard i Jan Mayen' },
      pt: { official: 'Svalbard og Jan Mayen', common: 'Ilhas Svalbard e Jan Mayen' },
      ru: { official: 'Свальбарда ог Ян-Майен', common: 'Шпицберген и Ян-Майен' },
      slk: { official: 'Svalbard a Jan Mayen', common: 'Svalbard a Jan Mayen' },
      es: { official: 'Svalbard og Jan Mayen', common: 'Islas Svalbard y Jan Mayen' },
      swe: { official: 'Svalbard och Jan Mayen', common: 'Svalbard och Jan Mayen' },
      tr: { official: 'Svalbard ve Jan Mayen', common: 'Svalbard ve Jan Mayen' },
      urd: { official: 'سوالبارڈ اور جان میئن', common: 'سوالبارڈ اور جان میئن' },
      cn: { official: '斯瓦尔巴特', common: '斯瓦尔巴特' },
    },
    latlng: [78.0, 20.0],
    landlocked: false,
    area: -1.0,
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'トンガ王国', common: 'トンガ' },
      kr: { official: '통가 왕국', common: '통가' },
      nld: { official: 'Koninkrijk Tonga', common: 'Tonga' },
      ir: { official: 'پادشاهی تونگا', common: 'تونگا' },
      pol: { official: 'Królestwo Tonga', common: 'Tonga' },
      pt: { official: 'Reino de Tonga', common: 'Tonga' },
      ru: { official: 'Королевство Тонга', common: 'Тонга' },
      ...
      tr: { official: 'Tonga Krallığı', common: 'Tonga' },
      urd: { official: 'مملکتِ ٹونگا', common: 'ٹونگا' },
      cn: { official: '汤加王国', common: '汤加' },
    },
    latlng: [-20.0, -175.0],
    landlocked: false,
    area: 747.0,
    demonyms: { eng: { f: 'Tongan', m: 'Tongan' }, fr: { f: 'Tonguienne', m: 'Tonguien' } },
    flag: '\uD83C\uDDF9\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'St. Vincent und die Grenadinen', common: 'St. Vincent und die Grenadinen' },
      ...
      fr: { official: 'Saint-Vincent-et-les Grenadines', common: 'Saint-Vincent-et-les-Grenadines' },
      ...
      it: { official: 'Saint Vincent e Grenadine', common: 'Saint Vincent e Grenadine' },
      jp: { official: 'セントビンセントおよびグレナディーン諸島', common: 'セントビンセントおよびグレナディーン諸島' },
      kr: { official: '세인트빈센트 그레나딘', common: '세인트빈센트 그레나딘' },
      nld: { official: 'Saint Vincent en de Grenadines', common: 'Saint Vincent en de Grenadines' },
      ir: { official: 'سنت وینسنت و گرنادین‌ها', common: 'سنت وینسنت و گرنادین‌ها' },
      pol: { official: 'Saint Vincent i Grenadyny', common: 'Saint Vincent i Grenadyny' },
      pt: { official: 'São Vicente e Granadinas', common: 'São Vincente e Granadinas' },
      ru: { official: 'Сент-Винсент и Гренадины', common: 'Сент-Винсент и Гренадины' },
      slk: { official: 'Svätý Vincent a Grenadíny', common: 'Svätý Vincent a Grenadíny' },
      es: { official: 'San Vicente y las Granadinas', common: 'San Vicente y Granadinas' },
      swe: { official: 'Saint Vincent och Grenadinerna', common: 'Saint Vincent och Grenadinerna' },
      tr: { official: 'Saint Vincent ve Grenadinler', common: 'Saint Vincent ve Grenadinler' },
      urd: { official: 'سینٹ وینسینٹ و گریناڈائنز', common: 'سینٹ وینسینٹ و گریناڈائنز' },
      cn: { official: '圣文森特和格林纳丁斯', common: '圣文森特和格林纳丁斯' },
    },
    latlng: [13.25, -61.2],
    landlocked: false,
    area: 389.0,
    demonyms: { eng: { f: 'Saint Vincentian', m: 'Saint Vincentian' }, fr: { f: 'Vincentaise', m: 'Vincentais' } },
    flag: '\uD83C\uDDFB\uD83C\uDDE8',
    maps: {
  ...
  },
  {
    ...
    status: 'officially-assigned',
    unMember: true,
    currencies: { CZK: { name: 'Czech kruna', symbol: 'Kč' } },
    ...
    translations: {
      ...
      de: { official: 'Tschechische Republik', common: 'Tschechien' },
      est: { official: 'Tšehhi Vabariik', common: 'Tšehhi' },
      fin: { official: 'Tšekin tasavalta', common: 'Tšekki' },
      fr: { official: 'République tchèque', common: 'Tchéquie' },
      hrv: { official: 'Češka', common: 'Češka' },
      hun: { official: 'Cseh Köztársaság', common: 'Csehország' },
      it: { official: 'Repubblica Ceca', common: 'Cechia' },
      jp: { official: 'チェコ共和国', common: 'チェコ' },
      kr: { official: '체코', common: '체코' },
      nld: { official: 'Tsjechische Republiek', common: 'Tsjechië' },
      ir: { official: 'جمهوری چک', common: 'جمهوری چک' },
      pol: { official: 'Republika Czeska', common: 'Czechy' },
      pt: { official: 'República Checa', common: 'Chéquia' },
      ru: { official: 'Чешская Республика', common: 'Чехия' },
      slk: { official: 'Česká republika', common: 'Česko' },
      es: { official: 'República Checa', common: 'Chequia' },
      swe: { official: 'Republiken Tjeckien', common: 'Tjeckien' },
      tr: { official: 'Çek Cumhuriyeti', common: 'Çekya' },
      urd: { official: 'چيک جمہوريہ', common: 'چيک' },
      cn: { official: '捷克共和国', common: '捷克' },
    },
    latlng: [49.75, 15.5],
    landlocked: true,
    borders: ['AUT', 'DEU', 'POL', 'SVK'],
    area: 78865.0,
    demonyms: { eng: { f: 'Czech', m: 'Czech' }, fr: { f: 'Tchèque', m: 'Tchèque' } },
    flag: '\uD83C\uDDE8\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    ...
    region: 'Africa',
    subregion: 'Eastern Africa',
    languages: { fr: 'French', mlg: 'Malagasy' },
    translations: {
      ...
      jp: { official: 'マダガスカル共和国', common: 'マダガスカル' },
      kr: { official: '마다가스카르 공화국', common: '마다가스카르' },
      nld: { official: 'Republiek Madagaskar', common: 'Madagaskar' },
      ir: { official: 'جمهوری ماداگاسکار', common: 'ماداگاسکار' },
      pol: { official: 'Republika Madagaskaru', common: 'Madagaskar' },
      pt: { official: 'República de Madagáscar', common: 'Madagáscar' },
      ru: { official: 'Республика Мадагаскар', common: 'Мадагаскар' },
      ...
      tr: { official: 'Madagaskar Cumhuriyeti', common: 'Madagaskar' },
      urd: { official: 'جمہوریہ مڈغاسکر', common: 'مڈغاسکر' },
      cn: { official: '马达加斯加共和国', common: '马达加斯加' },
    },
    latlng: [-20.0, 47.0],
    landlocked: false,
    area: 587041.0,
    demonyms: { eng: { f: 'Malagasy', m: 'Malagasy' }, fr: { f: 'Malgache', m: 'Malgache' } },
    flag: '\uD83C\uDDF2\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    ...
    region: 'Europe',
    subregion: 'Western Europe',
    languages: { de: 'German', fr: 'French', nld: 'Dutch' },
    translations: {
      ...
      jp: { official: 'ベルギー王国', common: 'ベルギー' },
      kr: { official: '벨기에 왕국', common: '벨기에' },
      nld: { official: 'Koninkrijk België', common: 'België' },
      ir: { official: 'پادشاهی بلژیک', common: 'بلژیک' },
      pol: { official: 'Królestwo Belgii', common: 'Belgia' },
      pt: { official: 'Reino da Bélgica', common: 'Bélgica' },
      ru: { official: 'Королевство Бельгия', common: 'Бельгия' },
      ...
      tr: { official: 'Belçika Krallığı', common: 'Belçika' },
      urd: { official: 'مملکتِ بلجئیم', common: 'بلجئیم' },
      cn: { official: '比利时王国', common: '比利时' },
    },
    latlng: [50.83333333, 4.0],
    landlocked: false,
    borders: ['FRA', 'DEU', 'LUX', 'NLD'],
    area: 30528.0,
    demonyms: { eng: { f: 'Belgian', m: 'Belgian' }, fr: { f: 'Belge', m: 'Belge' } },
    flag: '\uD83C\uDDE7\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ハンガリー', common: 'ハンガリー' },
      kr: { official: '헝가리', common: '헝가리' },
      nld: { official: 'Hongarije', common: 'Hongarije' },
      ir: { official: 'مجارستان', common: 'مجارستان' },
      pol: { official: 'Węgry', common: 'Węgry' },
      pt: { official: 'Hungria', common: 'Hungria' },
      ru: { official: 'Венгрия', common: 'Венгрия' },
      slk: { official: 'Maďarsko', common: 'Maďarsko' },
      es: { official: 'Hungría', common: 'Hungría' },
      swe: { official: 'Ungern', common: 'Ungern' },
      tr: { official: 'Macaristan', common: 'Macaristan' },
      urd: { official: 'مجارستان', common: 'مجارستان' },
      cn: { official: '匈牙利', common: '匈牙利' },
    },
    latlng: [47.0, 20.0],
    landlocked: true,
    borders: ['AUT', 'HRV', 'ROU', 'SRB', 'SVK', 'SVN', 'UKR'],
    area: 93028.0,
    demonyms: { eng: { f: 'Hungarian', m: 'Hungarian' }, fr: { f: 'Hongroise', m: 'Hongrois' } },
    flag: '\uD83C\uDDED\uD83C\uDDFA',
    maps: {
      googleMaps: 'https://goo.gl/maps/9gfPupm5bffixiFJ6',
      openStreetMaps: 'https://www.openstreetmap.org/relation/21335',
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República Dominicana', common: 'República Dominicana' } },
    },
    tld: ['.do'],
    code: 'DO',
    ccn3: '214',
    ...
    translations: {
      ...
      de: { official: 'Dominikanische Republik', common: 'Dominikanische Republik' },
      ...
      fr: { official: 'République Dominicaine', common: 'République dominicaine' },
      ...
      it: { official: 'Repubblica Dominicana', common: 'Repubblica Dominicana' },
      jp: { official: 'ドミニカ共和国', common: 'ドミニカ共和国' },
      kr: { official: '도미니카 공화국', common: '도미니카 공화국' },
      nld: { official: 'Dominicaanse Republiek', common: 'Dominicaanse Republiek' },
      ir: { official: 'جمهوری دومینیکن', common: 'جمهوری دومینیکن' },
      pol: { official: 'Republika Dominikańska', common: 'Dominikana' },
      pt: { official: 'República Dominicana', common: 'República Dominicana' },
      ru: { official: 'Доминиканская Республика', common: 'Доминиканская Республика' },
      slk: { official: 'Dominikánska republika', common: 'Dominikánska republika' },
      es: { official: 'República Dominicana', common: 'República Dominicana' },
      swe: { official: 'Dominikanska republiken', common: 'Dominikanska republiken' },
      tr: { official: 'Dominik Cumhuriyeti', common: 'Dominik Cumhuriyeti' },
      urd: { official: 'جمہوریہ ڈومینیکن', common: 'ڈومینیکن' },
      cn: { official: '多明尼加共和国', common: '多明尼加' },
    },
    latlng: [19.0, -70.66666666],
    landlocked: false,
    borders: ['HTI'],
    area: 48671.0,
    demonyms: { eng: { f: 'Dominican', m: 'Dominican' }, fr: { f: 'Dominicaine', m: 'Dominicain' } },
    flag: '\uD83C\uDDE9\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Arabische Republik Ägypten', common: 'Ägypten' },
      est: { official: 'Egiptuse Araabia Vabariik', common: 'Egiptus' },
      fin: { official: 'Egyptin arabitasavalta', common: 'Egypti' },
      fr: { official: "République arabe d'Égypte", common: 'Égypte' },
      ...
      jp: { official: 'エジプト·アラブ共和国', common: 'エジプト' },
      kr: { official: '이집트 아랍 공화국', common: '이집트' },
      nld: { official: 'Arabische Republiek Egypte', common: 'Egypte' },
      ir: { official: 'جمهوری عربی مصر', common: 'مصر' },
      pol: { official: 'Arabska Republika Egiptu', common: 'Egipt' },
      pt: { official: 'República Árabe do Egipto', common: 'Egito' },
      ru: { official: 'Арабская Республика Египет', common: 'Египет' },
      ...
      tr: { official: 'Mısır Arap Cumhuriyeti', common: 'Mısır' },
      urd: { official: 'مصری عرب جمہوریہ', common: 'مصر' },
      cn: { official: '阿拉伯埃及共和国', common: '埃及' },
    },
    latlng: [27.0, 30.0],
    landlocked: false,
    borders: ['ISR', 'LBY', 'PSE', 'SDN'],
    area: 1002450.0,
    demonyms: { eng: { f: 'Egyptian', m: 'Egyptian' }, fr: { f: 'Égyptienne', m: 'Égyptien' } },
    flag: '\uD83C\uDDEA\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ナウル共和国', common: 'ナウル' },
      kr: { official: '나우루 공화국', common: '나우루' },
      nld: { official: 'Republiek Nauru', common: 'Nauru' },
      ir: { official: 'جمهوری نائورو', common: 'نائورو' },
      pol: { official: 'Republika Nauru', common: 'Nauru' },
      pt: { official: 'República de Nauru', common: 'Nauru' },
      ru: { official: 'Республика Науру', common: 'Науру' },
      ...
      tr: { official: 'Nauru Cumhuriyeti', common: 'Nauru' },
      urd: { official: 'جمہوریہ ناورو', common: 'ناورو' },
      cn: { official: '瑙鲁共和国', common: '瑙鲁' },
    },
    latlng: [-0.53333333, 166.91666666],
    landlocked: false,
    area: 21.0,
    demonyms: { eng: { f: 'Nauruan', m: 'Nauruan' }, fr: { f: 'Nauruane', m: 'Nauruan' } },
    flag: '\uD83C\uDDF3\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'カメルーン共和国', common: 'カメルーン' },
      kr: { official: '카메룬 공화국', common: '카메룬' },
      nld: { official: 'Republiek Kameroen', common: 'Kameroen' },
      ir: { official: 'جمهوری کامِرون', common: 'کامِرون' },
      pol: { official: 'Republika Kamerunu', common: 'Kamerun' },
      pt: { official: 'República dos Camarões', common: 'Camarões' },
      ru: { official: 'Республика Камерун', common: 'Камерун' },
      ...
      tr: { official: 'Kamerun Cumhuriyeti', common: 'Kamerun' },
      urd: { official: 'جمہوریہ کیمرون', common: 'کیمرون' },
      cn: { official: '喀麦隆共和国', common: '喀麦隆' },
    },
    latlng: [6.0, 12.0],
    landlocked: false,
    borders: ['CAF', 'TCD', 'COG', 'GNQ', 'GAB', 'NGA'],
    area: 475442.0,
    demonyms: { eng: { f: 'Cameroonian', m: 'Cameroonian' }, fr: { f: 'Camerounaise', m: 'Camerounais' } },
    flag: '\uD83C\uDDE8\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    name: {
      common: 'Jamaica',
      official: 'Jamaica',
      nativeName: { eng: { official: 'Jamaica', common: 'Jamaica' }, jam: { official: 'Jamaica', common: 'Jamaica' } },
    },
    tld: ['.jm'],
    code: 'JM',
    ccn3: '388',
    ...
    translations: {
      ...
      jp: { official: 'ジャマイカ', common: 'ジャマイカ' },
      kr: { official: '자메이카', common: '자메이카' },
      nld: { official: 'Jamaica', common: 'Jamaica' },
      ir: { official: 'جامائیکا', common: 'جامائیکا' },
      pol: { official: 'Jamajka', common: 'Jamajka' },
      pt: { official: 'Jamaica', common: 'Jamaica' },
      ru: { official: 'Ямайка', common: 'Ямайка' },
      slk: { official: 'Jamajka', common: 'Jamajka' },
      es: { official: 'Jamaica', common: 'Jamaica' },
      swe: { official: 'Jamaica', common: 'Jamaica' },
      tr: { official: 'Jamaika', common: 'Jamaika' },
      urd: { official: 'جمیکا', common: 'جمیکا' },
      cn: { official: '牙买加', common: '牙买加' },
    },
    latlng: [18.25, -77.5],
    landlocked: false,
    area: 10991.0,
    demonyms: { eng: { f: 'Jamaican', m: 'Jamaican' }, fr: { f: 'Jamaïcaine', m: 'Jamaïcain' } },
    flag: '\uD83C\uDDEF\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Bouvetinsel', common: 'Bouvetinsel' },
      ...
      jp: { official: 'ブーヴェ島', common: 'ブーベ島' },
      kr: { official: '부베 섬', common: '부베 섬' },
      nld: { official: 'Bouvet Island', common: 'Bouveteiland' },
      ir: { official: 'جزیرهٔ بووه', common: 'جزیرهٔ بووه' },
      pol: { official: 'Wyspa Bouveta', common: 'Wyspa Bouveta' },
      pt: { official: 'Ilha Bouvet', common: 'Ilha Bouvet' },
      ru: { official: 'Остров Буве', common: 'Остров Буве' },
      ...
      tr: { official: 'Bouvet Adası', common: 'Bouvet Adası' },
      urd: { official: 'جزیرہ بووہ', common: 'جزیرہ بووہ' },
      cn: { official: '布维岛', common: '布维岛' },
    },
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Königreich Saudi-Arabien', common: 'Saudi-Arabien' },
      ...
      jp: { official: 'サウジアラビア王国', common: 'サウジアラビア' },
      kr: { official: '사우디아라비아 왕국', common: '사우디아라비아' },
      nld: { official: 'Koninkrijk van Saoedi-Arabië', common: 'Saoedi-Arabië' },
      ir: { official: 'پادشاهی عربی سَعودی', common: 'عربستان سعودی' },
      pol: { official: 'Królestwo Arabii Saudyjskiej', common: 'Arabia Saudyjska' },
      pt: { official: 'Reino da Arábia Saudita', common: 'Arábia Saudita' },
      ru: { official: 'Королевство Саудовская Аравия', common: 'Саудовская Аравия' },
      ...
      tr: { official: 'Suudi Arabistan Krallığı', common: 'Suudi Arabistan' },
      urd: { official: 'مملکتِ سعودی عرب', common: 'سعودی عرب' },
      cn: { official: '沙特阿拉伯王国', common: '沙特阿拉伯' },
    },
    latlng: [25.0, 45.0],
    landlocked: false,
    borders: ['IRQ', 'JOR', 'KWT', 'OMN', 'QAT', 'ARE', 'YEM'],
    area: 2149690.0,
    demonyms: { eng: { f: 'Saudi Arabian', m: 'Saudi Arabian' }, fr: { f: 'Saoudienne', m: 'Saoudien' } },
    flag: '\uD83C\uDDF8\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        ru: { official: 'Азербайджанская Республика', common: 'Азербайджан' },
      },
    },
    tld: ['.az'],
    code: 'AZ',
    ...
    region: 'Asia',
    subregion: 'Western Asia',
    languages: { aze: 'Azerbaijani', ru: 'Russian' },
    translations: {
      ...
      fr: { official: "République d'Azerbaïdjan", common: 'Azerbaïdjan' },
      ...
      jp: { official: 'アゼルバイジャン共和国', common: 'アゼルバイジャン' },
      kr: { official: '아제르바이잔 공화국', common: '아제르바이잔' },
      nld: { official: 'Republiek Azerbeidzjan', common: 'Azerbeidzjan' },
      ir: { official: 'جمهوری آذربایجان', common: 'جمهوری آذربایجان' },
      pol: { official: 'Republika Azerbejdżanu', common: 'Azerbejdżan' },
      pt: { official: 'República do Azerbaijão', common: 'Azerbeijão' },
      ru: { official: 'Азербайджанская Республика', common: 'Азербайджан' },
      slk: { official: 'Azerbajǆanská republika', common: 'AzerbajǇan' },
      es: { official: 'República de Azerbaiyán', common: 'Azerbaiyán' },
      swe: { official: 'Republiken Azerbajdzjan', common: 'Azerbajdzjan' },
      tr: { official: 'Azerbaycan Cumhuriyeti', common: 'Azerbaycan' },
      urd: { official: 'جمہوریہ آذربائیجان', common: 'آذربائیجان' },
      cn: { official: '阿塞拜疆共和国', common: '阿塞拜疆' },
    },
    latlng: [40.5, 47.5],
    landlocked: true,
    borders: ['ARM', 'GEO', 'IRN', 'RUS', 'TUR'],
    area: 86600.0,
    demonyms: { eng: { f: 'Azerbaijani', m: 'Azerbaijani' }, fr: { f: 'Azerbaïdjanaise', m: 'Azerbaïdjanais' } },
    flag: '\uD83C\uDDE6\uD83C\uDDFF',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Haschemitisches Königreich Jordanien', common: 'Jordanien' },
      ...
      fr: { official: 'Royaume hachémite de Jordanie', common: 'Jordanie' },
      ...
      jp: { official: 'ヨルダン·ハシミテ王国', common: 'ヨルダン' },
      kr: { official: '요르단 하심 왕국', common: '요르단' },
      nld: { official: 'Hasjemitisch Koninkrijk Jordanië', common: 'Jordanië' },
      ir: { official: 'پادشاهی اُردُن هاشمی', common: 'اردن' },
      pol: { official: 'Jordańskie Królestwo Haszymidzkie', common: 'Jordania' },
      pt: { official: 'Reino Hachemita da Jordânia', common: 'Jordânia' },
      ru: { official: 'Иорданского Хашимитского Королевства', common: 'Иордания' },
      ...
      tr: { official: 'Ürdün Hâşimi Krallığı', common: 'Ürdün' },
      urd: { official: 'ھاشمی مملکتِ اردن', common: 'اردن' },
      cn: { official: '约旦哈希姆王国', common: '约旦' },
    },
    latlng: [31.0, 36.0],
    landlocked: false,
    borders: ['IRQ', 'ISR', 'PSE', 'SAU', 'SYR'],
    area: 89342.0,
    demonyms: { eng: { f: 'Jordanian', m: 'Jordanian' }, fr: { f: 'Jordanienne', m: 'Jordanien' } },
    flag: '\uD83C\uDDEF\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'リトアニア共和国', common: 'リトアニア' },
      kr: { official: '리투아니아 공화국', common: '리투아니아' },
      nld: { official: 'Republiek Litouwen', common: 'Litouwen' },
      ir: { official: 'لیتوانیایی‌ها', common: 'لیتوانیایی‌ها' },
      pol: { official: 'Republika Litewska', common: 'Litwa' },
      pt: { official: 'República da Lituânia', common: 'Lituânia' },
      ru: { official: 'Литовская Республика', common: 'Литва' },
      ...
      tr: { official: 'Litvanya Cumhuriyeti', common: 'Litvanya' },
      urd: { official: 'جمہوریہ لتھووینیا', common: 'لتھووینیا' },
      cn: { official: '立陶宛共和国', common: '立陶宛' },
    },
    latlng: [56.0, 24.0],
    landlocked: false,
    borders: ['BLR', 'LVA', 'POL', 'RUS'],
    area: 65300.0,
    demonyms: { eng: { f: 'Lithuanian', m: 'Lithuanian' }, fr: { f: 'Lituanienne', m: 'Lituanien' } },
    flag: '\uD83C\uDDF1\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        fr: { official: 'République de la Guinée Équatoriale', common: 'Guinée équatoriale' },
        pt: { official: 'República da Guiné Equatorial', common: 'Guiné Equatorial' },
        es: { official: 'República de Guinea Ecuatorial', common: 'Guinea Ecuatorial' },
      },
    },
    tld: ['.gq'],
    code: 'GQ',
    ...
    region: 'Africa',
    subregion: 'Middle Africa',
    languages: { fr: 'French', pt: 'Portuguese', es: 'Spanish' },
    translations: {
      ...
      de: { official: 'Republik Äquatorialguinea', common: 'Äquatorialguinea' },
      ...
      fr: { official: 'République de Guinée équatoriale', common: 'Guinée équatoriale' },
      ...
      it: { official: 'Repubblica della Guinea Equatoriale', common: 'Guinea Equatoriale' },
      jp: { official: '赤道ギニア共和国', common: '赤道ギニア' },
      kr: { official: '적도 기니 공화국', common: '적도 기니' },
      nld: { official: 'Republiek Equatoriaal-Guinea', common: 'Equatoriaal-Guinea' },
      ir: { official: 'جمهوری گینه استوایی', common: 'گینه استوایی' },
      pol: { official: 'Republika Gwinei Równikowej', common: 'Gwinea Równikowa' },
      pt: { official: 'República da Guiné Equatorial', common: 'Guiné Equatorial' },
      ru: { official: 'Республика Экваториальная Гвинея', common: 'Экваториальная Гвинея' },
      ...
      tr: { official: 'Ekvator Ginesi Cumhuriyeti', common: 'Ekvator Ginesi' },
      urd: { official: 'جمہوریہ استوائی گنی', common: 'استوائی گنی' },
      cn: { official: '赤道几内亚共和国', common: '赤道几内亚' },
    },
    latlng: [2.0, 10.0],
    landlocked: false,
    borders: ['CMR', 'GAB'],
    ...
    demonyms: {
      ...
      fr: { f: 'Équato-guinéenne', m: 'Équato-guinéen' },
    },
    flag: '\uD83C\uDDEC\uD83C\uDDF6',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República de Costa Rica', common: 'Costa Rica' } },
    },
    tld: ['.cr'],
    code: 'CR',
    ccn3: '188',
    ...
    translations: {
      ...
      jp: { official: 'コスタリカ共和国', common: 'コスタリカ' },
      kr: { official: '코스타리카 공화국', common: '코스타리카' },
      nld: { official: 'Republiek Costa Rica', common: 'Costa Rica' },
      ir: { official: 'جمهوری کاستاریکا', common: 'کاستاریکا' },
      pol: { official: 'Republika Kostaryki', common: 'Kostaryka' },
      pt: { official: 'República da Costa Rica', common: 'Costa Rica' },
      ru: { official: 'Республика Коста-Рика', common: 'Коста-Рика' },
      ...
      tr: { official: 'Kosta Rika Cumhuriyeti', common: 'Kosta Rika' },
      urd: { official: 'جمہوریہ کوسٹاریکا', common: 'کوسٹاریکا' },
      cn: { official: '哥斯达黎加共和国', common: '哥斯达黎加' },
    },
    latlng: [10.0, -84.0],
    landlocked: false,
    borders: ['NIC', 'PAN'],
    area: 51100.0,
    demonyms: { eng: { f: 'Costa Rican', m: 'Costa Rican' }, fr: { f: 'Costaricaine', m: 'Costaricain' } },
    flag: '\uD83C\uDDE8\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República de Cuba', common: 'Cuba' } },
    },
    tld: ['.cu'],
    code: 'CU',
    ccn3: '192',
    ...
    translations: {
      ...
      jp: { official: 'キューバ共和国', common: 'キューバ' },
      kr: { official: '쿠바 공화국', common: '쿠바' },
      nld: { official: 'Republiek Cuba', common: 'Cuba' },
      ir: { official: 'جمهوری کوبا', common: 'کوبا' },
      pol: { official: 'Republika Kuby', common: 'Kuba' },
      pt: { official: 'República de Cuba', common: 'Cuba' },
      ru: { official: 'Республика Куба', common: 'Куба' },
      ...
      tr: { official: 'Küba Cumhuriyeti', common: 'Küba' },
      urd: { official: 'جمہوریہ کیوبا', common: 'کیوبا' },
      cn: { official: '古巴共和国', common: '古巴' },
    },
    latlng: [21.5, -80.0],
    landlocked: false,
    area: 109884.0,
    demonyms: { eng: { f: 'Cuban', m: 'Cuban' }, fr: { f: 'Cubaine', m: 'Cubain' } },
    flag: '\uD83C\uDDE8\uD83C\uDDFA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ドミニカ国', common: 'ドミニカ国' },
      kr: { official: '도미니카 공화국', common: '도미니카 공화국' },
      nld: { official: 'Gemenebest Dominica', common: 'Dominica' },
      ir: { official: 'قلمرو همسود دومینیکا', common: 'دومینیکا' },
      pol: { official: 'Wspólnota Dominiki', common: 'Dominika' },
      pt: { official: 'Comunidade da Dominica', common: 'Dominica' },
      ru: { official: 'Содружество Доминики', common: 'Доминика' },
      ...
      tr: { official: 'Dominika Topluluğu', common: 'Dominika' },
      urd: { official: 'دولتِ مشترکہ ڈومینیکا', common: 'ڈومینیکا' },
      cn: { official: '多米尼加共和国', common: '多米尼加' },
    },
    latlng: [15.41666666, -61.33333333],
    landlocked: false,
    area: 751.0,
    demonyms: { eng: { f: 'Dominican', m: 'Dominican' }, fr: { f: 'Dominiquaise', m: 'Dominiquais' } },
    flag: '\uD83C\uDDE9\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        fr: { official: 'République centrafricaine', common: 'République centrafricaine' },
    ...
    translations: {
      ...
      de: { official: 'Zentralafrikanische Republik', common: 'Zentralafrikanische Republik' },
      ...
      it: { official: 'Repubblica Centrafricana', common: 'Repubblica Centrafricana' },
      jp: { official: '中央アフリカ共和国', common: '中央アフリカ共和国' },
      kr: { official: '중앙아프리카 공화국', common: '중앙아프리카 공화국' },
      nld: { official: 'Centraal-Afrikaanse Republiek', common: 'Centraal-Afrikaanse Republiek' },
      ir: { official: 'جمهوری آفریقای مرکزی', common: 'جمهوری آفریقای مرکزی' },
      pol: { official: 'Republika Środkowoafrykańska', common: 'Republika Środkowoafrykańska' },
      pt: { official: 'República Centro-Africano', common: 'República Centro-Africana' },
      ru: { official: 'Центрально-Африканская Республика', common: 'Центральноафриканская Республика' },
      slk: { official: 'Stredoafrická republika', common: 'Stredoafrická republika' },
      es: { official: 'República Centroafricana', common: 'República Centroafricana' },
      swe: { official: 'Centralafrikanska republiken', common: 'Centralafrikanska republiken' },
      tr: { official: 'Orta Afrika Cumhuriyeti', common: 'Orta Afrika Cumhuriyeti' },
      urd: { official: 'وسطی افریقی جمہوریہ', common: 'وسطی افریقی جمہوریہ' },
      cn: { official: '中非共和国', common: '中非共和国' },
    },
    latlng: [7.0, 21.0],
    landlocked: true,
    borders: ['CMR', 'TCD', 'COD', 'COG', 'SSD', 'SDN'],
    area: 622984.0,
    demonyms: { eng: { f: 'Central African', m: 'Central African' }, fr: { f: 'Centrafricaine', m: 'Centrafricain' } },
    flag: '\uD83C\uDDE8\uD83C\uDDEB',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ナミビア共和国', common: 'ナミビア' },
      kr: { official: '나미비아 공화국', common: '나미비아' },
      nld: { official: 'Republiek Namibië', common: 'Namibië' },
      ir: { official: 'جمهوری نامیبیا', common: 'نامیبیا' },
      pol: { official: 'Republika Namibii', common: 'Namibia' },
      pt: { official: 'República da Namíbia', common: 'Namíbia' },
      ru: { official: 'Республика Намибия', common: 'Намибия' },
      ...
      tr: { official: 'Namibya Cumhuriyeti', common: 'Namibya' },
      urd: { official: 'جمہوریہ نمیبیا', common: 'نمیبیا' },
      cn: { official: '纳米比亚共和国', common: '纳米比亚' },
    },
    latlng: [-22.0, 17.0],
    landlocked: false,
    borders: ['AGO', 'BWA', 'ZAF', 'ZMB'],
    area: 825615.0,
    demonyms: { eng: { f: 'Namibian', m: 'Namibian' }, fr: { f: 'Namibienne', m: 'Namibien' } },
    flag: '\uD83C\uDDF3\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'トケラウ諸島', common: 'トケラウ' },
      kr: { official: '토켈라우', common: '토켈라우' },
      nld: { official: 'Tokelau', common: 'Tokelau' },
      ir: { official: 'توکلائو', common: 'توکلائو' },
      pol: { official: 'Tokelau', common: 'Tokelau' },
      pt: { official: 'Tokelau', common: 'Tokelau' },
      ru: { official: 'Токелау', common: 'Токелау' },
      ...
      tr: { official: 'Tokelau', common: 'Tokelau' },
      urd: { official: 'ٹوکیلاؤ', common: 'ٹوکیلاؤ' },
      cn: { official: '托克劳', common: '托克劳' },
    },
    latlng: [-9.0, -172.0],
    landlocked: false,
    area: 12.0,
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'モントセラト', common: 'モントセラト' },
      kr: { official: '몬트세랫', common: '몬트세랫' },
      nld: { official: 'Montserrat', common: 'Montserrat' },
      ir: { official: 'مونتسرات', common: 'مونتسرات' },
      pol: { official: 'Montserrat', common: 'Montserrat' },
      pt: { official: 'Montserrat', common: 'Montserrat' },
      ru: { official: 'Монтсеррат', common: 'Монтсеррат' },
      ...
      tr: { official: 'Montserrat', common: 'Montserrat' },
      urd: { official: 'مانٹسریٹ', common: 'مانٹسریٹ' },
      cn: { official: '蒙特塞拉特', common: '蒙特塞拉特' },
    },
    latlng: [16.75, -62.2],
    landlocked: false,
    area: 102.0,
    demonyms: { eng: { f: 'Montserratian', m: 'Montserratian' }, fr: { f: 'Montserratienne', m: 'Montserratien' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'セルビア共和国', common: 'セルビア' },
      kr: { official: '세르비아 공화국', common: '세르비아' },
      nld: { official: 'Republiek Servië', common: 'Servië' },
      ir: { official: 'جمهوری صربستان', common: 'صربستان' },
      pol: { official: 'Republika Serbii', common: 'Serbia' },
      pt: { official: 'República da Sérvia', common: 'Sérvia' },
      ru: { official: 'Республика Сербия', common: 'Сербия' },
      ...
      tr: { official: 'Sırbistan Cumhuriyeti', common: 'Sırbistan' },
      urd: { official: 'جمہوریہ سربیا', common: 'سربیا' },
      cn: { official: '塞尔维亚共和国', common: '塞尔维亚' },
    },
    latlng: [44.0, 21.0],
    landlocked: true,
    borders: ['BIH', 'BGR', 'HRV', 'HUN', 'UNK', 'MKD', 'MNE', 'ROU'],
    area: 88361.0,
    demonyms: { eng: { f: 'Serbian', m: 'Serbian' }, fr: { f: 'Serbe', m: 'Serbe' } },
    flag: '\uD83C\uDDF7\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'クウェート国', common: 'クウェート' },
      kr: { official: '쿠웨이트국', common: '쿠웨이트' },
      nld: { official: 'Staat Koeweit', common: 'Koeweit' },
      ir: { official: 'دولت کویت', common: 'کُویت' },
      pol: { official: 'Państwo Kuwejt', common: 'Kuwejt' },
      pt: { official: 'Estado do Kuwait', common: 'Kuwait' },
      ru: { official: 'Государство Кувейт', common: 'Кувейт' },
      ...
      tr: { official: 'Kuveyt Devleti', common: 'Kuveyt' },
      urd: { official: 'دولتِ کویت', common: 'کویت' },
      cn: { official: '科威特国', common: '科威特' },
    },
    latlng: [29.5, 45.75],
    landlocked: false,
    borders: ['IRQ', 'SAU'],
    area: 17818.0,
    demonyms: { eng: { f: 'Kuwaiti', m: 'Kuwaiti' }, fr: { f: 'Koweïtienne', m: 'Koweïtien' } },
    flag: '\uD83C\uDDF0\uD83C\uDDFC',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'République du Niger', common: 'Niger' } },
    },
    tld: ['.ne'],
    code: 'NE',
    ccn3: '562',
    ...
    translations: {
      ...
      jp: { official: 'ニジェール共和国', common: 'ニジェール' },
      kr: { official: '니제르 공화국', common: '니제르' },
      nld: { official: 'Republiek Niger', common: 'Niger' },
      ir: { official: 'جمهوری نیجر', common: 'نیجر' },
      pol: { official: 'Republika Nigru', common: 'Niger' },
      pt: { official: 'República do Níger', common: 'Níger' },
      ru: { official: 'Республика Нигер', common: 'Нигер' },
      ...
      tr: { official: 'Nijer Cumhuriyeti', common: 'Nijer' },
      urd: { official: 'جمہوریہ نائجر', common: 'نائجر' },
      cn: { official: '尼日尔共和国', common: '尼日尔' },
    },
    latlng: [16.0, 8.0],
    landlocked: true,
    borders: ['DZA', 'BEN', 'BFA', 'TCD', 'LBY', 'MLI', 'NGA'],
    area: 1267000.0,
    demonyms: { eng: { f: 'Nigerien', m: 'Nigerien' }, fr: { f: 'Nigérienne', m: 'Nigérien' } },
    flag: '\uD83C\uDDF3\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { it: { official: 'Repubblica di San Marino', common: 'San Marino' } },
    },
    tld: ['.sm'],
    code: 'SM',
    ccn3: '674',
    ...
    translations: {
      ...
      it: { official: 'Serenissima Repubblica di San Marino', common: 'San Marino' },
      jp: { official: 'サンマリノのほとんどセリーヌ共和国', common: 'サンマリノ' },
      kr: { official: '산마리노 공화국', common: '산마리노' },
      nld: { official: 'Meest Serene Republiek San Marino', common: 'San Marino' },
      ir: { official: 'جمهوری سان مارینو', common: 'سان مارینو' },
      pol: { official: 'Republika San Marino', common: 'San Marino' },
      pt: { official: 'Sereníssima República de San Marino', common: 'San Marino' },
      ru: { official: 'Большинство Serene Республика Сан-Марино', common: 'Сан-Марино' },
      slk: { official: 'Sanmarínska republika', common: 'San Maríno' },
      es: { official: 'Serenísima República de San Marino', common: 'San Marino' },
      swe: { official: 'Republiken San Marino', common: 'San Marino' },
      tr: { official: 'San Marino Cumhuriyeti', common: 'San Marino' },
      urd: { official: 'جمہوریہ سان مارینو', common: 'سان مارینو' },
      cn: { official: '圣马力诺共和国', common: '圣马力诺' },
    },
    latlng: [43.76666666, 12.41666666],
    landlocked: true,
    borders: ['ITA'],
    area: 61.0,
    demonyms: { eng: { f: 'Sammarinese', m: 'Sammarinese' }, fr: { f: 'Saint-Marinaise', m: 'Saint-Marinais' } },
    flag: '\uD83C\uDDF8\uD83C\uDDF2',
    maps: {
  ...
  {
    name: { common: 'Ukraine', official: 'Ukraine', nativeName: { ukr: { official: 'Україна', common: 'Україна' } } },
    tld: ['.ua', '.укр'],
    code: 'UA',
    ccn3: '804',
    cca3: 'UKR',
    ...
    translations: {
      ...
      jp: { official: 'ウクライナ', common: 'ウクライナ' },
      kr: { official: '우크라이나', common: '우크라이나' },
      nld: { official: 'Oekraïne', common: 'Oekraïne' },
      ir: { official: 'اوکراین', common: 'اوکراین' },
      pol: { official: 'Ukraina', common: 'Ukraina' },
      pt: { official: 'Ucrânia', common: 'Ucrânia' },
      ru: { official: 'Украина', common: 'Украина' },
      slk: { official: 'Ukrajina', common: 'Ukrajina' },
      es: { official: 'Ucrania', common: 'Ucrania' },
      swe: { official: 'Ukraina', common: 'Ukraina' },
      tr: { official: 'Ukrayna', common: 'Ukrayna' },
      urd: { official: 'یوکرین', common: 'یوکرین' },
      cn: { official: '乌克兰', common: '乌克兰' },
    },
    latlng: [49.0, 32.0],
    landlocked: false,
    borders: ['BLR', 'HUN', 'MDA', 'POL', 'ROU', 'RUS', 'SVK'],
    area: 603500.0,
    demonyms: { eng: { f: 'Ukrainian', m: 'Ukrainian' }, fr: { f: 'Ukrainienne', m: 'Ukrainien' } },
    flag: '\uD83C\uDDFA\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ブータン王国', common: 'ブータン' },
      kr: { official: '부탄 왕국', common: '부탄' },
      nld: { official: 'Koninkrijk Bhutan', common: 'Bhutan' },
      ir: { official: 'پادشاهی بوتان', common: 'بوتان' },
      pol: { official: 'Bhutan', common: 'Bhutan' },
      pt: { official: 'Reino do Butão', common: 'Butão' },
      ru: { official: 'Королевство Бутан', common: 'Бутан' },
      ...
      tr: { official: 'Butan Krallığı', common: 'Butan' },
      urd: { official: 'سلطنت بھوٹان', common: 'بھوٹان' },
      cn: { official: '不丹王国', common: '不丹' },
    },
    latlng: [27.5, 90.5],
    landlocked: true,
    borders: ['CHN', 'IND'],
    area: 38394.0,
    demonyms: { eng: { f: 'Bhutanese', m: 'Bhutanese' }, fr: { f: 'Bhoutanaise', m: 'Bhoutanais' } },
    flag: '\uD83C\uDDE7\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'イエメン共和国', common: 'イエメン' },
      kr: { official: '예멘 공화국', common: '예멘' },
      nld: { official: 'Republiek Jemen', common: 'Jemen' },
      ir: { official: 'جمهوری یمن', common: 'یمن' },
      pol: { official: 'Republika Jemeńska', common: 'Jemen' },
      pt: { official: 'República do Iêmen', common: 'Iémen' },
      ru: { official: 'Йеменская Республика', common: 'Йемен' },
      ...
      tr: { official: 'Yemen Cumhuriyeti', common: 'Yemen' },
      urd: { official: 'جمہوریہ یمن', common: 'یمن' },
      cn: { official: '也门共和国', common: '也门' },
    },
    latlng: [15.0, 48.0],
    landlocked: false,
    borders: ['OMN', 'SAU'],
    area: 527968.0,
    demonyms: { eng: { f: 'Yemeni', m: 'Yemeni' }, fr: { f: 'Yéménite', m: 'Yéménite' } },
    flag: '\uD83C\uDDFE\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República Bolivariana de Venezuela', common: 'Venezuela' } },
    },
    tld: ['.ve'],
    code: 'VE',
    ccn3: '862',
    ...
    translations: {
      ...
      fr: { official: 'République bolivarienne du Venezuela', common: 'Venezuela' },
      ...
      it: { official: 'Repubblica Bolivariana del Venezuela', common: 'Venezuela' },
      jp: { official: 'ベネズエラ·ボリバル共和国', common: 'ベネズエラ・ボリバル共和国' },
      kr: { official: '베네수엘라 볼리바르 공화국', common: '베네수엘라' },
      nld: { official: 'Bolivariaanse Republiek Venezuela', common: 'Venezuela' },
      ir: { official: 'جمهوری بولیواری ونزوئلا', common: 'ونزوئلا' },
      pol: { official: 'Boliwariańska Republika Wenezueli', common: 'Wenezuela' },
      pt: { official: 'República Bolivariana da Venezuela', common: 'Venezuela' },
      ru: { official: 'Боливарианская Республика Венесуэла', common: 'Венесуэла' },
      slk: { official: 'Venezuelská bolívarovská republika', common: 'Venezuela' },
      es: { official: 'República Bolivariana de Venezuela', common: 'Venezuela' },
      swe: { official: 'Bolivarianska republiken Venezuela', common: 'Venezuela' },
      tr: { official: 'Bolivarcı Venezuela Cumhuriyeti', common: 'Venezuela' },
      urd: { official: 'جمہوریہ وینیزویلا', common: 'وینیزویلا' },
      cn: { official: '委内瑞拉玻利瓦尔共和国', common: '委内瑞拉' },
    },
    latlng: [8.0, -66.0],
    landlocked: false,
    borders: ['BRA', 'COL', 'GUY'],
    area: 916445.0,
    demonyms: { eng: { f: 'Venezuelan', m: 'Venezuelan' }, fr: { f: 'Vénézuélienne', m: 'Vénézuélien' } },
    flag: '\uD83C\uDDFB\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'モロッコ王国', common: 'モロッコ' },
      kr: { official: '모로코 왕국', common: '모로코' },
      nld: { official: 'Koninkrijk Marokko', common: 'Marokko' },
      ir: { official: 'پادشاهی مراکش', common: 'مراکش' },
      pol: { official: 'Królestwo Marokańskie', common: 'Maroko' },
      pt: { official: 'Reino de Marrocos', common: 'Marrocos' },
      ru: { official: 'Королевство Марокко', common: 'Марокко' },
      ...
      tr: { official: 'Fas Krallığı', common: 'Fas' },
      urd: { official: 'مملکتِ مراکش', common: 'مراکش' },
      cn: { official: '摩洛哥王国', common: '摩洛哥' },
    },
    latlng: [32.0, -5.0],
    landlocked: false,
    borders: ['DZA', 'ESH', 'ESP'],
    area: 446550.0,
    demonyms: { eng: { f: 'Moroccan', m: 'Moroccan' }, fr: { f: 'Marocaine', m: 'Marocain' } },
    flag: '\uD83C\uDDF2\uD83C\uDDE6',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Sultanat Brunei Darussalam', common: 'Brunei' },
      ...
      it: { official: 'Nazione di Brunei, Dimora della Pace', common: 'Brunei' },
      jp: { official: 'ブルネイ、平和の精舎の国家', common: 'ブルネイ・ダルサラーム' },
      kr: { official: '브루나이 다루살람국', common: '브루나이' },
      nld: { official: 'Natie van Brunei, de verblijfplaats van de Vrede', common: 'Brunei' },
      ir: { official: 'برونئی سرای صلح', common: 'برونئی' },
      pol: { official: 'Państwo Brunei Darussalam', common: 'Brunei' },
      pt: { official: 'Nação do Brunei, Morada da Paz', common: 'Brunei' },
      ru: { official: 'Нация Бруней, обитель мира', common: 'Бруней' },
      slk: { official: 'Brunejský sultanât', common: 'Brunej' },
      es: { official: 'Nación de Brunei, Morada de la Paz', common: 'Brunei' },
      swe: { official: 'Brunei Darussalam', common: 'Brunei' },
      tr: { official: 'Brunei Barış Ülkesi Devleti', common: 'Brunei' },
      urd: { official: 'ریاستِ برونائی دارالسلام', common: 'برونائی' },
      cn: { official: '文莱和平之国', common: '文莱' },
    },
    latlng: [4.5, 114.66666666],
    landlocked: false,
    borders: ['MYS'],
    area: 5765.0,
    demonyms: { eng: { f: 'Bruneian', m: 'Bruneian' }, fr: { f: 'Brunéienne', m: 'Brunéien' } },
    flag: '\uD83C\uDDE7\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'République du Sénégal', common: 'Sénégal' } },
    },
    tld: ['.sn'],
    code: 'SN',
    ccn3: '686',
    ...
    translations: {
      ...
      fr: { official: 'République du Sénégal', common: 'Sénégal' },
      ...
      jp: { official: 'セネガル共和国', common: 'セネガル' },
      kr: { official: '세네갈 공화국', common: '세네갈' },
      nld: { official: 'Republiek Senegal', common: 'Senegal' },
      ir: { official: 'جمهوری سنگال', common: 'سنگال' },
      pol: { official: 'Senegal', common: 'Senegal' },
      pt: { official: 'República do Senegal', common: 'Senegal' },
      ru: { official: 'Республика Сенегал', common: 'Сенегал' },
      ...
      tr: { official: 'Senegal Cumhuriyeti', common: 'Senegal' },
      urd: { official: 'جمہوریہ سینیگال', common: 'سینیگال' },
      cn: { official: '塞内加尔共和国', common: '塞内加尔' },
    },
    latlng: [14.0, -14.0],
    landlocked: false,
    borders: ['GMB', 'GIN', 'GNB', 'MLI', 'MRT'],
    area: 196722.0,
    demonyms: { eng: { f: 'Senegalese', m: 'Senegalese' }, fr: { f: 'Sénégalaise', m: 'Sénégalais' } },
    flag: '\uD83C\uDDF8\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'République du Soudan du Sud', common: 'Soudan du Sud' },
      ...
      jp: { official: '南スーダン共和国', common: '南スーダン' },
      kr: { official: '남수단 공화국', common: '남수단' },
      nld: { official: 'Republiek Zuid-Soedan', common: 'Zuid-Soedan' },
      ir: { official: 'جمهوری سودان جنوبی', common: 'سودان جنوبی' },
      pol: { official: 'Republika Sudanu', common: 'Sudan' },
      pt: { official: 'República do Sudão do Sul', common: 'Sudão do Sul' },
      ru: { official: 'Республика Южный Судан', common: 'Южный Судан' },
      slk: { official: 'Juhosudánska republika', common: 'Južný Sudán' },
      es: { official: 'República de Sudán del Sur', common: 'Sudán del Sur' },
      swe: { official: 'Republiken Sydsudan', common: 'Sydsudan' },
      tr: { official: 'Güney Sudan Cumhuriyeti', common: 'Güney Sudan' },
      urd: { official: 'جمہوریہ جنوبی سوڈان', common: 'جنوبی سوڈان' },
      cn: { official: '南苏丹共和国', common: '南苏丹' },
    },
    latlng: [7.0, 30.0],
    landlocked: true,
    borders: ['CAF', 'COD', 'ETH', 'KEN', 'SDN', 'UGA'],
    area: 619745.0,
    demonyms: { eng: { f: 'South Sudanese', m: 'South Sudanese' }, fr: { f: 'Sud-Soudanaise', m: 'Sud-Soudanais' } },
    flag: '\uD83C\uDDF8\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'オランダ', common: 'オランダ' },
      kr: { official: '네덜란드 왕국', common: '네덜란드' },
      nld: { official: 'Nederland', common: 'Nederland' },
      ir: { official: 'هلند', common: 'هلند' },
      pol: { official: 'Królestwo Niderlandów', common: 'Holandia' },
      pt: { official: 'Holanda', common: 'Holanda' },
      ru: { official: 'Нидерланды', common: 'Нидерланды' },
      ...
      tr: { official: 'Hollanda', common: 'Hollanda' },
      urd: { official: 'مملکتِ نیدرلینڈز', common: 'نیدرلینڈز' },
      cn: { official: '荷兰', common: '荷兰' },
    },
    latlng: [52.5, 5.75],
    landlocked: false,
    borders: ['BEL', 'DEU'],
  ...
  },
  {
    name: {
      ...
      nativeName: { de: { official: 'Fürstentum Liechtenstein', common: 'Liechtenstein' } },
    },
    tld: ['.li'],
    code: 'LI',
    ccn3: '438',
    ...
    translations: {
      ...
      jp: { official: 'リヒテンシュタイン公国', common: 'リヒテンシュタイン' },
      kr: { official: '리히텐슈타인 공국', common: '리히텐슈타인' },
      nld: { official: 'Vorstendom Liechtenstein', common: 'Liechtenstein' },
      ir: { official: 'شاهزاده‌نشین لیختن‌اشتاین', common: 'لیختن‌اشتاین' },
      pol: { official: 'Księstwo Liechtensteinu', common: 'Liechtenstein' },
      pt: { official: 'Principado de Liechtenstein', common: 'Liechtenstein' },
      ru: { official: 'Княжество Лихтенштейн', common: 'Лихтенштейн' },
      ...
      tr: { official: 'Lihtenştayn Prensliği', common: 'Lihtenştayn' },
      urd: { official: 'امارات لیختینستائن', common: 'لیختینستائن' },
      cn: { official: '列支敦士登公国', common: '列支敦士登' },
    },
    ...
    demonyms: {
      ...
      fr: { f: 'Liechtensteinoise', m: 'Liechtensteinois' },
    },
    flag: '\uD83C\uDDF1\uD83C\uDDEE',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'アンドラ公国', common: 'アンドラ' },
      kr: { official: '안도라 공국', common: '안도라' },
      nld: { official: 'Prinsdom Andorra', common: 'Andorra' },
      ir: { official: 'شاهزاده‌نشین آندورا', common: 'آندورا' },
      pol: { official: 'Księstwo Andory', common: 'Andora' },
      pt: { official: 'Principado de Andorra', common: 'Andorra' },
      ru: { official: 'Княжество Андорра', common: 'Андорра' },
      ...
      tr: { official: 'Andorra Prensliği', common: 'Andorra' },
      urd: { official: 'اماراتِ انڈورا', common: 'انڈورا' },
      cn: { official: '安道尔公国', common: '安道尔' },
    },
    latlng: [42.5, 1.5],
    landlocked: true,
    borders: ['FRA', 'ESP'],
    area: 468.0,
    demonyms: { eng: { f: 'Andorran', m: 'Andorran' }, fr: { f: 'Andorrane', m: 'Andorran' } },
    flag: '\uD83C\uDDE6\uD83C\uDDE9',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'レバノン共和国', common: 'レバノン' },
      kr: { official: '레바논 공화국', common: '레바논' },
      nld: { official: 'Libanese Republiek', common: 'Libanon' },
      ir: { official: 'جمهوری لبنان', common: 'لبنان' },
      pol: { official: 'Republika Libańska', common: 'Liban' },
      pt: { official: 'República Libanesa', common: 'Líbano' },
      ru: { official: 'Ливанская Республика', common: 'Ливан' },
      ...
      tr: { official: 'Lübnan Cumhuriyeti', common: 'Lübnan' },
      urd: { official: 'جمہوریہ لبنان', common: 'لبنان' },
      cn: { official: '黎巴嫩共和国', common: '黎巴嫩' },
    },
    latlng: [33.83333333, 35.83333333],
    landlocked: false,
    borders: ['ISR', 'SYR'],
    area: 10452.0,
    demonyms: { eng: { f: 'Lebanese', m: 'Lebanese' }, fr: { f: 'Libanaise', m: 'Libanais' } },
    flag: '\uD83C\uDDF1\uD83C\uDDE7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ラトビア共和国', common: 'ラトビア' },
      kr: { official: '라트비아 공화국', common: '라트비아' },
      nld: { official: 'Republiek Letland', common: 'Letland' },
      ir: { official: 'جمهوری لتونی', common: 'لتونی' },
      pol: { official: 'Republika Łotewska', common: 'Łotwa' },
      pt: { official: 'República da Letónia', common: 'Letónia' },
      ru: { official: 'Латвийская Республика', common: 'Латвия' },
      ...
      tr: { official: 'Letonya Cumhuriyeti', common: 'Letonya' },
      urd: { official: 'جمہوریہ لٹویا', common: 'لٹویا' },
      cn: { official: '拉脱维亚共和国', common: '拉脱维亚' },
    },
    latlng: [57.0, 25.0],
    landlocked: false,
    borders: ['BLR', 'EST', 'LTU', 'RUS'],
    area: 64559.0,
    demonyms: { eng: { f: 'Latvian', m: 'Latvian' }, fr: { f: 'Lettone', m: 'Letton' } },
    flag: '\uD83C\uDDF1\uD83C\uDDFB',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Republik Nordmazedonien', common: 'Nordmazedonien' },
      ...
      fr: { official: 'République de Macédoine du Nord', common: 'Macédoine du Nord' },
      ...
      it: { official: 'Repubblica di Macedonia del Nord', common: 'Macedonia del Nord' },
      jp: { official: '北マケドニア共和国', common: '北マケドニア ' },
      kr: { official: '북마케도니아 공화국', common: '북마케도니아' },
      nld: { official: 'Republiek Noord-Macedonië', common: 'Noord-Macedonië' },
      ir: { official: 'جمهوری مقدونیه شمالی', common: 'مقدونیه شمالی' },
      pol: { official: 'Republika Macedonii Północnej', common: 'Macedonia Północna' },
      pt: { official: 'República da Macedônia do Norte', common: 'Macedónia do Norte' },
      ru: { official: 'Республика Северная Македония', common: 'Северная Македония' },
      slk: { official: 'Severomacedónska republika', common: 'Severné Macedónsko' },
      es: { official: 'República de Macedonia del Norte', common: 'Macedonia del Norte' },
      swe: { official: 'Republiken Nordmakedonien', common: 'Nordmakedonien' },
      tr: { official: 'Kuzey Makedonya Cumhuriyeti', common: 'Kuzey Makedonya' },
      urd: { official: 'جمہوریہ مقدونیہ', common: 'شمالی مقدونیہ' },
      cn: { official: '北馬其頓共和國', common: '北馬其頓' },
    },
    latlng: [41.83333333, 22.0],
    landlocked: true,
    borders: ['ALB', 'BGR', 'GRC', 'UNK', 'SRB'],
    area: 25713.0,
    demonyms: { eng: { f: 'Macedonian', m: 'Macedonian' }, fr: { f: 'Macédonienne', m: 'Macédonien' } },
    flag: '\uD83C\uDDF2\uD83C\uDDF0',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { pt: { official: 'República português', common: 'Portugal' } },
    },
    tld: ['.pt'],
    code: 'PT',
    ccn3: '620',
    ...
    translations: {
      ...
      jp: { official: 'ポルトガル共和国', common: 'ポルトガル' },
      kr: { official: '포르투갈 공화국', common: '포르투갈' },
      nld: { official: 'Portugese Republiek', common: 'Portugal' },
      ir: { official: 'جمهوری پرتغال', common: 'پرتغال' },
      pol: { official: 'Republika Portugalska', common: 'Portugalia' },
      pt: { official: 'República português', common: 'Portugal' },
      ru: { official: 'Португальская Республика', common: 'Португалия' },
      ...
      tr: { official: 'Portekiz Cumhuriyeti', common: 'Portekiz' },
      urd: { official: 'جمہوریہ پرتگال', common: 'پرتگال' },
      cn: { official: '葡萄牙共和国', common: '葡萄牙' },
    },
    latlng: [39.5, -8.0],
    landlocked: false,
    borders: ['ESP'],
    area: 92090.0,
    demonyms: { eng: { f: 'Portuguese', m: 'Portuguese' }, fr: { f: 'Portugaise', m: 'Portugais' } },
    flag: '\uD83C\uDDF5\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'Estados Unidos Mexicanos', common: 'México' } },
    },
    tld: ['.mx'],
    code: 'MX',
    ccn3: '484',
    ...
    translations: {
      ...
      jp: { official: 'メキシコ合衆国', common: 'メキシコ' },
      kr: { official: '멕시코 합중국', common: '멕시코' },
      nld: { official: 'Verenigde Mexicaanse Staten', common: 'Mexico' },
      ir: { official: 'ایالات متحد مکزیک', common: 'مکزیک' },
      pol: { official: 'Meksykańskie Stany Zjednoczone', common: 'Meksyk' },
      pt: { official: 'Estados Unidos Mexicanos', common: 'México' },
      ru: { official: 'Мексиканские Соединённые Штаты', common: 'Мексика' },
      ...
      tr: { official: 'Birleşik Meksika Devletleri', common: 'Meksika' },
      urd: { official: 'ریاستہائے متحدہ میکسیکو', common: 'میکسیکو' },
      cn: { official: '墨西哥合众国', common: '墨西哥' },
    },
    latlng: [23.0, -102.0],
    landlocked: false,
    borders: ['BLZ', 'GTM', 'USA'],
    area: 1964375.0,
    demonyms: { eng: { f: 'Mexican', m: 'Mexican' }, fr: { f: 'Mexicaine', m: 'Mexicain' } },
    flag: '\uD83C\uDDF2\uD83C\uDDFD',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'バハマ', common: 'バハマ' },
      kr: { official: '바하마 연방', common: '바하마' },
      nld: { official: "Gemenebest van de Bahama's", common: 'Bahama’s' },
      ir: { official: 'قلمرو همسود باهاما', common: 'باهاما' },
      pol: { official: 'Bahamy', common: 'Bahamy' },
      pt: { official: 'Comunidade das Bahamas', common: 'Bahamas' },
      ru: { official: 'Содружество Багамских Островов', common: 'Багамские Острова' },
      ...
      tr: { official: 'Bahama Milletler Topluluğu', common: 'Bahamalar' },
      urd: { official: 'دولتِ مشترکہ بہاماس', common: 'بہاماس' },
      cn: { official: '巴哈马联邦', common: '巴哈马' },
    },
    latlng: [25.0343, 77.3963],
    landlocked: false,
    area: 13943.0,
    demonyms: { eng: { f: 'Bahamian', m: 'Bahamian' }, fr: { f: 'Bahamienne', m: 'Bahamien' } },
    flag: '\uD83C\uDDE7\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'Département de Mayotte', common: 'Mayotte' } },
    },
    tld: ['.yt'],
    code: 'YT',
    ccn3: '175',
    ...
    translations: {
      ...
      de: { official: 'Übersee-Département Mayotte', common: 'Mayotte' },
      ...
      jp: { official: 'マヨット科', common: 'マヨット' },
      kr: { official: '마요트', common: '마요트' },
      nld: { official: 'Afdeling Mayotte', common: 'Mayotte' },
      ir: { official: 'مجموعه شهرستانی مایوت', common: 'مایوت' },
      pol: { official: 'Majotta', common: 'Majotta' },
      pt: { official: 'Departamento de Mayotte', common: 'Mayotte' },
      ru: { official: 'Департамент Майотта', common: 'Майотта' },
      ...
      tr: { official: 'Mayotte', common: 'Mayotte' },
      urd: { official: 'مایوٹ', common: 'مایوٹ' },
      cn: { official: '马约特', common: '马约特' },
    },
    latlng: [-12.83333333, 45.16666666],
    landlocked: false,
    area: 374.0,
    demonyms: { eng: { f: 'Mahoran', m: 'Mahoran' }, fr: { f: 'Mahoraise', m: 'Mahorais' } },
    flag: '\uD83C\uDDFE\uD83C\uDDF9',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { cn: { official: '中华人民共和国', common: '中国' } },
    },
    tld: ['.cn', '.中国', '.中國', '.公司', '.网络'],
    code: 'CN',
    ccn3: '156',
    ...
    translations: {
      ...
      jp: { official: '中華人民共和国', common: '中国' },
      kr: { official: '중화인민공화국', common: '중국' },
      nld: { official: 'Volksrepubliek China', common: 'China' },
      ir: { official: 'جمهوری خلق چین', common: 'چین' },
      pol: { official: 'Chińska Republika Ludowa', common: 'Chiny' },
      pt: { official: 'República Popular da China', common: 'China' },
      ru: { official: 'Народная Республика Китай', common: 'Китай' },
      ...
      tr: { official: 'Çin Halk Cumhuriyeti', common: 'Çin' },
    ...
    area: 9706961.0,
    demonyms: { eng: { f: 'Chinese', m: 'Chinese' }, fr: { f: 'Chinoise', m: 'Chinois' } },
    flag: '\uD83C\uDDE8\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ...
        ru: { official: 'Кыргызская Республика', common: 'Киргизия' },
      },
    },
    tld: ['.kg'],
    code: 'KG',
    ...
    region: 'Asia',
    subregion: 'Central Asia',
    languages: { kir: 'Kyrgyz', ru: 'Russian' },
    translations: {
      ...
      jp: { official: 'キルギス共和国', common: 'キルギス' },
      kr: { official: '키르기스 공화국', common: '키르기스스탄' },
      nld: { official: 'Kirgizische Republiek', common: 'Kirgizië' },
      ir: { official: 'جمهوری قِرقیزستان', common: 'قرقیزستان' },
      pol: { official: 'Republika Kirgiska', common: 'Kirgistan' },
      pt: { official: 'República do Quirguistão', common: 'Quirguistão' },
      ru: { official: 'Кыргызская Республика', common: 'Киргизия' },
      ...
      tr: { official: 'Kırgızistan Cumhuriyeti', common: 'Kırgızistan' },
      urd: { official: 'جمہوریہ کرغیزستان', common: 'کرغیزستان' },
      cn: { official: '吉尔吉斯斯坦共和国', common: '吉尔吉斯斯坦' },
    },
    latlng: [41.0, 75.0],
    landlocked: true,
    borders: ['CHN', 'KAZ', 'TJK', 'UZB'],
    area: 199951.0,
    demonyms: { eng: { f: 'Kirghiz', m: 'Kirghiz' }, fr: { f: 'Kirghize', m: 'Kirghize' } },
    flag: '\uD83C\uDDF0\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { fr: { official: 'Territoire des îles Wallis et Futuna', common: 'Wallis et Futuna' } },
    },
    tld: ['.wf'],
    code: 'WF',
    ccn3: '876',
    ...
    translations: {
      ...
      de: { official: 'Gebiet der Wallis und Futuna', common: 'Wallis und Futuna' },
      ...
      fr: { official: 'Territoire des îles Wallis et Futuna', common: 'Wallis-et-Futuna' },
      hrv: { official: 'Teritoriju Wallis i Futuna', common: 'Wallis i Fortuna' },
      hun: { official: 'Wallis és Futuna', common: 'Wallis és Futuna' },
      it: { official: 'Territorio delle Isole Wallis e Futuna', common: 'Wallis e Futuna' },
      jp: { official: 'ウォリス·フツナ諸島の領土', common: 'ウォリス・フツナ' },
      kr: { official: '왈리스 퓌튀나', common: '왈리스 퓌튀나' },
      nld: { official: 'Grondgebied van de Wallis en Futuna', common: 'Wallis en Futuna' },
      ir: { official: 'جزایر والیس و فوتونا', common: 'والیس و فوتونا' },
      pol: { official: 'Terytorium Wysp Wallis i Futuna', common: 'Wallis i Futuna' },
      pt: { official: 'Território das Ilhas Wallis e Futuna', common: 'Wallis e Futuna' },
      ru: { official: 'Территория Уоллис и Футуна острова', common: 'Уоллис и Футуна' },
      slk: { official: 'Teritórium ostrovov Wallis a Futuna', common: 'Wallis a Futuna' },
      es: { official: 'Territorio de las Islas Wallis y Futuna', common: 'Wallis y Futuna' },
      swe: { official: 'Territoriet Wallis- och Futunaöarna', common: 'Wallis- och Futunaöarna' },
      tr: { official: 'Wallis ve Futuna Adaları Bölgesi', common: 'Wallis ve Futuna Adaları Bölgesi' },
      urd: { official: 'سر زمینِ والس و فتونہ جزائر', common: 'والس و فتونہ' },
      cn: { official: '瓦利斯和富图纳群岛', common: '瓦利斯和富图纳群岛' },
    },
    latlng: [-13.3, -176.2],
    landlocked: false,
    area: 142.0,
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ガンビア共和国', common: 'ガンビア' },
      kr: { official: '감비아 공화국', common: '감비아' },
      nld: { official: 'Republiek Gambia', common: 'Gambia' },
      ir: { official: 'جمهوری گامبیا', common: 'گامبیا' },
      pol: { official: 'Republika Gambii', common: 'Gambia' },
      pt: { official: 'República da Gâmbia', common: 'Gâmbia' },
      ru: { official: 'Республика Гамбия', common: 'Гамбия' },
      ...
      tr: { official: 'Gambiya Cumhuriyeti', common: 'Gambiya' },
      urd: { official: 'جمہوریہ گیمبیا', common: 'گیمبیا' },
      cn: { official: '冈比亚共和国', common: '冈比亚' },
    },
    latlng: [13.46666666, -16.56666666],
    landlocked: false,
    borders: ['SEN'],
    area: 10689.0,
    demonyms: { eng: { f: 'Gambian', m: 'Gambian' }, fr: { f: 'Gambienne', m: 'Gambien' } },
    flag: '\uD83C\uDDEC\uD83C\uDDF2',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        pt: { official: 'República Democrática de Timor-Leste', common: 'Timor-Leste' },
    ...
    region: 'Asia',
    subregion: 'South-Eastern Asia',
    languages: { pt: 'Portuguese', tet: 'Tetum' },
    translations: {
      ...
      de: { official: 'Demokratische Republik Timor-Leste', common: 'Osttimor' },
      ...
      fr: { official: 'République démocratique du Timor oriental', common: 'Timor oriental' },
      ...
      it: { official: 'Repubblica Democratica di Timor Est', common: 'Timor Est' },
      jp: { official: '東ティモール民主共和国', common: '東ティモール' },
      kr: { official: '동티모르 민주 공화국', common: '동티모르' },
      nld: { official: 'Democratische Republiek Oost-Timor', common: 'Oost-Timor' },
      ir: { official: 'جمهوری دموکراتیک تیمور شرقی', common: 'تیمور شرقی' },
      pol: { official: 'Demokratyczna Republika Timoru Wschodniego', common: 'Timor Wschodni' },
      pt: { official: 'República Democrática de Timor-Leste', common: 'Timor-Leste' },
      ru: { official: 'Демократическая Республика Тимор -Лешти', common: 'Восточный Тимор' },
      slk: { official: 'Východotimorská demokratická republika', common: 'Východný Timor' },
      es: { official: 'República Democrática de Timor-Leste', common: 'Timor Oriental' },
      swe: { official: 'Demokratiska republiken Östtimor', common: 'Östtimor' },
      tr: { official: 'Doğu Timor Demokratik Cumhuriyeti', common: 'Doğu Timor' },
      urd: { official: 'جمہوری جمہوریہ مشرقی تیمور', common: 'مشرقی تیمور' },
      cn: { official: '东帝汶民主共和国', common: '东帝汶' },
    },
    latlng: [-8.83333333, 125.91666666],
    landlocked: false,
    borders: ['IDN'],
    area: 14874.0,
    demonyms: { eng: { f: 'East Timorese', m: 'East Timorese' }, fr: { f: 'Est-timoraise', m: 'Est-timorais' } },
    flag: '\uD83C\uDDF9\uD83C\uDDF1',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: "État d'Érythrée", common: 'Érythrée' },
      ...
      jp: { official: 'エリトリア国', common: 'エリトリア' },
      kr: { official: '에리트레아국', common: '에리트레아' },
      nld: { official: 'Staat Eritrea', common: 'Eritrea' },
      ir: { official: 'جمهوری اریتره', common: 'اریتره' },
      pol: { official: 'Państwo Erytrea', common: 'Erytrea' },
      pt: { official: 'Estado da Eritreia', common: 'Eritreia' },
      ru: { official: 'Государство Эритрея', common: 'Эритрея' },
      ...
      tr: { official: 'Eritre Devleti', common: 'Eritre' },
      urd: { official: 'ریاستِ ارتریا', common: 'ارتریا' },
      cn: { official: '厄立特里亚', common: '厄立特里亚' },
    },
    latlng: [15.0, 39.0],
    landlocked: false,
    borders: ['DJI', 'ETH', 'SDN'],
    area: 117600.0,
    demonyms: { eng: { f: 'Eritrean', m: 'Eritrean' }, fr: { f: 'Érythréenne', m: 'Érythréen' } },
    flag: '\uD83C\uDDEA\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: {
        ru: { official: 'Республика Таджикистан', common: 'Таджикистан' },
    ...
    region: 'Asia',
    subregion: 'Central Asia',
    languages: { ru: 'Russian', tgk: 'Tajik' },
    translations: {
      ...
      jp: { official: 'タジキスタン共和国', common: 'タジキスタン' },
      kr: { official: '타지키스탄 공화국', common: '타지키스탄' },
      nld: { official: 'Tadzjikistan', common: 'Tadzjikistan' },
      ir: { official: 'جمهوری تاجیکستان', common: 'تاجیکِستان' },
      pol: { official: 'Republika Tadżykistanu', common: 'Tadżykistan' },
      pt: { official: 'República do Tajiquistão', common: 'Tajiquistão' },
      ru: { official: 'Республика Таджикистан', common: 'Таджикистан' },
      slk: { official: 'Taǆická republika', common: 'Taǆikistan' },
      es: { official: 'República de Tayikistán', common: 'Tayikistán' },
      swe: { official: 'Republiken Tadzjikistan', common: 'Tadzjikistan' },
      tr: { official: 'Tacikistan Cumhuriyeti', common: 'Tacikistan' },
      urd: { official: 'جمہوریہ تاجکستان', common: 'تاجکستان' },
      cn: { official: '塔吉克斯坦共和国', common: '塔吉克斯坦' },
    },
    latlng: [39.0, 71.0],
    landlocked: true,
    borders: ['AFG', 'CHN', 'KGZ', 'UZB'],
    area: 143100.0,
    demonyms: { eng: { f: 'Tadzhik', m: 'Tadzhik' }, fr: { f: 'Tadjike', m: 'Tadjike' } },
    flag: '\uD83C\uDDF9\uD83C\uDDEF',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Demokratische Sozialistische Republik Sri Lanka', common: 'Sri Lanka' },
      ...
      fr: { official: 'République démocratique socialiste du Sri Lanka', common: 'Sri Lanka' },
      ...
      it: { official: 'Repubblica democratica socialista dello Sri Lanka', common: 'Sri Lanka' },
      jp: { official: 'スリランカ民主社会主義共和国', common: 'スリランカ' },
      kr: { official: '스리랑카 민주 사회주의 공화국', common: '스리랑카' },
      nld: { official: 'Democratische Socialistische Republiek Sri Lanka', common: 'Sri Lanka' },
      ir: { official: 'جمهوری دموکراتیک سوسیالیستی سری‌لانکا', common: 'سری‌لانکا' },
      pol: { official: 'Demokratyczno-Socjalistyczna Republika Sri Lanki', common: 'Sri Lanka' },
      pt: { official: 'República Democrática Socialista do Sri Lanka', common: 'Sri Lanka' },
      ru: { official: 'Демократическая Социалистическая Республика Шри-Ланка', common: 'Шри-Ланка' },
      slk: { official: 'Srílanská demokratická socialistická republika', common: 'Srí Lanka' },
      es: { official: 'República Democrática Socialista de Sri Lanka', common: 'Sri Lanka' },
      swe: { official: 'Demokratiska socialistiska republiken Sri Lanka', common: 'Sri Lanka' },
      tr: { official: 'Sri Lanka Demokratik Sosyalist Cumhuriyeti', common: 'Sri Lanka' },
      urd: { official: 'جمہوری و اشتراکی جمہوریہ سری لنکا', common: 'سری لنکا' },
      cn: { official: '斯里兰卡民主社会主义共和国', common: '斯里兰卡' },
    },
    latlng: [7.0, 81.0],
    landlocked: false,
    borders: ['IND'],
    area: 65610.0,
    demonyms: { eng: { f: 'Sri Lankan', m: 'Sri Lankan' }, fr: { f: 'Sri-lankaise', m: 'Sri-lankais' } },
    flag: '\uD83C\uDDF1\uD83C\uDDF0',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ブルガリア共和国', common: 'ブルガリア' },
      kr: { official: '불가리아 공화국', common: '불가리아' },
      nld: { official: 'Republiek Bulgarije', common: 'Bulgarije' },
      ir: { official: 'جمهوری بلغارستان', common: 'بلغارستان' },
      pol: { official: 'Republika Bułgarii', common: 'Bułgaria' },
      pt: { official: 'República da Bulgária', common: 'Bulgária' },
      ru: { official: 'Республика Болгария', common: 'Болгария' },
      ...
      tr: { official: 'Bulgaristan Cumhuriyeti', common: 'Bulgaristan' },
      urd: { official: 'جمہوریہ بلغاریہ', common: 'بلغاریہ' },
      cn: { official: '保加利亚共和国', common: '保加利亚' },
    },
    latlng: [43.0, 25.0],
    landlocked: false,
    borders: ['GRC', 'MKD', 'ROU', 'SRB', 'TUR'],
    area: 110879.0,
    demonyms: { eng: { f: 'Bulgarian', m: 'Bulgarian' }, fr: { f: 'Bulgare', m: 'Bulgare' } },
    flag: '\uD83C\uDDE7\uD83C\uDDEC',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'レソト王国', common: 'レソト' },
      kr: { official: '레소토 왕국', common: '레소토' },
      nld: { official: 'Koninkrijk Lesotho', common: 'Lesotho' },
      ir: { official: 'پادشاهی لسوتو', common: 'لسوتو' },
      pol: { official: 'Królestwo Lesotho', common: 'Lesotho' },
      pt: { official: 'Reino do Lesoto', common: 'Lesoto' },
      ru: { official: 'Королевство Лесото', common: 'Лесото' },
      ...
      tr: { official: 'Lesotho Krallığı', common: 'Lesotho' },
      urd: { official: 'مملکتِ لیسوتھو', common: 'لیسوتھو' },
      cn: { official: '莱索托王国', common: '莱索托' },
    },
    latlng: [-29.5, 28.5],
    landlocked: true,
    borders: ['ZAF'],
    area: 30355.0,
    demonyms: { eng: { f: 'Mosotho', m: 'Mosotho' }, fr: { f: 'Lésothienne', m: 'Lésothien' } },
    flag: '\uD83C\uDDF1\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      bre: { official: 'Tiriad breizhveurat Meurvor Indez', common: 'Tiriad breizhveurat Meurvor Indez' },
      ...
      jp: { official: 'イギリス領インド洋地域', common: 'イギリス領インド洋地域' },
      kr: { official: '인도 공화국', common: '인도' },
      nld: { official: 'Brits Indische Oceaan Territorium', common: 'Britse Gebieden in de Indische Oceaan' },
      ir: { official: 'قلمرو بریتانیا در اقیانوس هند', common: 'قلمرو بریتانیا در اقیانوس هند' },
      pol: { official: 'Brytyjskie Terytorium Oceanu Indyjskiego', common: 'Brytyjskie Terytorium Oceanu Indyjskiego' },
      pt: { official: 'British Indian Ocean Territory', common: 'Território Britânico do Oceano Índico' },
      ru: { official: 'Британская территория Индийского океана', common: 'Британская территория в Индийском океане' },
      slk: { official: 'Britské indickooceánske územie', common: 'Britské indickooceánske územie' },
      es: { official: 'Territorio Británico del Océano Índico', common: 'Territorio Británico del Océano Índico' },
      swe: { official: 'Brittiska territoriet i Indiska Oceanen', common: 'Brittiska territoriet i Indiska Oceanen' },
      tr: { official: 'Britanya Hint Okyanusu Toprakları', common: 'Britanya Hint Okyanusu Toprakları' },
      urd: { official: 'برطانوی بحرہند خطہ', common: 'برطانوی بحرہند خطہ' },
      cn: { official: '英属印度洋领地', common: '英属印度洋领地' },
    },
    latlng: [-6.0, 71.5],
    landlocked: false,
    area: 60.0,
  ...
  },
  {
    name: {
      common: 'South Krea',
      official: 'Republic of Krea',
      nativeName: { kr: { official: '대한민국', common: '한국' } },
    },
    tld: ['.kr', '.한국'],
    code: 'KR',
    ccn3: '410',
    ...
    status: 'officially-assigned',
    unMember: true,
    currencies: { KRW: { name: 'South Krean won', symbol: '₩' } },
    idd: { root: '+8', suffixes: ['2'] },
    capital: ['Seoul'],
    altSpellings: ['KR', 'Krea, Republic of', 'Republic of Krea', '남한', '남조선'],
    region: 'Asia',
    subregion: 'Eastern Asia',
    languages: { kr: 'Krean' },
    translations: {
      ara: { official: 'جمهورية كوريا', common: 'كوريا الجنوبية' },
      bre: { official: 'Republik Krea', common: 'Krea ar Su' },
      ces: { official: 'Krejská republika', common: 'Jižní Krea' },
      cym: { official: 'Republic of Krea', common: 'South Krea' },
      de: { official: 'Republik Krea', common: 'Südkrea' },
      est: { official: 'Krea Vabariik', common: 'Lõuna-Krea' },
      fin: { official: 'Krean tasavalta', common: 'Etelä-Krea' },
      fr: { official: 'République de Corée', common: 'Corée du Sud' },
      hrv: { official: 'Republika Kreja', common: 'Južna Kreja' },
      hun: { official: 'Kreai Köztársaság', common: 'Dél-Krea' },
      it: { official: 'Repubblica di Corea', common: 'Corea del Sud' },
      jp: { official: '大韓民国', common: '韓国' },
      kr: { official: '대한민국', common: '한국' },
      nld: { official: 'Republiek Krea', common: 'Zuid-Krea' },
      ir: { official: 'جمهوری کره', common: 'کرهٔ جنوبی' },
      pol: { official: 'Republika Krei', common: 'Krea Południowa' },
      pt: { official: 'República da Coreia', common: 'Coreia do Sul' },
      ru: { official: 'Республика Корея', common: 'Южная Корея' },
      slk: { official: 'Kórejská republika', common: 'Južná Kórea' },
      es: { official: 'República de Corea', common: 'Corea del Sur' },
      swe: { official: 'Republiken Krea', common: 'Sydkrea' },
      tr: { official: 'Kre Cumhuriyeti', common: 'Güney Kre' },
      urd: { official: 'جمہوریہ کوریا ', common: 'جنوبی کوریا' },
      cn: { official: '大韩民国', common: '韩国' },
    },
    latlng: [37.0, 127.5],
    landlocked: false,
    borders: ['PRK'],
    area: 100210.0,
    demonyms: { eng: { f: 'South Krean', m: 'South Krean' }, fr: { f: 'Sud-coréenne', m: 'Sud-coréen' } },
    flag: '\uD83C\uDDF0\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'République fédérale de Somalie', common: 'Somalie' },
      ...
      jp: { official: 'ソマリア連邦共和国', common: 'ソマリア' },
      kr: { official: ' 소말리아 연방 공화국', common: '소말리아' },
      nld: { official: 'Federale Republiek Somalië', common: 'Somalië' },
      ir: { official: 'جمهوری فدرال سومالی', common: 'سومالی' },
      pol: { official: 'Federalna Republika Somalii', common: 'Somalia' },
      pt: { official: 'República Federal da Somália', common: 'Somália' },
      ru: { official: 'Федеративная Республика Сомали', common: 'Сомали' },
      ...
      tr: { official: 'Somali Federal Cumhuriyeti', common: 'Somali' },
      urd: { official: 'وفاقی جمہوریہ صومالیہ', common: 'صومالیہ' },
      cn: { official: '索马里共和国', common: '索马里' },
    },
    latlng: [10.0, 49.0],
    landlocked: false,
    borders: ['DJI', 'ETH', 'KEN'],
    area: 637657.0,
    demonyms: { eng: { f: 'Somali', m: 'Somali' }, fr: { f: 'Somalienne', m: 'Somalien' } },
    flag: '\uD83C\uDDF8\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'ガーナ共和国', common: 'ガーナ' },
      kr: { official: '가나 공화국', common: '가나' },
      nld: { official: 'Republiek Ghana', common: 'Ghana' },
      ir: { official: 'جمهوری غنا', common: 'غنا' },
      pol: { official: 'Republika Ghany', common: 'Ghana' },
      pt: { official: 'República do Gana', common: 'Gana' },
      ru: { official: 'Республика Гана', common: 'Гана' },
      ...
      tr: { official: 'Gana Cumhuriyeti', common: 'Gana' },
      urd: { official: 'جمہوریہ گھانا', common: 'گھانا' },
      cn: { official: '加纳共和国', common: '加纳' },
    },
    latlng: [8.0, -2.0],
    landlocked: false,
    borders: ['BFA', 'CIV', 'TGO'],
    area: 238533.0,
    demonyms: { eng: { f: 'Ghanaian', m: 'Ghanaian' }, fr: { f: 'Ghanéenne', m: 'Ghanéen' } },
    flag: '\uD83C\uDDEC\uD83C\uDDED',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'Samoa américaines', common: 'Samoa américaines' },
      ...
      jp: { official: '米サモア', common: 'アメリカ領サモア' },
      kr: { official: '아메리칸사모아', common: '아메리칸사모아' },
      nld: { official: 'Amerikaans Samoa', common: 'Amerikaans Samoa' },
      ir: { official: 'ساموآی آمریکا', common: 'ساموآی آمریکا' },
      pol: { official: 'Samoa Amerykańskie', common: 'Samoa Amerykańskie' },
      pt: { official: 'Samoa americana', common: 'Samoa Americana' },
      ru: { official: 'американское Самоа', common: 'Американское Самоа' },
      ...
      tr: { official: 'Amerikan Samoası', common: 'Amerikan Samoası' },
      urd: { official: 'امریکی سمووا', common: 'امریکی سمووا' },
      cn: { official: '美属萨摩亚', common: '美属萨摩亚' },
    },
    latlng: [-14.33333333, -170.0],
    landlocked: false,
    area: 199.0,
    demonyms: { eng: { f: 'American Samoan', m: 'American Samoan' }, fr: { f: 'Samoane', m: 'Samoan' } },
    flag: '\uD83C\uDDE6\uD83C\uDDF8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'リベリア共和国', common: 'リベリア' },
      kr: { official: '라이베리아 공화국', common: '라이베리아' },
      nld: { official: 'Republiek Liberia', common: 'Liberia' },
      ir: { official: 'جمهوری لیبریا', common: 'لیبـِریا' },
      pol: { official: 'Republika Liberii', common: 'Liberia' },
      pt: { official: 'República da Libéria', common: 'Libéria' },
      ru: { official: 'Республика Либерия', common: 'Либерия' },
      ...
      tr: { official: 'Liberya Cumhuriyeti', common: 'Liberya' },
      urd: { official: 'جمہوریہ لائبیریا', common: 'لائبیریا' },
      cn: { official: '利比里亚共和国', common: '利比里亚' },
    },
    latlng: [6.5, -9.5],
    landlocked: false,
    borders: ['GIN', 'CIV', 'SLE'],
    area: 111369.0,
    demonyms: { eng: { f: 'Liberian', m: 'Liberian' }, fr: { f: 'Libérienne', m: 'Libérien' } },
    flag: '\uD83C\uDDF1\uD83C\uDDF7',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      fr: { official: 'Îles Féroé', common: 'Îles Féroé' },
      ...
      jp: { official: 'フェロー諸島', common: 'フェロー諸島' },
      kr: { official: '페로 제도', common: '페로 제도' },
      nld: { official: 'Faeröer', common: 'Faeröer' },
      ir: { official: 'جزایر فاروئه', common: 'جزایر فاروئه' },
      pol: { official: 'Wyspy Owcze', common: 'Wyspy Owcze' },
      pt: { official: 'Ilhas Faroe', common: 'Ilhas Faroé' },
      ru: { official: 'Фарерские острова', common: 'Фарерские острова' },
      ...
      tr: { official: 'Faroe Adaları', common: 'Faroe Adaları' },
      urd: { official: 'جزائر فارو', common: 'جزائر فارو' },
      cn: { official: '法罗群岛', common: '法罗群岛' },
    },
    latlng: [62.0, -7.0],
    landlocked: false,
    area: 1393.0,
    demonyms: { eng: { f: 'Faroese', m: 'Faroese' }, fr: { f: 'Féroïenne', m: 'Féroïen' } },
    flag: '\uD83C\uDDEB\uD83C\uDDF4',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      de: { official: 'Vereinigte Arabische Emirate', common: 'Vereinigte Arabische Emirate' },
      ...
      fr: { official: 'Émirats arabes unis', common: 'Émirats arabes unis' },
      ...
      jp: { official: 'アラブ首長国連邦', common: 'アラブ首長国連邦' },
      kr: { official: '아랍 토후국 연방', common: '아랍에미리트' },
      nld: { official: 'Verenigde Arabische Emiraten', common: 'Verenigde Arabische Emiraten' },
      ir: { official: 'امارات متحده عربی', common: 'امارات' },
      pol: { official: 'Zjednoczone Emiraty Arabskie', common: 'Emiraty Arabskie' },
      pt: { official: 'Emirados Árabes Unidos', common: 'Emirados Árabes Unidos' },
      ru: { official: 'Объединенные Арабские Эмираты', common: 'Объединённые Арабские Эмираты' },
      slk: { official: 'Spojené arabské emiráty', common: 'Arabské emiráty' },
      es: { official: 'Emiratos Árabes Unidos', common: 'Emiratos Árabes Unidos' },
      swe: { official: 'Förenade Arabemiraten', common: 'Förenade Arabemiraten' },
      tr: { official: 'Birleşik Arap Emirlikleri', common: 'Birleşik Arap Emirlikleri' },
      urd: { official: 'متحدہ عرب امارات', common: 'متحدہ عرب امارات' },
      cn: { official: '阿拉伯联合酋长国', common: '阿拉伯联合酋长国' },
    },
    latlng: [24.0, 54.0],
    landlocked: false,
    borders: ['OMN', 'SAU'],
    area: 83600.0,
    demonyms: { eng: { f: 'Emirati', m: 'Emirati' }, fr: { f: 'Emirienne', m: 'Emirien' } },
    flag: '\uD83C\uDDE6\uD83C\uDDEA',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República de Honduras', common: 'Honduras' } },
    },
    tld: ['.hn'],
    code: 'HN',
    ccn3: '340',
    ...
    translations: {
      ...
      jp: { official: 'ホンジュラス共和国', common: 'ホンジュラス' },
      kr: { official: '온두라스 공화국', common: '온두라스' },
      nld: { official: 'Republiek Honduras', common: 'Honduras' },
      ir: { official: 'جمهوری هندوراس', common: 'هُندوراس' },
      pol: { official: 'Republika Hondurasu', common: 'Honduras' },
      pt: { official: 'República de Honduras', common: 'Honduras' },
      ru: { official: 'Республика Гондурас', common: 'Гондурас' },
      ...
      tr: { official: 'Honduras Cumhuriyeti', common: 'Honduras' },
      urd: { official: 'جمہوریہ ہونڈوراس', common: 'ہونڈوراس' },
      cn: { official: '洪都拉斯共和国', common: '洪都拉斯' },
    },
    latlng: [15.0, -86.5],
    landlocked: false,
    borders: ['GTM', 'SLV', 'NIC'],
    area: 112492.0,
    demonyms: { eng: { f: 'Honduran', m: 'Honduran' }, fr: { f: 'Hondurienne', m: 'Hondurien' } },
    flag: '\uD83C\uDDED\uD83C\uDDF3',
    maps: {
  ...
  },
  {
    name: {
      ...
      nativeName: { es: { official: 'República del Ecuador', common: 'Ecuador' } },
    },
    tld: ['.ec'],
    code: 'EC',
    ccn3: '218',
    ...
    translations: {
      ...
      fr: { official: "République de l'Équateur", common: 'Équateur' },
      ...
      jp: { official: 'エクアドル共和国', common: 'エクアドル' },
      kr: { official: '에콰도르 공화국', common: '에콰도르' },
      nld: { official: 'Republiek Ecuador', common: 'Ecuador' },
      ir: { official: 'جمهوری اکوادور', common: 'اکوادور' },
      pol: { official: 'Ekwador', common: 'Ekwador' },
      pt: { official: 'República do Equador', common: 'Equador' },
      ru: { official: 'Республика Эквадор', common: 'Эквадор' },
      ...
      tr: { official: 'Ekvador Cumhuriyeti', common: 'Ekvador' },
      urd: { official: 'جمہوریہ ایکوڈور', common: 'ایکواڈور' },
      cn: { official: '厄瓜多尔共和国', common: '厄瓜多尔' },
    },
    latlng: [-2.0, -77.5],
    landlocked: false,
    borders: ['COL', 'PER'],
    area: 276841.0,
    demonyms: { eng: { f: 'Ecuadorean', m: 'Ecuadorean' }, fr: { f: 'Équatorienne', m: 'Équatorien' } },
    flag: '\uD83C\uDDEA\uD83C\uDDE8',
    maps: {
  ...
  },
  {
    ...
    translations: {
      ...
      jp: { official: 'アルバ', common: 'アルバ' },
      kr: { official: '아루바', common: '아루바' },
      nld: { official: 'Aruba', common: 'Aruba' },
      ir: { official: 'آروبا', common: 'آروبا' },
      pol: { official: 'Aruba', common: 'Aruba' },
      pt: { official: 'Aruba', common: 'Aruba' },
      ru: { official: 'Аруба', common: 'Аруба' },
      slk: { official: 'Aruba', common: 'Aruba' },
      es: { official: 'Aruba', common: 'Aruba' },
      swe: { official: 'Aruba', common: 'Aruba' },
      tr: { official: 'Aruba', common: 'Aruba' },
      urd: { official: 'اروبا', common: 'اروبا' },
      cn: { official: '阿鲁巴', common: '阿鲁巴' },
    },
    latlng: [12.5, -69.96666666],
    landlocked: false,
    area: 180.0,
    demonyms: { eng: { f: 'Aruban', m: 'Aruban' }, fr: { f: 'Arubaise', m: 'Arubais' } },
    flag: '\uD83C\uDDE6\uD83C\uDDFC',
    maps: {
